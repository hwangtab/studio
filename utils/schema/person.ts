...
export const OPERATOR_KNOWS_ABOUT: Record<'ko' | 'en', string[]> = {
  ko: ['A&R', '아티스트 발굴·육성', '음반 기획', '보컬 디렉팅', '믹싱', '인디 음악 유통', '평론 PR', '해외 매체·라디오·플레이리스트 피칭', '세션 네트워킹'],
  en: ['A&R', 'Artist Discovery & Development', 'Album Production', 'Vocal Direction', 'Mixing', 'Indie Music Distribution', 'Press PR', 'International Radio & Playlist Pitching', 'Session Networking'],
};
