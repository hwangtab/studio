...
faq:
  - q: 바리톤 기타·다운 튜닝·헤비 사운드을 처음 연습할 때 어디서부터 시작해야 하나요?
    a: >-
      바리톤 기타·다운 튜닝·헤비 사운드 연습은 바리톤 기타란?, 다운 튜닝 (Down Tuning), 헤비 리프 기법 순서로 진행하는
      것을 추천합니다. 기초 단계를 충분히 소화한 후 다음 단계로 넘어가세요.
  - q: 바리톤 기타·다운 튜닝·헤비 사운드 연습 시 가장 중요한 포인트는 무엇인가요?
    a: >-
      바리톤 기타·다운 튜닝·헤비 사운드 연습에서 가장 중요한 것은 정확한 손 포지션과 리듬감입니다. 메트로놈을 활용해 느린 템포부터
...
스튜디오 놀(연신내, 서울 은평구) 음악연습실에서 바리톤 기타·확장 스케일 상담에서 반복적으로 드리는 조언입니다.
