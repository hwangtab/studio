---
title: "재즈 이론·스케일 연습 음악연습실 — 재즈 화성 완성 가이드"
date: 2026-04-09
author: "스튜디오 놀"
category: "음악연습실 가이드"
tags: ["재즈 이론 연습", "재즈 스케일 훈련", "재즈 이론 음악연습실", "음악연습실", "재즈 화성 공부", "도리안 믹솔리디안 스케일", "재즈 스케일 음악연습실"]
thumbnail: "/images/room5.webp"
summary: "재즈 이론·스케일 연습을 위한 음악연습실 활용 가이드. 재즈 모드 스케일, ii-V-I 화성, 비밥 스케일, 음악연습실에서 재즈 이론을 실전에 적용하는 방법을 안내합니다."
faq:
  - q: "재즈 이론을 처음 배울 때 어떤 것부터 시작해야 하나요?"
    a: "재즈 이론 입문 순서: ① 7화음 이해 — maj7, m7, dom7, m7b5 ② ii-V-I 진행 — 재즈 화성의 기본 ③ 도리안 스케일 — ii chord에 적용 ④ 믹솔리디안 스케일 — V chord에 적용 ⑤ 리디안 스케일 — maj7 chord에 적용. 처음에는 C장조 ii-V-I 하나를 모든 스케일과 함께 철저히 익히고, 12개 키로 확장하는 것이 가장 효율적입니다."
  - q: "재즈 모드 스케일이란 무엇인가요?"
    a: "재즈 모드 스케일: ① 도리안 (D Dorian) — D 단조 색채, ii chord ② 믹솔리디안 (G Mixolydian) — 장조·도미넌트 느낌, V chord ③ 리디안 (F Lydian) — 밝고 신선함, maj7 chord ④ 로크리안 (B Locrian) — 불안정, m7b5 chord ⑤ 비밥 스케일 — 경과음 추가, 8분음부 흐름. 모드 스케일은 '코드에 어울리는 색깔' 역할을 합니다."
  - q: "재즈 ii-V-I를 실전 즉흥에 어떻게 활용하나요?"
    a: "ii-V-I 즉흥 연주: ① 각 코드별 스케일 준비 — Dm7(도리안), G7(믹솔리디안), Cmaj7(리디안) ② 코드 노트 강조 — 코드톤(1·3·5·7)을 강박에 ③ 스케일 패턴 반복 — 오름·내림 8분음부 ④ 아르페지오 이동 — 코드 전환 시 ⑤ 귀로 확인 — 어울리는지 즉각 판단. 처음에는 코드톤만 연주해도 충분히 재즈스럽습니다."
  - q: "비밥 스케일은 어떻게 연습하나요?"
    a: "비밥 스케일 연습: ① 메이저 비밥 스케일 — 장조 7음에 b7 추가 (8음) ② 도미넌트 비밥 스케일 — 믹솔리디안에 장7도 추가 ③ 8분음부 흐름 — 코드톤이 강박에 오도록 설계 ④ 하행 시작 — 비밥 특유의 하행 패턴 ⑤ BPM 80 → 점차 빠르게. 비밥 스케일의 핵심은 경과음이 항상 약박에 오도록 설계되어 있다는 것입니다."
---
