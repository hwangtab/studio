...
author: "스튜디오 놀"
category: "강좌"
tags: ["음악 이론 기초", "보컬 음악 이론", "음정 이해", "조성 이해", "코드 기초", "보컬 이론", "노래 이론"]
thumbnail: "/images/recording15.webp"
summary: "보컬리스트가 알아야 할 음악 이론 기초. 음정(인터벌), 조성(Key), 코드의 관계를 보컬 중심으로 쉽게 설명합니다. 녹음 세션 전 알아두면 도움이 되는 핵심 이론."
faq:
  - q: "보컬리스트도 음악 이론을 알아야 하나요?"
    a: "필수는 아니지만 알면 큰 도움이 됩니다. 키 설정, 화음 이해, 곡 구조 파악, 엔지니어와의 소통이 훨씬 쉬워집니다. 특히 '이 구간이 좀 높아요', '반음 낮춰주세요' 같은 의사소통을 위해 기본 개념은 알아두세요."
  - q: "음정(인터벌)이란 무엇인가요?"
    a: "두 음 사이의 거리를 말합니다. 반음(반 음정)과 온음(온 음정)이 기본 단위입니다. '1도'는 같은 음, '2도'는 한 음 위, '5도'는 완전 5도 등으로 불립니다. 조화롭게 어울리는 음정(3도, 5도)을 이해하면 화음 노래에 도움됩니다."
  - q: "조성(Key)이란 무엇인가요?"
    a: "노래의 중심 음(으뜸음)과 그 주변을 이루는 음계의 집합입니다. '다장조(C Major)', 'D단조(D minor)' 등으로 표현됩니다. 녹음 시 내 음역에 맞는 키를 찾는 것이 중요합니다."
  - q: "코드(화음)와 보컬 멜로디의 관계는 무엇인가요?"
    a: "코드는 반주의 화성 구조이며, 보컬 멜로디는 코드 안에서 어울리는 음들로 이루어집니다. 코드를 이해하면 화음 노래(백 보컬), 즉흥 애드립, 편곡 의뢰 소통이 쉬워집니다."
---
