...
summary: "신림·서울대입구에서 연신내 스튜디오 놀까지 2호선·6호선 환승으로 약 40~50분. Neumann U87AI 마이크, 10년 경력 엔지니어, 시간당 합리적인 요금. 관악구 대학가 뮤지션과 인디 아티스트를 위한 전문 레코딩 스튜디오 방문 가이드."
faq:
  - q: "신림역에서 스튜디오 놀까지 어떻게 오나요?"
    a: "신림역(2호선)에서 홍대입구역 방면으로 2호선 탑승, 홍대입구역에서 6호선 환승 후 연신내역까지 약 40~45분 소요됩니다. 연신내역 3번 출구에서 도보 5분입니다."
  - q: "서울대입구역에서 스튜디오 놀까지 어떻게 오나요?"
    a: "서울대입구역(2호선)에서 홍대입구역까지 2호선 탑승, 6호선 연신내역 환승까지 약 45~50분 소요됩니다."
  - q: "대학생도 이용할 수 있나요? 요금이 합리적인가요?"
    a: "네, 대학생 뮤지션들이 많이 이용합니다. 합주실은 시간당 2만원, 보컬 녹음 축가 패키지는 15만원부터 시작합니다. 카카오톡으로 무료 상담 후 본인 예산에 맞는 서비스를 선택하시면 됩니다."
  - q: "방문 없이 온라인 믹싱을 의뢰할 수 있나요?"
    a: "가능합니다. 드라이 보컬 WAV 파일을 카카오톡으로 전송하면 믹싱·마스터링 후 완성 파일을 납품합니다. 신림·서울대에서 방문이 어려운 날에도 이용할 수 있습니다."
  - q: "처음 녹음하는데 혼자 와도 괜찮나요?"
    a: "괜찮습니다. 10년 경력 엔지니어가 마이크 세팅부터 테이크 선별까지 함께 도와드립니다. 처음 스튜디오를 이용하는 분도 편하게 오세요."
  - q: "예약은 어떻게 하나요?"
    a: "카카오톡 채널 '스튜디오 놀'로 문의하시면 됩니다. 방문 전 예약은 필수이며, 원하는 날짜와 서비스 종류를 알려주시면 빠르게 일정을 잡아드립니다."
---
...
강남·홍대 지역 스튜디오 대비 합리적인 요금으로 방송·음반사급 장비를 이용할 수 있습니다. 합주실은 시간당 2만원으로 여럿이 나눠 쓰면 부담이 더 줄어듭니다.
...
합주실은 시간당 2만원으로 대여 가능합니다. 연습 후 바로 녹음 세션으로 연결하는 것도 가능합니다.
