...
author: "스튜디오 놀"
category: "강좌"
tags: ["성우 녹음", "나레이션 녹음", "오디오북 녹음", "광고 녹음", "유튜브 나레이션", "성우 스튜디오", "보이스 레코딩"]
thumbnail: "/images/service3.webp"
summary: "성우·나레이션 녹음을 위한 완전 가이드. 오디오북, 광고, 유튜브 나레이션 용도별 녹음 방법, 발음·딕션 준비, 마이크 세팅, 납품 형식까지 모든 것을 정리합니다."
faq:
  - q: "성우 녹음과 보컬 녹음의 차이는 무엇인가요?"
    a: "보컬 녹음은 음정과 감정 표현이 중심이고, 성우 녹음은 딕션(발음 명확도), 속도 조절, 음색의 일관성이 핵심입니다. 나레이션은 대본 읽기 능력과 감정 전달이 중요하며, 배경음악(BGM) 없이 목소리만 독립적으로 납품되는 경우가 많습니다."
  - q: "성우 오디션용 데모 테이프를 녹음할 수 있나요?"
    a: "네, 가능합니다. 성우 오디션 데모 녹음은 1~3분 분량의 본인 목소리 포트폴리오입니다. 다양한 장르(광고, 내레이션, 애니메이션, 다큐)로 나누어 녹음하면 에이전시에 제출하기 좋습니다. 카카오톡으로 사전 문의해주세요."
  - q: "나레이션 녹음 비용은 얼마인가요?"
    a: "나레이션 녹음은 분량(단어 수·시간)에 따라 다릅니다. 일반적으로 30분~1시간 세션으로 5분 이내 나레이션이 완성됩니다. 카카오톡으로 대본 분량과 목적을 알려주시면 맞춤 견적을 안내드립니다."
  - q: "유튜브 영상용 나레이션을 영상 편집자에게 바로 넘길 수 있나요?"
    a: "네, WAV 44.1kHz/16bit 또는 24bit 파일로 납품합니다. 영상 편집자가 요청하는 포맷(WAV, MP3, AIFF)으로 제공 가능합니다. 노이즈 제거와 음압 처리가 완료된 상태로 납품되므로 영상에 바로 삽입할 수 있습니다."
---
