...
**숫자보다 귀로 A/B 합니다.** 미터가 맞아도 안심하지 않아요. 내가 목표로 하는 상업 음원을 같은 음량으로 맞춰 나란히 들어보면, 내 곡이 얇은지 답답한지가 그제야 들립니다. 결국 마지막 판단은 미터가 아니라 귀입니다. 개념이 더 궁금하면 [마스터링 완전 가이드](/stories/mastering1)로 이어보세요.
