...
summary: >-
  베이스 하모닉스·플래절렛 완전 마스터 연습을 위한 음악연습실 활용 가이드. 기초 연습법부터 실전 활용까지 안내합니다.
faq:
...
howTo:
  name: "베이스 인공 하모닉(Artificial Harmonics) 3 단계"
  description: "원하는 음정에서 하모닉을 만드는 양손 협응 핵심 3 단계"
  steps:
    - name: "왼손 프레팅"
      text: "원하는 프렛을 일반적인 방식으로 정확히 프레팅합니다. 음정의 베이스 톤은 이 지점에서 결정됩니다."
    - name: "오른손 엄지 위치"
      text: "프레팅 위치보다 12프렛 위 지점에 오른손 엄지를 줄에 가볍게 얹습니다. 너무 강하게 누르면 하모닉이 사라집니다."
    - name: "오른손 검지·중지 플럭"
      text: "엄지로 노드 포인트를 잡은 상태에서 검지 또는 중지로 줄을 퉁겨 발음합니다. 1옥타브 위 하모닉이 또렷이 들립니다."
---
...
## Studio NOL이 베이스 하모닉스 연습실 사용자에게 자주 권하는 3가지

스튜디오 놀(연신내, 서울 은평구) 음악연습실에서 베이스 하모닉스 연습 상담에서 반복적으로 드리는 조언입니다.

**1. 픽업 셀렉터 — 프론트 픽업 단독으로 시작**

하모닉스는 픽업 위치에 따라 명료도가 크게 달라집니다. 프론트 픽업 단독에서 분절점 감각을 익힌 뒤 리어·하프 픽업으로 확장합니다.

**2. 5·7·12프렛 우선 — 자연 하모닉스 기준점**

자연 하모닉스는 5·7·12프렛이 가장 명료합니다. 이 3개 분절점부터 손바닥·손가락 위치를 정확히 익힌 후 인공·태핑 하모닉스로 진행합니다.

**3. 헤드폰 앰프 시뮬 — 미세 음정 모니터링**

하모닉스 미세 음정은 실 앰프 + 룸 반사로는 가려집니다. Helix Bass 시뮬 + 헤드폰 조합으로 직결 모니터링하면 분절점 정확도 학습이 빨라집니다.
