...
author: "스튜디오 놀"
category: "강좌"
tags: ["플레이리스트 피칭", "스포티파이 피칭", "멜론 플레이리스트", "음원 홍보", "인디 뮤지션 마케팅", "스트리밍 전략", "독립 음원 발매"]
thumbnail: "/images/recording4.webp"
summary: "발매 후 스트리밍 수를 늘리기 위한 플레이리스트 피칭 전략. 스포티파이 for Artists 공식 피칭, 멜론 독립 DJ 공략, 유튜브 뮤직 피칭 방법까지 인디 뮤지션을 위한 실전 가이드입니다."
faq:
  - q: "스포티파이 플레이리스트에 내 음원을 올리려면 어떻게 하나요?"
    a: "Spotify for Artists 계정에서 발매 예정 음원을 발매 7일 전에 피칭하면 Spotify 편집팀이 검토합니다. 공식 편집 플레이리스트 외에 독립 큐레이터 플레이리스트에는 SubmitHub, Groover 등 피칭 플랫폼을 활용합니다."
  - q: "멜론 플레이리스트에는 어떻게 피칭하나요?"
    a: "멜론에는 공식 편집팀 피칭 채널이 제한적입니다. 음원 유통사(카카오뮤직)를 통한 피칭 요청이 가장 직접적인 경로입니다. 또한 멜론 내 독립 DJ(플레이리스트 큐레이터)에게 직접 연락하는 방법도 있습니다."
  - q: "플레이리스트 피칭에서 가장 중요한 것은 무엇인가요?"
    a: "음원 품질이 가장 중요합니다. 피칭 이메일이나 메시지보다 음원이 먼저 심사됩니다. 플레이리스트 콘셉트에 맞는 곡인지 설명하고, 장르·무드·BPM 등 메타데이터를 정확히 입력하는 것도 중요합니다."
  - q: "피칭이 거절되면 어떻게 해야 하나요?"
    a: "대부분의 독립 큐레이터는 수십~수백 건의 피칭을 받습니다. 거절은 개인적인 문제가 아니라 그 순간의 플레이리스트 방향과 맞지 않는 경우가 많습니다. 여러 큐레이터에 동시에 피칭하고, 소셜 미디어에서 관계를 먼저 만드는 방법이 장기적으로 더 효과적입니다."
---
...
큐레이터에게 직접 피칭할 때 이메일 구조:

플랫폼마다 정책이 다르므로 각 플랫폼의 최신 가이드라인을 직접 확인하세요.

- **제목**: [장르] [아티스트명] - [곡명] | [플레이리스트명]에 어울리는 새 음원 공유
...
### 한두 문장: 곡의 무드·분위기 설명, 플레이리스트와의 연관성
