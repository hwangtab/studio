...
summary: "목소리 유형(보이스 타입) 완전 가이드입니다. 소프라노·메조소프라노·알토·테너·바리톤·베이스의 음역대와 특성, 자신의 보이스 타입 확인 방법, 장르 적합성을 정리합니다."
faq:
