---
title: "믹스 납품 준비 가이드 — 최종 믹스·마스터링 파일 납품 기준"
date: 2025-11-19
author: "스튜디오 놀"
category: "music-guide"
tags: ["실전", "마스터링"]
thumbnail: "/images/studio1.webp"
summary: "믹스·마스터링 납품 준비 가이드입니다. WAV 규격, 루돈 기준, ISRC 코드, 유통사 제출 형식, 최종 체크리스트까지 음원 발매 전 모든 것을 정리합니다."
faq:
...
---
![믹스 납품 준비 가이드 — 스튜디오 놀](/images/studio1.webp)
...
ISRC 코드와 메타데이터에 대한 핵심 내용을 정리했습니다.
...
아래에서 납품 전 최종 체크리스트의 세부 내용을 확인하세요.
...
[음원 유통 가이드](/stories/distribution1) | [마스터링 가이드](/stories/mastering1) | [앨범 아트 제작 가이드](/stories/album-art1) | [스트리밍 발매 가이드](/stories/streaming-release1)
