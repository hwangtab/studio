...
faq:
  ...
  - q: "템플릿을 사용하면 매번 비슷한 사운드가 나오지 않나요?"
    a: "템플릿은 작업 환경(라우팅·버스)을 미리 세팅해두는 것으로, 사운드 자체를 고정하는 것이 아닙니다. 플러그인은 비활성화(Bypass) 상태로 저장하고 각 프로젝트에 맞게 새로 조정하면 효율성과 창의성을 모두 확보할 수 있습니다."
inlineFallback:
...
## Studio NOL이 마스터 버스 처리 학습자에게 자주 권하는 3가지

스튜디오 놀(연신내, 서울 은평구)에서 마스터 버스 처리·믹스 글루 상담에서 반복적으로 드리는 조언입니다.

**1. 버스 컴프 가볍게 — Ratio 2:1, GR 1~3dB**

마스터 버스 컴프는 무리하면 안 됩니다. Ratio 2:1, GR 1~3dB가 표준입니다.

**2. EQ 미세 조정 — 절반 이하 dB**

마스터 EQ는 ±0.5dB 미세 조정이 표준입니다.

**3. 레퍼런스 비교 — 같은 음량에서**

마스터 처리 후 레퍼런스와 비교 시 음량을 맞춰야 정확한 판단이 가능합니다.

---

**믹싱 강좌 시리즈**: [← 제11부: 믹싱을 위한 마지막 조각, 에디팅](/stories/mixing11) | [제13부: 멈춰있을 때 가장 아름답다 →](/stories/mixing13) | [믹싱 워크플로우 가이드](/stories/mixing-workflow1) | [온라인 믹싱 의뢰](/stories/onlinemix1) | [레슨 안내](/lesson) | [요금 안내](/pricing) | [📚 믹싱 완전 가이드 (전체 로드맵)](/stories/mixing-complete-guide)
