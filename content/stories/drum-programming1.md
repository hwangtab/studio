...
faq:
  ...
  - q: 드럼 프로그래밍에 좋은 DAW는?
    a: >-
      Ableton Live는 직관적인 피아노 롤과 드럼 랙 구조로 가장 많이 사용됩니다. Pro Tools와 Logic Pro도 강력한
      드럼 프로그래밍 기능을 지원합니다.
  - q: 드럼을 휴머나이징하는 방법은?
    a: >-
...
스튜디오 놀에 들어오는 보컬 곡 프로그래밍 드럼 믹싱 의뢰에서 반복적으로 손이 가는 영역입니다.
...
## Studio NOL이 드럼 프로그래밍 작업자에게 자주 권하는 3가지

스튜디오 놀(연신내, 서울 은평구)에서 드럼 프로그래밍 상담에서 반복적으로 드리는 조언입니다.
