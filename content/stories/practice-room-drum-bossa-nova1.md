...
## Studio NOL이 보사노바 드럼 연습실 사용자에게 자주 권하는 3가지

스튜디오 놀(연신내, 서울 은평구) 음악연습실에서 보사노바 드럼 연습 상담에서 반복적으로 드리는 조언입니다.

**1. 사이드 스틱 패턴 — 보사노바 골격**

보사노바의 핵심은 크로스 스틱(사이드 스틱)으로 만드는 클라베 패턴입니다. 림에 정확히 닿는 위치를 마스킹 테이프로 표시합니다.

**2. 부드러운 다이나믹 — 발라드 수준 음량**

보사노바는 빠른 곡이라도 다이나믹이 부드럽습니다. 강하게 치면 보사노바가 아니라 라틴 록이 됩니다.

**3. 브러시 활용 권장 — 보사노바 톤 강화**

스틱 대신 브러시로 라이드를 쓸어내리면 보사노바의 둥근 톤이 살아납니다.
