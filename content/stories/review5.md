...
faq:
  - q: "믹싱 의뢰를 할 때 어떤 파일을 준비해야 하나요?"
    a: "각 악기·보컬 트랙을 개별 WAV 파일로 내보낸 스템(Stem) 파일이 필요합니다. WAV 24bit/48kHz 또는 44.1kHz 포맷이 좋습니다. 처음이시면 카카오톡으로 DAW 프로젝트 종류를 알려주시면 단계별로 안내해드립니다."
  ...
  - q: "홈레코딩 보컬 파일로 믹싱이 가능한가요?"
    a: "가능합니다. 다만 방 울림이 심하거나 잡음이 많은 파일은 믹싱 품질에 한계가 있습니다. 보컬 품질이 걱정되신다면 스튜디오에서 재녹음 후 믹싱하는 방법을 권합니다."
...
스튜디오 놀(연신내, 서울 은평구) 녹음 세션에서 자주 드리는 조언입니다.
...
녹음 품질이 믹싱·마스터링 결과를 결정합니다. 보컬 품질이 걱정된다면 스튜디오 재녹음이 좋습니다.
