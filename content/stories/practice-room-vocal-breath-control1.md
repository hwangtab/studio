...
## 긴 프레이즈의 끝음이 내려앉으면 호흡이 아니라 지지가 풀린 겁니다

녹음을 받다 보면, 프레이즈 앞부분은 멀쩡한데 마지막 한두 음에서 음정이 슬며시 내려앉는 트랙을 자주 만납니다. 숨이 부족해서라고 생각하기 쉽지만, 실제로는 호흡량보다 지지가 먼저 풀리는 경우가 대부분이에요. 배로 버티던 힘이 프레이즈 끝에서 스르르 놓이면서, 성대로 가는 공기 압력이 떨어져 음이 주저앉는 겁니다.

그래서 연습은 "더 많이 들이쉬기"가 아니라 "끝까지 붙잡기"에 초점을 둬야 해요. 한 음만 잡고 "스—" 소리로 30초를 목표로 내보내되, 마지막 5초에서 배가 안으로 무너지지 않는지에만 집중해 보세요. 대개 초반은 넉넉하다가 끝에서 무너지거든요. 그 끝 5초를 버티는 감각이 곧 프레이즈 끝음을 지켜 주는 힘입니다.

녹음 전 확인은 스마트폰이면 충분해요. 가장 긴 프레이즈 하나를 부른 뒤 파형을 보면, 지지가 풀리는 지점에서 음압이 계단처럼 뚝 떨어집니다. 그 자리가 바로 오늘 연습할 한 마디예요. 곡 전체를 반복하기보다 무너지는 그 한 소절만 열 번 돌리는 편이 훨씬 빠릅니다.
