...
summary: >-
  복식호흡, 지지(Support), 폐활량 확장 훈련. 보컬 호흡의 기초부터 고급 테크닉까지 은평구 24시간 음악연습실에서 완성하세요.
---
...
스튜디오 놀(연신내, 서울 은평구) 보컬 녹음·연습실에서 호흡 컨트롤·폐활량 상담에서 반복적으로 드리는 조언입니다.

**1. 복식 호흡 — 어깨 안 움직이는 호흡**

가슴·어깨가 움직이는 호흡은 흉식 호흡. 어깨를 의식적으로 고정하고 복부만 팽창하는 훈련.

**2. 호흡 길이 — 8초 → 16초 → 24초 점진적**

복식 호흡 안정 후 호흡 길이를 점진적으로 늘리기. 8초 → 16초 → 24초 → 32초 단계별.

**3. 호흡 + 발성 — 한 호흡에 한 프레이즈 완성**

호흡 컨트롤은 결국 한 호흡에 한 프레이즈를 완성하는 능력. 호흡 분배 의식적으로 훈련.
