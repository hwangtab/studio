...
faq:
  ...
  - q: "재즈에서 7화음 대신 9th·11th·13th를 쓰는 이유는?"
    a: "확장 코드(Extended Chords)는 더 복잡하고 색깔 있는 화음을 만듭니다. Dm9은 Dm7보다 부드럽고 세련된 느낌을 주며, G13은 도미넌트(V)의 긴장감을 더욱 강조합니다. 재즈의 특유한 사운드는 이러한 확장 코드의 활용에서 나옵니다."
  - q: "재즈 코드 보이싱이란 무엇인가요?"
    a: "보이싱은 코드 구성음을 어떤 순서로, 어떤 음역에 배치하느냐의 문제입니다. 재즈 피아노에서 루트를 왼손으로 내리고, 3rd·7th·확장음을 오른손으로 조합하는 방법이 대표적입니다. 보이싱의 차이가 같은 코드도 전혀 다른 분위기로 만듭니다."
