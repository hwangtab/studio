...
## Studio NOL이 프렛리스 베이스 연습실 사용자에게 자주 권하는 3가지

스튜디오 놀(연신내, 서울 은평구) 음악연습실에서 프렛리스 베이스 연습 상담에서 반복적으로 드리는 조언입니다.

**1. 음정 시각 표시 — 라인이 없으면 스티커**

프렛리스는 라인이 없어 정확한 음정 위치 학습이 필요합니다. 음정 위치에 스티커를 붙여 시각 표시를 한 후 점차 떼는 훈련을 합니다.

**2. 튜너 + 귀 훈련 — 음정 자동화**

매 음마다 튜너로 음정 확인 후 귀로 기억합니다. 6개월 이상의 점진적 훈련이 필요합니다.

**3. 미세 비브라토 — 프렛리스 표현력**

프렛리스의 강점은 슬라이드와 미세 비브라토입니다. 음정 도달 후 손가락 미세 흔들기로 노래하는 듯한 베이스 라인을 만듭니다.
