...
스튜디오 놀(연신내, 서울 은평구) 음악연습실에서 피아노 재즈 보이싱 연습 상담 때 자주 드리는 조언입니다.

**1. Shell Voicing 우선 — 3·7도 기본 골격**

텐션을 추가하기 전 3·7도만으로 곡 전체를 연주하는 훈련부터 시작합니다. 보이싱의 골격을 먼저 잡지 않으면 텐션 추가 시 사운드가 흐려집니다.

**2. 양손 분리 연습 — 왼손 자동화 후 오른손 멜로디**

왼손 보이싱이 자동화되지 않은 상태에서 오른손 멜로디를 얹으면 박자가 흔들립니다. 왼손 보이싱을 메트로놈에 맞춰 자동화한 후 오른손을 더합니다.

**3. 녹음 자가 청취 — 보이싱 결정 검증**

같은 코드도 보이싱 선택에 따라 사운드가 크게 다릅니다. 녹음 후 청취하면 보이싱 결정의 적절성을 객관적으로 점검할 수 있습니다.
