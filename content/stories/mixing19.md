---
title: "딜레이(Delay)란? — 슬랩백·핑퐁·테이프 딜레이 종류와 믹싱 활용 완전 가이드"
date: 2025-11-29
author: "스튜디오 놀"
category: 강좌
tags: ["믹싱", "강좌", "딜레이", "Delay", "Echo"]
summary: >-
  딜레이(Delay)란 오디오 신호를 일정 시간 후 반복 재생해 공간감과 두께감을 더하는 이펙터입니다. 슬랩백(단일 반복)·핑퐁(좌우 반복)·테이프 딜레이(빈티지 에코) 타입별 특성과 BPM 동기화 설정법을 정리합니다.
