...
faq:
  ...
  - q: 완성된 비트는 어떻게 내보내나요?
    a: >-
      ...
      44.1kHz, 24bit WAV 형식이 표준입니다. 스튜디오에 MR로 제공할 때는 WAV 형식을 권합니다.
inlineFallback:
...
만든 비트를 보컬 녹음용 MR로 쓸 거라면 마지막에 꼭 WAV(44.1kHz 24bit)로 내보내세요. MP3로 넘기면 이미 한 번 손실된 소리 위에 보컬을 얹는 셈이라 믹스에서 손해를 봅니다. 제작 흐름 전체를 옆에서 잡아주는 게 필요하면, [프로듀싱 레슨](/lesson)에서 각자 만들던 트랙을 가지고 함께 다듬습니다.
