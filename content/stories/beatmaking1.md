...
author: "스튜디오 놀"
category: "강좌"
tags: ["비트 메이킹", "DAW 입문", "비트 만들기", "음악 제작 입문", "드럼 비트 만들기", "홈 프로듀싱", "프로듀서 입문"]
thumbnail: "/images/hardware4.webp"
summary: "DAW를 처음 열면 어디서부터 시작해야 할지 막막합니다. 드럼 패턴 구성부터 코드 레이어링, 멜로디 제작, 믹스다운까지 비트 메이킹 기초 프로세스를 단계별로 안내합니다."
faq:
  - q: "비트 메이킹을 시작하려면 무엇이 필요한가요?"
    a: "컴퓨터와 DAW(GarageBand, FL Studio, Ableton 등) 하나면 충분합니다. MIDI 키보드가 없어도 마우스로 피아노롤에 음표를 입력할 수 있습니다. 처음에는 무료 DAW인 GarageBand(Mac) 또는 LMMS(Windows)로 시작해도 됩니다."
  - q: "드럼 비트는 어떻게 만드나요?"
    a: "드럼 패턴은 킥(강박·4분음표), 스네어(2·4박), 하이햇(8분음표·16분음표) 순서로 레이어를 쌓습니다. 처음에는 4/4박자 8마디 루프를 만드는 연습이 기초입니다. FL Studio의 Step Sequencer나 GarageBand의 Drummer가 직관적입니다."
  - q: "비트에 어울리는 코드 진행을 어떻게 고르나요?"
    a: "힙합·R&B에서 자주 쓰이는 코드 진행은 i-VII-VI-VII(단조), I-V-vi-IV(장조) 등이 있습니다. 처음에는 검색('힙합 코드 진행 예시')으로 코드 진행을 가져와 피아노롤에 입력해보세요. 코드 이론보다 귀로 듣고 판단하는 것이 우선입니다."
  - q: "완성된 비트는 어떻게 내보내나요?"
    a: "DAW의 Export(내보내기) 기능으로 WAV(무손실) 또는 MP3(손실) 형식으로 렌더링합니다. 보컬 녹음용 MR은 44.1kHz, 24bit WAV 형식이 표준입니다. 스튜디오에 MR로 제공할 때는 WAV 형식을 권장합니다."
---
