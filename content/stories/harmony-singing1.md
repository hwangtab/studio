...
author: "스튜디오 놀"
category: "녹음 가이드"
tags: ["하모니 노래", "코러스 녹음", "화음 보컬", "하모니 보컬", "보컬 하모니", "화음 어레인지", "코러스 레코딩"]
thumbnail: "/images/room3.webp"
summary: "하모니 보컬(코러스·화음) 녹음과 어레인지 완전 가이드입니다. 3도·5도 하모니 원리, 코러스 레코딩 전략, 더블 트래킹, 하모니 스태킹, 믹싱 포인트를 정리합니다."
faq:
  - q: "하모니 보컬은 어떻게 잡나요?"
    a: "주선율 음에서 3도(단3도 또는 장3도) 또는 5도 위아래 음을 화음으로 사용하는 것이 기본입니다. 코드 스케일에 맞는 음을 귀로 확인하며 잡습니다. 피아노로 먼저 음을 확인한 후 녹음하면 도움이 됩니다."
  - q: "코러스 녹음은 몇 번 겹치는 것이 좋나요?"
    a: "리드 보컬 기준 코러스 2~4트랙 겹치기(더블 또는 쿼드 트래킹)가 일반적입니다. 각 테이크의 타이밍과 음정이 조금씩 달라야 자연스러운 두께감을 만듭니다."
  - q: "하모니 보컬을 혼자 녹음할 수 있나요?"
    a: "가능합니다. 리드 보컬 트랙을 먼저 녹음한 뒤, 같은 가수가 화음 트랙을 따로 녹음하는 방식(오버더빙)으로 풍성한 하모니를 만들 수 있습니다."
  - q: "하모니 보컬 믹싱 시 주의사항은 무엇인가요?"
    a: "하모니 트랙은 주선율보다 레벨을 낮게 설정해야 합니다. 주선율 보컬이 묻히지 않도록 하모니 트랙에 EQ로 중역을 소폭 컷하거나 리버브를 더해 뒤로 물러나는 느낌을 주세요."
---
