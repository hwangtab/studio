...
faq:
  - q: 피아노 코드 대리·리하모나이제이션을 처음 연습할 때 어디서부터 시작해야 하나요?
    a: >-
      피아노 코드 대리·리하모나이제이션 연습은 코드 대리의 기본 원리, 토닉 대리, 서브도미넌트 대리 순서로 진행하는 것을 추천합니다.
      기초 단계를 충분히 소화한 후 다음 단계로 넘어가세요.
  - q: 피아노 코드 대리·리하모나이제이션 연습 시 가장 중요한 포인트는 무엇인가요?
    a: >-
...
스튜디오 놀(연신내, 서울 은평구) 음악연습실에서 피아노 코드 대체·리하모니제이션 연습 상담에서 반복적으로 드리는 조언입니다.
