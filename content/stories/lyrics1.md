...
summary: >-
  작사 방법 과정을 작곡·편곡·녹음 흐름에 맞춰 정리합니다. 홈레코딩에서 적용할 방법과 Studio NOL 제작 상담 전 준비할 내용을 함께 확인하세요.
faq:
  - q: 가사를 처음 써보는데 어떻게 시작해야 하나요?
    a: >-
      지금 가장 강하게 느끼는 감정이나 경험에서 시작하세요. '쓰고 싶은 말'을 먼저 산문으로 적고, 그 핵심 단어들을 추려 가사로 다듬는
      방법이 효과적입니다. 처음부터 좋은 가사를 목표로 하면 막힙니다. 나쁜 가사를 많이 쓰면서 좋은 가사가 나옵니다.
  - q: 가사에 라임(운율)이 반드시 필요한가요?
    a: >-
      꼭 필요하진 않지만 라임은 기억에 남는 가사를 만드는 데 유용한 도구입니다. 특히 한국어는 어미 변화로 자연스러운 라임이
...
- **프리코러스 (Pre-chorus)**: 감정 재고조
- **코러스 (Chorus)**: 반복
- **브리지 (Bridge)**: 전환점·새로운 관점
- **코러스 (Chorus)**: 아우트로로 마무리
...
## 작사가 막힐 때, 저는 감정의 이름부터 지우라고 합니다

작사를 처음 하는 분들은 대부분 "잘 쓰려는" 마음 때문에 막힙니다. 예쁜 단어, 그럴듯한 비유를 먼저 찾다가 한 줄도 못 넘기는 거죠. 저는 순서를 뒤집으시라고 합니다. 잘 쓰려 하지 말고, 지금 하고 싶은 말을 그냥 산문으로 쏟아낸 다음 거기서 가사를 캐내는 방식이 훨씬 잘 굴러갑니다. 나쁜 초고를 겁내지 않는 사람이 결국 좋은 가사에 도착합니다.

그리고 감정의 이름을 직접 쓰지 마시라고 자주 말합니다. '슬프다', '보고 싶다'는 감정의 라벨이지 감정 그 자체가 아닙니다. 본문에서 든 예처럼, 버스 창문에 서린 습기에 이름을 쓰는 장면 한 컷이 "슬프다" 열 번보다 강합니다. 신기한 건 이렇게 구체적으로 쓸수록 오히려 더 많은 사람이 자기 이야기처럼 받아들인다는 겁니다. 구체적일수록 보편적이 된다는 이 역설이 작사의 핵심이라고 저는 생각합니다.

실력을 가장 빨리 끌어올리는 훈련은 받아쓰기입니다. 좋아하는 곡의 가사를 손으로 그대로 옮겨 적으면서, 버스와 코러스가 어떻게 나뉘고 어디서 라임이 걸리는지 눈으로 뜯어보세요. 저도 편곡·프로듀싱을 하며 수많은 가사가 곡에 얹히는 걸 봐왔는데, 잘 되는 가사에는 예외 없이 이 '뜯어본 흔적'이 있습니다. 하루 세 줄 일기에서 한 줄을 골라 가사처럼 다듬는 습관을 석 달만 이어가면, 코러스 한 줄이 저절로 떠오르는 순간이 옵니다.
