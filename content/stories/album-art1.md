...
author: "스튜디오 놀"
category: "음반 제작 가이드"
tags: ["앨범 아트", "앨범 재킷", "커버 아트", "음원 커버", "스포티파이 커버", "멜론 커버", "앨범 아트 제작"]
thumbnail: "/images/recording14.webp"
summary: "음원 발매를 위한 앨범 아트·재킷 제작 가이드입니다. 플랫폼별 이미지 규격, 저작권 없는 이미지 소스, 무료 디자인 툴 활용법, 아티스트 사진 활용 팁을 정리합니다."
faq:
  - q: "멜론·스포티파이 커버 아트 규격은 무엇인가요?"
    a: "대부분의 플랫폼은 3000×3000px (최소 1400×1400px), JPG 또는 PNG, RGB 색상 모드를 요구합니다. 멜론·지니는 3000×3000px JPG를 권장합니다. 스포티파이는 1:1 비율, 최소 640×640px이지만 3000×3000px이 표준입니다."
  - q: "앨범 아트 제작에 저작권 없는 이미지를 어디서 구하나요?"
    a: "Unsplash·Pexels(사진), Freepik·Flaticon(일러스트), Pixabay(사진+일러스트)에서 무료로 사용할 수 있습니다. 단, 각 사이트의 라이센스 조건을 확인하세요. AI 이미지 생성 도구(Midjourney, DALL-E)를 활용하는 방법도 있습니다."
  - q: "무료로 앨범 아트를 디자인할 수 있는 툴이 있나요?"
    a: "Canva(무료 플랜, 3000×3000px 지원), Adobe Express(무료 플랜), GIMP(무료 편집 툴)를 활용할 수 있습니다. Canva는 음악 앨범 아트 템플릿이 많아 비디자이너에게 가장 편리합니다."
  - q: "아티스트 사진을 앨범 커버로 쓰고 싶은데 어떻게 해야 하나요?"
    a: "아티스트 사진을 커버에 사용할 때는 배경 제거(remove.bg, Canva), 텍스트 오버레이, 필터/색조 처리로 완성도를 높입니다. 사진 촬영 시부터 앨범 커버 용도를 의도하고 1:1 정방형 프레임으로 찍으면 편리합니다."
---
