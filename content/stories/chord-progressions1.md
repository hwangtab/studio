...
faq:
  ...
  - q: "I-V-vi-IV 진행이 많이 사용되는 이유는?"
    a: "이 진행은 장조(I), 장조(V), 단조(vi), 장조(IV)의 조합으로 자연스럽게 해결되는 화성 흐름을 갖습니다. 수천 곡이 이 진행을 사용하지만 멜로디와 편곡에 따라 항상 새롭게 들립니다."
  - q: "차용 화음(Borrowed Chord)이란?"
    a: "같은 조성이 아닌 동일한 으뜸음을 가진 다른 조에서 화음을 빌려오는 기법입니다. 예를 들어 C장조에서 bVII (Bb장조)를 사용하면 독특한 색채가 생깁니다. 팝에서 IV minor chord를 차용하는 것도 흔한 기법입니다."
