...
author: "스튜디오 놀"
category: "강좌"
tags: ["음반 커버 아트", "앨범 커버 디자인", "스트리밍 커버 이미지", "음원 발매 준비", "커버 아트 규격", "인디 뮤지션", "디지털 싱글"]
thumbnail: "/images/album2.webp"
summary: "멜론·스포티파이·애플뮤직 등 스트리밍 플랫폼에 제출하는 음반 커버 아트 규격과 제작 방법 완전 가이드. 직접 제작 도구, 저작권 없는 이미지 활용법, 디자이너 의뢰 방법까지 정리합니다."
faq:
  - q: "음원 발매용 커버 아트 규격은 어떻게 되나요?"
    a: "스트리밍 플랫폼 공통 기준: 3000×3000px, JPEG 또는 PNG, RGB 색상 모드, 72~300dpi, 파일 크기 10MB 이하가 권장됩니다. 멜론·카카오뮤직은 600×600px 이상, 스포티파이·애플뮤직은 3000×3000px를 기본으로 요구합니다."
  - q: "스마트폰 앱으로 커버 아트를 만들 수 있나요?"
    a: "네. Canva, Adobe Express(무료), UNUM, Over 등 앱으로 템플릿 기반 커버 아트를 만들 수 있습니다. 단, 무료 템플릿 이미지는 저작권 확인이 필요합니다. Canva Pro에서는 상업적 사용 허가 이미지를 사용할 수 있습니다."
  - q: "유명 사진 또는 이미지를 커버 아트에 사용해도 되나요?"
    a: "타인의 사진이나 유명인 사진, 영화 스틸컷 등은 저작권 침해에 해당합니다. 자신이 직접 찍은 사진, 저작권 없는 이미지(Unsplash, Pexels, Pixabay), 또는 직접 제작한 일러스트를 사용하세요."
  - q: "AI로 커버 아트를 생성해서 사용해도 되나요?"
    a: "Midjourney, DALL·E, Stable Diffusion 등 AI 생성 이미지는 현재 저작권 법적 지위가 국가마다 다릅니다. 상업적 발매용으로 사용 시 해당 AI 서비스의 이용 약관(commercial use 허용 여부)을 반드시 확인하세요."
---
