...
리스트는 부탁으로 모이지 않습니다. 미공개 데모든 어쿠스틱 버전이든, 이메일 주소를 적어줄 만한 가치가 있는 걸 먼저 만들어 두세요. 저는 [발매 작업](/release-project)을 할 때 늘 "이 곡의 데모 버전은 팬에게 줄 선물로 남겨두자"고 제안합니다. 완성본에 안 들어간 초기 스케치가 의외로 반응이 좋아요.
