...
엔지니어 분께서 녹음 모니터링을 하면서 디렉션을 주셨습니다. CF 내레이션 첫 번째 테이크에서 아나운서 투로 읽고 있다는 지적을 받았습니다. 학원에서 연습해온 방식이었는데, 스튜디오 모니터로 들으니 딱딱하게 들렸습니다. "편하게 말하듯이, 제품 설명하는 사람처럼요"라는 한 마디가 방향을 잡아줬고, 두 번째 테이크부터 감이 잡혔습니다. 이후 "조금 더 밝게", "속도를 살짝 늦추면 좋을 것 같아요"처럼 세부 피드백으로 이어졌고, 성우 학원 선생님과는 다른 시각에서 도움을 받는 느낌이었습니다.
...
학원 선생님께 보여드렸더니 "환경이 바뀌니까 목소리가 제대로 들리네"라고 하셨습니다. 데모 테이프 퀄리티가 오디션에서 첫인상을 좌우한다는 말씀도 해주셨는데, 이번 녹음이 방향이 맞다는 확신이 생겼습니다.
