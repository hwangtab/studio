...
summary: >-
  녹음 세션 후 받는 파일 형식(WAV, 스템, 믹스다운)의 차이와 용도를 설명합니다. 음원 발매, 믹싱 의뢰, 유튜브 업로드별 필요한 파일 형식과 요청 방법까지 안내합니다. 스튜디오 녹음 전 준비사항부터 세션 후 파일 전달까지 연신내 스튜디오 놀의 실전 경험을 바탕으로 안내합니다.
faq:
  - q: 스템(Stem) 파일이 무엇인가요?
    a: >-
