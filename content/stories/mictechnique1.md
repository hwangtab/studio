...
## Studio NOL이 마이크 테크닉 입문자에게 자주 권하는 3가지

스튜디오 놀(연신내, 서울 은평구)에서 마이크 테크닉 입문 상담 때 자주 드리는 조언입니다.

**1. 강한 구간 → 멀리, 약한 구간 → 가까이**

다이나믹 컨트롤은 거리 조절로.

**2. 입김 직격 회피**

ㅍ·ㅂ 자음은 팝 필터 + 오프액시스로 분산.

**3. 모니터 헤드폰 한쪽 빼기**

피치 인식 향상. 한쪽 귀로 실내 사운드 청취.
