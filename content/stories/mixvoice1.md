...
summary: >-
  믹스 보이스(Mix Voice) 내는 법과 흉성·두성 연결 훈련. Studio NOL 보컬 레슨 패턴.
faq:
  - q: 믹스 보이스란 무엇인가요?
    a: >-
...
## Studio NOL 보컬 레슨에서 믹스 보이스가 막히는 경우 3가지

보컬 레슨에서 믹스 보이스 훈련이 막히는 패턴은 거의 동일합니다. 스튜디오 놀에서 반복적으로 확인하는 3가지입니다.
...
중저음에서 흉성으로 강하게 부르는 습관이 있는 보컬은 패시지오 전환이 더 어렵습니다. 흉성의 무게가 두성 연결을 방해합니다. 이 경우 중음역을 의도적으로 얇게 부르는 연습부터 시작해서 두성과의 접점을 넓혀가는 방향으로 진행합니다. 레슨에서 이 교정에 보통 3~5세션이 걸립니다.

**3. 두성 연결 직전에 포기한다**

패시지오 바로 위 음에서 소리가 불안정하게 느껴지면 두성으로 넘어가지 않고 그 음역을 피하는 방향으로 습관이 굳어집니다. 불안정한 연결음을 반복해서 통과하는 훈련이 필요하며, 이 구간을 의도적으로 자주 지나다니는 패턴으로 레슨을 구성합니다.
