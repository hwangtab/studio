...
faq:
  ...
  - q: "브라스 편곡을 처음 시작하려면 무엇이 필요한가요?"
    a: "각 악기의 음역을 파악하는 것이 먼저입니다. 트럼펫(B♭ ~ F6), 트롬본(E2 ~ B♭5), 알토색소폰(D♭3 ~ A5) 등 기본 음역과 이조 악기 처리(B♭ 조율)를 이해하면 편곡이 훨씬 수월해집니다."
  - q: "재즈와 R&B 브라스 편곡은 어떻게 다른가요?"
    a: "재즈 브라스는 즉흥성과 스윙 리듬이 중심으로, 솔로 구간과 빅밴드 앙상블이 특징입니다. R&B·소울 브라스는 짧고 리드미컬한 리프(Stab)와 탄탄한 유니즌 사운드가 특징이며, 함수 팝과 디스코 음악에서도 핵심 요소입니다."
