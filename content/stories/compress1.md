...
summary: >-
  보컬 믹싱에서 컴프레서를 어떻게 사용하는지 설명합니다. 어택·릴리즈·레시오·스레숄드 설정의 의미와 보컬 장르별 컴프레서 세팅 가이드를 정리했습니다. 홈레코딩 환경에서도 바로 적용할 수 있는 실전 팁을 단계별로 정리합니다.
faq:
  - q: "컴프레서가 무엇인가요?"
