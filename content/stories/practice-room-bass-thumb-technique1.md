...
faq:
  - q: 베이스 썸 테크닉·슬랩 베이스 고급을 처음 연습할 때 어디서부터 시작해야 하나요?
    a: >-
      ...
      스타일 순서로 진행하면 좋습니다. 기초 단계를 충분히 소화한 후 다음 단계로 넘어가세요.
  - q: 베이스 썸 테크닉·슬랩 베이스 고급 연습 시 핵심 포인트는 무엇인가요?
    a: >-
...
## Studio NOL이 베이스 썸 테크닉 연습실 사용자에게 자주 권하는 3가지

스튜디오 놀(연신내, 서울 은평구) 음악연습실에서 베이스 썸·슬랩 고급 연습 상담 때 자주 드리는 조언입니다.

**1. 엄지 각도 — 줄과 30~45도 유지**

엄지가 줄과 평행하거나 직각이면 어택이 둔합니다. 30~45도 비스듬한 각도로 줄에 닿아야 펀치감이 살아납니다.

**2. 손목 회전 — 손목 단독 움직임**

엄지를 휘둘러 치는 것이 아니라 손목 회전으로 줄을 칩니다. 손목이 굳으면 빠른 슬랩이 불가능합니다.

**3. 메트로놈 BPM 70 — 균일성 우선**

빠르게 치려 하면 음량 편차가 생깁니다. BPM 70에서 음량 균일성을 잡은 뒤 단계적으로 BPM을 올립니다.
