...
faq:
  - q: 피아노 발라드 연주 기법·감성 표현을 처음 연습할 때 어디서부터 시작해야 하나요?
    a: >-
      피아노 발라드 연주 기법·감성 표현 연습은 루바토(Rubato) 이해하기, 페달 테크닉 심화, 다이나믹 쉐이핑 순서로 진행하면 좋습니다. 기초 단계를 익힌 뒤 다음 단계로 넘어가세요.
  - q: 피아노 발라드 연주 기법·감성 표현 연습할 때 무엇을 신경 쓰면 좋나요?
    a: >-
...
summary: >-
  피아노 발라드의 루바토, 페달 기법, 다이나믹 쉐이핑. 감성적 발라드 연주의 핵심 기술을 은평구 24시간 음악연습실에서 완성하세요.
---
...
## 발라드 테크닉은 페달과 터치의 미세한 차이에서 갈립니다

발라드를 잘 치는 사람과 아닌 사람의 차이는 아주 미세한 손끝과 발끝의 컨트롤에 있어요. 먼저 페달 교체 타이밍입니다. 음이 바뀌는 순간 페달을 올렸다가 즉시 다시 밟는, 이 동작이 0.1초만 늦어도 앞뒤 화음이 뒤섞여 소리가 뿌옇게 흐려져요. '음 바뀌는 찰나에 올리고 곧바로 밟기'를 몸이 반사적으로 할 때까지 반복 훈련해야 합니다.

여린 소리, 피아니시모(pp)를 내는 법도 오해가 많아요. pp는 힘을 빼는 게 아니라 건반을 내리는 속도를 늦추는 겁니다. 같은 깊이로 누르되 천천히 눌러 해머가 현을 부드럽게 때리게 하면, 작으면서도 죽지 않는 여린 소리가 나요. 속도로 음색을 만드는 이 감각이 발라드 터치의 핵심입니다.

문제는 이 미세한 차이가 연주 중에는 잘 안 들린다는 거예요. 페달 밟는 소음이나 터치의 불균일함은 몸으로 치는 동안 놓치기 쉽습니다. 그래서 스마트폰으로 녹음해 헤드폰으로 들어 보는 루틴이 필수예요. 발라드의 전체 표현 설계는 [피아노 발라드 연습](/stories/practice-room-piano-ballad1)에서 이어집니다.

---

[피아노 인상주의·드뷔시·라벨·색채 화성 — 완전 가이드](/stories/practice-room-piano-impressionist1) | [피아노 뉴에이지·Einaudi·George Winston 스타일 — 완전 가이드](/stories/practice-room-piano-new-age1) | [피아노 팝 편곡·발라드 반주법 — 완전 가이드](/stories/practice-room-piano-pop-arrangement1) | [피아노 래그타임·Scott Joplin 스타일 — 완전 가이드](/stories/practice-room-piano-ragtime1)
