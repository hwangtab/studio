...
## Studio NOL이 발라드 피아노 테크닉 연습자에게 자주 권하는 3가지

스튜디오 놀(연신내, 서울 은평구) 음악연습실에서 발라드 피아노 테크닉 상담에서 반복적으로 드리는 조언입니다.

**1. 페달 교체 — 음 바뀌는 순간 즉시**

페달 체인지 타이밍이 0.1초 늦으면 하모닉이 흐릿해집니다. "음 바뀌는 순간 페달 올리고 즉시 다시 밟기"를 반복 훈련.

**2. 피아니시모(pp) — 손가락 속도로 만들기**

pp는 힘을 빼는 것이 아니라 손가락 내리는 속도를 천천히 하는 것입니다. 같은 힘으로도 속도 조절로 음색 변화.

**3. 녹음 청취 — 페달·터치 객관화**

페달 소음과 터치 차이는 연주 중에는 잘 안 들립니다. 스마트폰 녹음 → 헤드폰 청취 루틴이 필수입니다.
