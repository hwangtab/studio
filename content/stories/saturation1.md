...
summary: >-
  새추레이션(Saturation) 완전 가이드. 테이프·튜브·트랜지스터 새추레이션 차이, 보컬·드럼·믹스버스에 적용하는 방법, 추천 플러그인까지 아날로그 따뜻함을 더하는 실전 가이드. 스튜디오 녹음 전 준비사항부터 세션 후 파일 전달까지 연신내 스튜디오 놀의 실전 경험을 바탕으로 안내합니다.
faq:
  - q: 새추레이션이란 무엇인가요?
    a: >-
