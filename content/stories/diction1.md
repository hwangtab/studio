...
summary: >-
  보컬 딕션 정보를 보컬 훈련 순서, 녹음 실수, 피드백 기준으로 정리합니다. 연신내 Studio NOL 레슨·녹음에서 바로 점검할 포인트를 담았습니다.
faq:
  - q: 딕션이란 무엇인가요?
    a: >-
...
## Studio NOL이 보컬 딕션 연습자에게 자주 권하는 3가지

스튜디오 놀(연신내, 서울 은평구)에서 보컬 딕션·발음 상담에서 반복적으로 드리는 조언입니다.

**1. 치찰음 — 입 측면으로 살짝 돌리기**

ㅅ·ㅊ·ㅈ 발음 시 마이크 정면 X. 살짝 측면 돌리기.

**2. 받침 — 다음 음절 전 끊고 시작**

받침이 다음 모음으로 연음되면 뭉개짐. 의식적 끊기.

**3. 느린 템포 — 발음 정확 우선**

빠른 곡에서 딕션 무너지기 쉬움. 느린 템포에서 발음 100% → 점진적 빠르게.
