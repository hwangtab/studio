...
faq:
  ...
  - q: 노래할 때 발음이 뭉개지는 이유는 무엇인가요?
    a: >-
      자음(특히 초성 자음)을 약하게 처리하거나, 입을 덜 열거나, 혀가 굳어 있을 때 발음이 뭉개집니다. 또한 빠른 템포의
  ...
  - q: 딕션 훈련은 어떻게 시작하면 되나요?
    a: >-
      처음에는 느린 템포로 가사를 하나씩 또렷하게 발음하는 연습부터 시작합니다. 거울을 보며 입 모양이 잘 열리는지 확인하세요.
...
제가 세션 전에 자주 드리는 부탁은 딱 하나입니다. 부를 곡의 가사를 소리 내어 한 번 낭독해보고, 스스로 뭉개지는 지점을 표시해 오시라는 거예요. 그 몇 분이 녹음실에서 반복 테이크로 날리는 시간을 크게 줄여줍니다. 발음을 정돈해 녹음실에 오시면 저도 훨씬 편하게 좋은 테이크를 뽑을 수 있으니, 녹음을 계획 중이시라면 [녹음 요금 안내](/pricing)를 미리 확인해두세요.
