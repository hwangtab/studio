...
## Studio NOL이 록 리드 기타 연습실 사용자에게 자주 권하는 3가지

스튜디오 놀(연신내, 서울 은평구) 음악연습실에서 록 리드 기타 연습 상담에서 반복적으로 드리는 조언입니다.

**1. 펜타토닉 + 블루스 스케일 — 록 솔로 골격**

록 리드의 골격은 마이너 펜타토닉 + 블루스 스케일입니다.

**2. 벤딩 + 비브라토 — 표현력 절반**

록 리드의 절반은 벤딩과 비브라토 표현력입니다.

**3. 오버드라이브 + 부스트 — 솔로 톤**

리듬 톤보다 솔로 시 부스트로 음량과 게인을 올립니다.
