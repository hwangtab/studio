...
**모노에서 한 번은 꼭 확인한다.** 더블을 좌우로 시원하게 벌려두면 스피커에선 멋지지만, 이어폰 한쪽이 빠지거나 모노로 재생되는 순간 보컬이 훅 사라질 수 있습니다. 저는 믹스 중에 반드시 모노로 접어 들어보고, 그래도 보컬이 가운데 단단히 서 있는지를 마지막에 점검합니다. 이런 판단은 [녹음 세션](/pricing)에서 곡 성격을 함께 들어본 뒤 정하는 편이 실패가 적습니다.
