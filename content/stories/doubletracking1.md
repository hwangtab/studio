...
summary: >-
  더블 트래킹은 같은 멜로디를 두 번 녹음해 겹쳐서 소리를 풍성하고 두껍게 만드는 기술입니다. 방법, 설정, 활용 장르별 노하우를 정리합니다.
faq:
  - q: 보컬 더블 트래킹이란 무엇인가요?
    a: >-
...
## Studio NOL이 더블 트래킹 보컬 녹음자에게 자주 권하는 3가지

스튜디오 놀(연신내, 서울 은평구)에서 더블 트래킹 보컬 상담에서 반복적으로 드리는 조언입니다.

**1. 두 번째 테이크 — 첫 테이크 직후**

첫 테이크 직후 두 번째. 시간이 지나면 컨디션 변화로 더블링 효과 감소.

**2. 좌우 펜닝 — 50%~100%**

더블 트래킹 두 트랙은 좌우 펜닝(L 50%, R 50%) 적용. 두꺼운 사운드.

**3. 피치 교정 — 미세 변이 유지**

피치 교정 시 -15~+15cent 미세 변이 유지. 완벽 정렬은 더블링 효과 소멸.
