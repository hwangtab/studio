...
faq:
  - q: "믹싱(Mixing)이란 무엇인가요?"
    a: "믹싱은 보컬·드럼·기타·베이스 등 여러 트랙을 하나의 스테레오 파일로 완성하는 과정입니다. 볼륨·패닝·EQ·컴프레서·리버브 등을 조합해 각 악기가 잘 들리면서도 전체적으로 어우러지는 사운드를 만듭니다."
  - q: "믹싱을 직접 배울 수 있나요?"
    a: "네, 배울 수 있습니다. 스튜디오 놀의 믹싱 강좌 시리즈는 입문자도 이해할 수 있는 순서로 구성되어 있습니다. 꾸준히 따라오시면 실전 믹싱 능력을 기를 수 있습니다."
---
