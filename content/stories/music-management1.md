...
summary: >-
  음악 매니지먼트 정보를 비용, 일정, 준비물 기준으로 비교합니다. Studio NOL 상담 전에 예산과 선택 기준, 의뢰 전 확인할 내용을 빠르게 정리하세요.
faq:
...
## Studio NOL 발매 클라이언트가 매니저 선택에서 가장 자주 받는 3가지 위험 신호

스튜디오 놀에서 발매 후 매니저 영입을 고민하는 클라이언트가 자주 마주치는 위험 신호입니다.

**1. "수수료 50%" — 과도한 수익 분배 요구**

매니저 수수료는 일반적으로 매출의 10~20%가 표준입니다. 50% 이상을 요구하는 경우는 위험 신호이며, 신인 아티스트라도 30%를 넘기지 않는 것이 시장 기준입니다.

**2. 계약 기간 — 3년 이상 + 자동 연장 조항**

3년 이상 장기 계약 + 자동 연장 조항이 있으면 매니저와 신뢰가 깨졌을 때 분리가 어렵습니다. 1~2년 계약으로 시작해 성과에 따라 연장 협상하는 것이 안전합니다.

**3. "포트폴리오·레퍼런스 공유 거부"**

이전에 어떤 아티스트를 매니지먼트했는지, 어떤 성과를 만들었는지 묻을 때 회피하거나 모호하게 답한다면 위험 신호입니다. 공유 가능한 레퍼런스가 명확한 매니저를 선택하는 것이 기본입니다.
...
## 매니저는 없는 걸 만들어주지 않습니다, 있는 걸 키워줄 뿐이에요

발매를 몇 번 하고 나면 "이제 매니저가 필요한 것 같다"는 상담을 종종 받습니다. 그때 제가 되묻는 건 "지금 매니저에게 맡길 만한 게 손에 있느냐"입니다. 좋은 매니저는 이미 굴러가는 활동을 더 크게 키워주는 사람이지, 아직 아무것도 없는 상태를 대신 만들어주는 사람이 아니거든요. 발매작도, 무대 경험도, 최소한의 기록도 없는 상태에서 매니저부터 구하면 대개 서로 실망하고 끝납니다.

그래서 초기에는 셀프 매니지먼트 근육부터 붙이시라고 말합니다. 본문에 나온 것처럼 일정·정산·저작권 등록을 스스로 굴려본 사람은, 나중에 매니저가 생겨도 무엇을 위임하고 무엇을 직접 챙길지 압니다. 반대로 이걸 한 번도 안 해본 사람은 통째로 맡겼다가 정산이 어떻게 도는지도 모른 채 끌려다니기 쉬워요. 적어도 저작권료가 어디서 얼마 들어오는지는 본인이 읽을 줄 알아야 합니다.

계약서 이야기가 나오면 저는 늘 한발 물러섭니다. 수수료 기준이든 해지 조건이든 이건 제가 조언할 수 있는 선이 아니라 음악 전문 변호사의 몫입니다. 제가 도와드릴 수 있는 건 매니저에게 보여줄 '맡길 만한 결과물' — 완성도 있는 음원과 발매 실적 — 을 만드는 앞단까지예요. 그 토대가 단단할수록 더 좋은 매니저를 만날 확률도 올라갑니다.
