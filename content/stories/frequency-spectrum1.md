...
## Studio NOL 믹싱에서 주파수 대역을 보는 방식 — U87Ai 보컬과 각 악기의 충돌 포인트

주파수 이론을 알아도 실제 믹스에서 어디가 충돌하는지 모르면 EQ를 엉뚱한 곳에 씁니다.

**충돌 포인트 1: 보컬 2~4kHz vs 어쿠스틱 기타 프레즌스**
Neumann U87Ai로 녹음한 보컬은 2~5kHz 프레즌스 대역이 풍부합니다. 어쿠스틱 기타도 같은 대역에 공명이 집중됩니다. 두 트랙이 믹스에서 겹치면 보컬이 "기타에 파묻힌다"는 느낌이 납니다. 해결은 기타의 3~4kHz를 1~2dB 좁게 컷하는 것입니다. 보컬을 올리는 것보다 기타를 비켜주는 게 훨씬 자연스럽습니다.

**충돌 포인트 2: 킥드럼 80Hz vs 베이스 기타 저역**
킥과 베이스가 함께 들어오는 순간 저역이 뭉치는 현상은 두 악기가 80~120Hz를 놓고 경쟁하기 때문입니다. 킥은 60~80Hz "펀치"를 살리고 80~120Hz를 약간 줄이며, 베이스는 반대로 80~120Hz를 유지하고 60Hz 이하를 HPF로 정리합니다. 킥이 들어올 때 베이스가 살짝 뒤로 물러나는 사이드체인 컴프레서도 함께 씁니다.

**충돌 포인트 3: 보컬 저중역 250~400Hz 누적**
여러 트랙이 동시에 250~400Hz 에너지를 가지면 믹스 전체가 탁하고 무거워집니다("머디"). 보컬 외 악기들(피아노, 어쿠스틱 기타, 신디사이저 패드)의 저중역을 각각 1~2dB씩 컷하면 보컬이 앞으로 나오고 믹스가 투명해집니다. 악기 하나하나는 작은 컷이지만 합산하면 효과가 큽니다.
