...
author: "스튜디오 놀"
category: "음반 제작 가이드"
tags: ["음악 퍼블리싱", "음악 저작권", "작곡가 수익", "퍼블리셔", "KOMCA", "저작인접권", "음악 수익"]
thumbnail: "/images/service2.webp"
summary: "음악 퍼블리싱 완전 가이드입니다. 퍼블리싱의 개념과 수익 구조, KOMCA 가입 방법, 퍼블리셔와의 계약 주의사항, 자가 퍼블리싱 vs 퍼블리셔 계약 비교를 정리합니다."
faq:
  - q: "음악 퍼블리싱이란 무엇인가요?"
    a: "음악 퍼블리싱은 작곡·작사 저작권을 관리하고 수익을 창출하는 활동입니다. 스트리밍 재생, 음원 판매, 공연 사용료, 방송 사용료, 싱크 라이센스(광고·영화) 등에서 저작권료를 받습니다. 퍼블리셔는 이 과정을 대행하고 수익 일부를 가져갑니다."
  - q: "KOMCA(한국음악저작권협회)란?"
    a: "KOMCA는 한국의 저작권 신탁 관리 단체입니다. 음악 저작권자를 대신해 음원 사용료를 징수하고 분배합니다. 작곡가·작사가는 KOMCA에 저작물을 신탁하면 방송·공연·스트리밍 사용료를 분기마다 받을 수 있습니다."
  - q: "자가 퍼블리싱과 퍼블리셔 계약의 차이는?"
    a: "자가 퍼블리싱은 저작권의 100%를 유지하지만 홍보·마케팅·라이센싱을 직접 해야 합니다. 퍼블리셔 계약은 보통 50% 퍼블리셔 몫으로 권리 일부를 주지만, 음반사·브랜드 등에 적극적으로 곡을 판매(pitch)해줍니다. 초기 아티스트는 자가 퍼블리싱으로 시작하는 것이 일반적입니다."
  - q: "싱크 라이센싱이란 무엇인가요?"
    a: "싱크 라이센싱(Sync Licensing)은 음악을 광고·영화·드라마·유튜브 등 영상 콘텐츠에 사용 허가하고 라이센스 피를 받는 것입니다. 한 번의 싱크 계약으로 큰 수익이 가능하며, 주요 수익원 중 하나입니다."
---
