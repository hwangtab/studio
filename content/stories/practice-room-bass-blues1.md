...
faq:
  ...
  - q: 베이스 블루스·12마디 블루스 베이스라인 연습 시 가장 중요한 포인트는 무엇인가요?
    a: >-
      베이스 블루스·12마디 블루스 베이스라인 연습에서 가장 중요한 것은 정확한 리듬감과 톤 컨트롤입니다. 드럼 트랙과 함께 연습하며
      그루브 감각을 키우세요.
...
## Studio NOL이 블루스 베이스 연습실 사용자에게 자주 권하는 3가지

스튜디오 놀(연신내, 서울 은평구) 음악연습실에서 베이스 블루스·12마디 블루스 베이스라인 연습 상담에서 반복적으로 드리는 조언입니다.

**1. 12마디 진행 우선 — 블루스 베이스 골격**

블루스 베이스의 골격은 12마디 I-IV-V 진행입니다. 12키에서 12마디 진행을 익히면 어떤 블루스 곡도 즉시 따라갈 수 있습니다.

**2. 셔플 그루브 — 8분음 2:1 비율**

블루스 베이스는 셔플 그루브로 연주됩니다. 8분음을 균등 분할이 아닌 2:1 비율로 셔플합니다.

**3. 워킹 베이스 + 부기우기 — 블루스 스타일**

전통 블루스는 부기우기 패턴, 모던 블루스는 워킹 베이스 라인을 자주 씁니다. 두 스타일을 모두 익힙니다.
