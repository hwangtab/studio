...
faq:
  ...
  - q: 드럼 아프로큐반 리듬·클라베 연습 시 핵심 포인트는 무엇인가요?
    a: >-
      드럼 아프로큐반 리듬·클라베 연습에서는 일정한 타이밍과 스틱 컨트롤이 중요합니다. 메트로놈과 함께 느린 BPM부터 시작해
      정확도를 높이세요.
...
스튜디오 놀(연신내, 서울 은평구) 음악연습실에서 아프로쿠반·라틴 드럼 연습 상담 때 자주 드리는 조언입니다.
