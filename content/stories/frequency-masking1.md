...
summary: >-
  주파수 마스킹 설정 기준과 작업 순서를 정리합니다. 홈레코딩에서 바로 적용할 체크포인트와 Studio NOL 믹싱 의뢰 전 준비할 파일까지 확인하세요.
faq:
  - q: 주파수 마스킹이란 무엇인가요?
    a: >-
...
## Studio NOL이 주파수 마스킹 해결자에게 자주 권하는 3가지

스튜디오 놀(연신내, 서울 은평구)에서 주파수 마스킹·믹싱 상담에서 반복적으로 드리는 조언입니다.

**1. 다이나믹 EQ — 사이드체인 활용**

정적 EQ보다 다이나믹 EQ가 자연스러운 마스킹 해결.

**2. 보컬 + 기타 1~3kHz — 가장 큰 충돌**

보컬과 기타 중역(1~3kHz)이 마스킹 주요 영역. 사이드체인으로 -3~4dB 감쇄.

**3. SPAN 스펙트럼 분석 — 시각적 확인**

SPAN 플러그인으로 레퍼런스 vs 본인 스펙트럼 시각 비교.
