...
howTo:
  ...
  steps:
    ...
    - name: "2단계: 장르·작업 스타일 매칭"
      text: "발라드·팝·OST 등 어쿠스틱 중심은 Cubase 또는 Logic. 일렉트로닉·힙합 비트 메이킹·라이브 퍼포먼스는 Ableton Live. K-POP 보컬 녹음 현장에서도 Cubase가 함께 쓰입니다."
    - name: "3단계: 협업자 DAW 확인"
...
한국 음악 시장에도 하나로 정해진 "표준 DAW"는 없어요. 앞서 다룬 것처럼 방송·음대처럼 워크플로우가 정형화된 분야는 Pro Tools가 표준에 가깝지만, 그 밖의 현장에서는 실제 선택을 좌우하는 게 "무엇이 대세냐"보다 **함께 작업할 협업자가 무엇을 쓰느냐**인 경우가 많아요. 그래서 이 글도 앞의 "협업자 DAW 확인" 단계를 DAW 선택의 핵심 기준 중 하나로 다루고 있고요.
...
보컬 녹음과 믹싱 세션에서 황경하 엔지니어가 실제로 여는 DAW는 개인 작업 주력인 Fender Studio Pro(구 PreSonus Studio One Pro)입니다. 트랙 녹음, 편집, 믹싱까지 이 안에서 이어서 진행합니다. 피치 교정이 필요한 구간은 Melodyne Studio를 따로 불러와 보정합니다.
