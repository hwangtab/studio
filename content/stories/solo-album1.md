...
summary: >-
  혼자 앨범을 내고 싶지만 어디서부터 시작해야 할지 모르겠다면. 작곡, 편곡, 녹음, 믹싱, 마스터링, 음원 유통까지 1인 음반 제작의 전 과정을 현실적인 순서로 정리했습니다. 스튜디오 놀 엔지니어의 실무 경험을 바탕으로 홈레코딩 환경에서 바로 적용할 수 있도록 정리합니다.
faq:
  - q: 혼자서도 앨범을 낼 수 있나요?
    a: >-
      가능합니다. 작곡부터 유통까지 전 과정을 혼자 진행하는 인디 아티스트가 점점 늘고 있습니다. 다만 녹음·믹싱 등 전문 장비가 필요한
      단계는 스튜디오를 이용하는 것이 품질 면에서 유리합니다.
  - q: 1인 앨범 제작 비용은 얼마나 드나요?
    a: >-
      곡 수와 작업 범위에 따라 다르지만, 3~4곡 EP 기준으로 녹음·믹싱·마스터링에 약 50~150만원이 소요됩니다. 작곡·편곡을 직접
      하면 비용을 크게 줄일 수 있습니다. 음원 유통은 대부분 무료 또는 수수료 기반입니다.
  - q: 앨범 작업 기간은 얼마나 걸리나요?
    a: >-
      3~4곡 EP 기준으로 작곡·편곡 완료 상태에서 녹음·믹싱·마스터링까지 약 1~2개월입니다. 작곡 단계부터 시작하면 3~6개월 이상
      소요될 수 있습니다.
  - q: 작곡을 못해도 앨범을 낼 수 있나요?
    a: >-
      가능합니다. 외주 작곡가에게 곡을 의뢰하거나 기존 곡의 커버 앨범을 만드는 방법이 있습니다. 레슨을 통해 작곡을 배우면서 진행하는
      분도 많습니다.
  - q: 음원 유통은 어떻게 하나요?
    a: >-
      디스트로키드(DistroKid), 튠코어(TuneCore), 루트노트(Routenote) 같은 음원 유통 서비스를 이용하면 멜론,
      스포티파이, 애플뮤직 등에 음원을 등록할 수 있습니다. 대부분 연간 구독료 또는 곡당 수수료 방식입니다.
---
...
### EP vs 싱글 vs 정규 앨범
 형태 | 곡 수 | 특징 |------|-------|------| 싱글 | 1~2곡 | 첫 발매에 적합, 부담 적음 | EP | 3~6곡 | 아티스트 정체성을 보여줄 수 있는 최소 단위 | 정규 앨범 | 7곡 이상 | 완성도 높지만 시간·비용 부담 큼 
...
### 주요 유통 서비스 비교
 서비스 | 비용 방식 | 특징 |--------|----------|------| DistroKid | 연간 구독 (~$22) | 무제한 업로드, 빠른 등록 | TuneCore | 곡/앨범당 과금 | 스토어 선택 가능 | Routenote | 무료 (수익 15% 수수료) | 초기 비용 없음 | 한국 유통사 (벅스, 지니뮤직 등) | 별도 계약 | 국내 플랫폼 직접 등록 
...
3~4곡 EP 기준, 작곡을 직접 하는 경우의 예상 비용입니다.
 ...
 항목 | 예상 비용 |------|----------| 스튜디오 녹음 (보컬) | 15~40만원 | 믹싱 (곡당) | 10~20만원 | 마스터링 (곡당) | 5~10만원 | 앨범 아트워크 | 5~20만원 | 음원 유통 | 0~3만원 | **합계 (3~4곡 EP)** | **약 50~150만원** 
