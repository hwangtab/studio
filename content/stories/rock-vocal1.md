...
author: "스튜디오 놀"
category: "녹음 가이드"
tags: ["록 보컬", "록 녹음", "메탈 보컬", "인디 록 보컬", "벨팅 록", "파워 보컬", "록 믹싱"]
thumbnail: "/images/service4.webp"
summary: "록·메탈·인디 장르 보컬 녹음 전략을 정리합니다. 록 보컬 특성, 벨팅 기법, 마이크 세팅, 더블 트래킹, 믹싱 포인트까지 록 장르에 최적화된 보컬 레코딩 가이드입니다."
faq:
  - q: "록 보컬 녹음이 팝과 어떻게 다른가요?"
    a: "록 보컬은 거칠고 파워풀한 벨팅, 그릿(grit), 성대 과부하 없이 강한 에너지를 내는 것이 핵심입니다. 마이크 거리를 약간 더 멀리 두고, 컴프레서를 살짝 덜 강하게 적용해 다이나믹한 에너지를 살립니다."
  - q: "록 보컬에서 더블 트래킹이란 무엇인가요?"
    a: "같은 멜로디를 두 번 녹음하여 두 트랙을 좌우로 패닝해 두껍고 넓은 록 보컬 사운드를 만드는 기법입니다. 코러스 구간에 많이 사용되며, 두 트랙이 완전히 일치하지 않고 약간의 타이밍·피치 차이가 있어야 자연스럽습니다."
  - q: "록 보컬 마이크 세팅은 어떻게 하나요?"
    a: "파워풀한 록 보컬은 다이내믹 마이크(예: Shure SM7B)가 잘 어울립니다. 콘덴서 마이크를 사용하는 경우 마이크를 30~40cm로 약간 멀리 두어 공간감을 살립니다."
