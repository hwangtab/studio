...
**비싼 플러그인이 실력을 만들지 않습니다.** 처음엔 다들 유명한 유료 번들부터 사려 하는데, 사실 ReaPlugs·Voxengo·TDR 같은 무료 도구만으로도 웬만한 믹스는 완성됩니다. 좋은 소리는 어떤 EQ를 쓰느냐보다 **어느 대역을 왜 건드리는지 아는가**에서 나오거든요. 도구부터 늘리면 그 판단이 오히려 늦게 자랍니다.

**만능 플러그인은 없고, 필요하지도 않습니다.** EQ 하나, 컴프레서 하나를 손에 익도록 깊이 쓰는 게 열 개를 얕게 쓰는 것보다 훨씬 빠르게 늡니다. 저도 실제 세션에서 쓰는 EQ·컴프는 손에 꼽아요. 어떤 플러그인이 좋은지 비교가 궁금하면 [VST 플러그인 완전 가이드](/stories/vst-guide1)를 먼저 보시고요.

**소리보다 CPU가 먼저 터지면 작업이 끊깁니다.** 트랙마다 플러그인을 겹겹이 얹다 보면 재생이 버벅여요. 확정된 트랙은 Freeze로 렌더해두면 CPU가 숨을 쉬고, 그만큼 믹스에 집중할 수 있습니다. 도구를 줄이는 습관이 결국 결과물의 완성도로 돌아옵니다.
