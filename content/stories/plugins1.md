...
믹싱 플러그인은 크게 EQ, 컴프레서, 리버브, 딜레이, 코러스·모듈레이션, 새추레이션 계열로 분류됩니다. 처음 믹싱을 시작한다면 DAW에 기본 내장된 플러그인만으로도 프로페셔널한 결과물을 낼 수 있습니다. 플러그인 수집보다는 한 가지 플러그인을 깊이 이해하고 다양한 소스에 적용해보는 연습이 믹싱 실력 향상에 훨씬 효과적입니다.
