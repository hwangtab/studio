...
tags: ["음원 발매 타임라인", "음악 발매 계획", "앨범 발매 준비", "음원 발매 일정", "인디 음원 발매", "발매 체크리스트", "음악 발매 전략"]
...
faq:
  - q: "음원 발매까지 최소 얼마나 걸리나요?"
    a: "녹음 완료 후 믹싱·마스터링(1~2주) → 유통사 등록(2~3주 심사) → 발매 최소 약 3~5주 소요됩니다. 여유 있게 D-8주 전부터 준비하는 것을 권장합니다."
  - q: "주요 스트리밍 플랫폼 등록에 얼마나 걸리나요?"
    a: "DistroKid·TuneCore 같은 DIY 유통사는 멜론·지니·스포티파이 등 대부분 플랫폼에 7~14일 이내 등록됩니다. 한국 주요 플랫폼(멜론·지니·벅스)은 유통사 심사가 더 엄격해 2~3주 소요되기도 합니다."
  - q: "발매 전 홍보는 언제부터 시작해야 하나요?"
    a: "D-4주부터 SNS 티저 콘텐츠를 시작하고, D-1주에 사전 청취 링크(Pre-save)를 공개하는 것이 효과적입니다. D-3일부터 매일 업데이트로 기대감을 극대화하세요."
  - q: "스포티파이 플레이리스트 피칭은 언제 해야 하나요?"
    a: "Spotify for Artists를 통한 에디토리얼 플레이리스트 피칭은 발매 최소 7일 전, 이상적으로는 28일 전에 제출해야 합니다."
---
