...
그리고 꼭 당부하는 게 하나 있습니다. 플러그인을 걸기 전에, 페이더만으로도 곡이 이미 '곡'처럼 들려야 한다는 겁니다. 이 정적 밸런스가 안 잡힌 상태에서 EQ와 컴프로 승부를 보려 하면 없는 밸런스를 플러그인으로 억지로 만들다 소리가 지쳐버려요. 이 순서를 몸에 붙이는 건 글로 읽는 것보다 옆에서 한 곡을 같이 타보는 게 빨라서, [믹싱 레슨](/lesson)에서도 저는 늘 이 '참는 연습'부터 시킵니다.
