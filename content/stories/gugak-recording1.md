...
tags: ["국악 녹음", "국악 레코딩", "가야금 녹음", "판소리 녹음", "해금 녹음", "전통 음악 녹음", "국악 음원 제작"]
thumbnail: "/images/recording14.webp"
summary: "국악·전통 음악 레코딩 완전 가이드입니다. 가야금·판소리·해금·대금 등 국악 악기 마이킹 방법, 국악 음원 제작 순서, 국악 믹싱 방법, 국악 현대음악 퓨전 레코딩 팁을 정리합니다."
faq:
  - q: "국악 악기를 스튜디오에서 녹음할 수 있나요?"
    a: "가능합니다. 가야금·해금·대금·장구·판소리 등 국악 악기는 컨덴서 마이크로 녹음합니다. 악기별 마이킹 방법과 음향 특성이 다르므로 국악 녹음 경험이 있는 엔지니어와 상담이 필요합니다."
  - q: "판소리를 녹음할 때 특별한 준비가 필요한가요?"
    a: "판소리는 다이내믹 레인지가 매우 크고 성음(聲音)의 특수성이 있습니다. 넓은 다이내믹을 처리할 수 있는 마이크 세팅과, 성음의 거친 질감을 보존하는 컴프레서 설정이 중요합니다. 사전에 엔지니어와 충분한 상담을 권장합니다."
  - q: "가야금·해금 등 현악기 마이킹은 어떻게 하나요?"
    a: "가야금은 악기 앞쪽 50~80cm 거리에서 XY 또는 ORTF 스테레오 마이킹이 일반적입니다. 해금은 악기 정면에서 30~50cm 거리에 단일지향성 마이크를 배치합니다. 공명통(울림통)을 향해 보조 마이크를 추가하기도 합니다."
  - q: "국악과 양악을 퓨전해서 녹음하면 어떻게 되나요?"
    a: "국악 현대음악 퓨전은 MIDI 편곡 + 국악 악기 라이브 레코딩 방식이 일반적입니다. 음계 차이(12음 vs 순정율)와 음색 차이를 고려한 편곡이 필요하며, 믹싱 단계에서 두 사운드의 조화가 중요합니다."
---
