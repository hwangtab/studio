...
faq:
  - q: 프렛리스 베이스·Jaco Pastorius·마이크로토날 글라이드을 처음 연습할 때 어디서부터 시작해야 하나요?
    a: >-
      ...
      인토네이션 훈련 순서로 진행하면 좋습니다. 기초 단계를 충분히 소화한 후 다음 단계로 넘어가세요.
  - q: 프렛리스 베이스·Jaco Pastorius·마이크로토날 글라이드 연습 시 핵심 포인트는 무엇인가요?
    a: >-
...
스튜디오 놀(연신내, 서울 은평구) 음악연습실에서 프렛리스 재즈 베이스 연습 상담 때 자주 드리는 조언입니다.
