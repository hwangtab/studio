...
faq:
  - q: 커버곡 녹음 시 저작권 문제가 있나요?
    a: >-
      ...
      적용됩니다. 플랫폼 자체 Content ID 시스템으로 수익 배분이 자동 처리되는 경우도 많으니 업로드 전에 확인하는 것이 좋습니다.
...
스튜디오 녹음은 단순히 '더 좋은 마이크'를 쓰는 것 이상입니다. 방음 환경, 전문 프리앰프, 엔지니어의 실시간 보컬 디렉팅이 합쳐져야 커버곡 음원이 완성됩니다.
...
**키는 무대가 아니라 마이크 앞 기준으로 잡으세요.** 카메라 앞에선 긴장으로 평소보다 고음이 안 나옵니다. 실용 음역의 90% 안쪽으로 키를 잡아 여러 테이크를 편하게 갈 수 있게 하세요. 키 잡는 법은 [노래 키 찾는 방법](/stories/song-key1)을 참고하시고요.

**올리기 전에 저작권을 확인하세요.** 비영리 커버는 대체로 가능하지만, 수익화(영리)하려면 원곡의 라이선스 정리가 필요해요. 삭제·수익화 조건은 [유튜브 커버곡 저작권 가이드](/stories/copyright-cover1)에서 미리 확인하는 게 안전합니다.
