...
faq:
  - q: "믹싱 전에 에디팅을 해야 하나요?"
    a: "네, 믹싱 전에 타이밍 교정, 피치 교정, 클릭 제거 등 에디팅을 먼저 하는 것이 좋습니다. 에디팅이 깔끔하게 되어 있을수록 믹싱 과정이 단순해지고 최종 결과물 퀄리티가 높아집니다."
  - q: "오디오 에디팅에서 가장 중요한 작업은 무엇인가요?"
    a: "드럼 그리드 정렬(타이밍 교정), 보컬 피치 교정(Melodyne·AutoTune), 불필요한 소음·숨 소리 제거가 가장 많이 사용됩니다. 보컬 컴핑(Comping)도 에디팅의 핵심 작업 중 하나입니다."
---
...
가수가 한 번에 완벽하게 노래를 부르는 경우는 거의 없습니다. (저도 본 적이 거의 없어요... 읍읍!)
