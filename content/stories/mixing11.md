---
title: 오디오 에디팅이란? 믹싱 전 타이밍·피치 교정 단계 — 강좌 11부
date: 2025-11-22
author: 스튜디오 놀
category: 강좌
tags:
...
- Editing
- Comping
summary: 믹싱 전에 반드시 해야 하는 오디오 에디팅. 타이밍 교정, 피치 교정, 클릭 제거 등 믹스 품질을 결정하는 에디팅 기술을 설명합니다. 홈레코딩 환경에서도 바로 적용할 수 있는 실전 팁을 단계별로 정리합니다.
