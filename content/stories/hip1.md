...
레이어는 순서가 생명입니다. 메인을 완전히 확정한 다음에 더블링, 그다음 애드립으로 갑니다. 메인이 흔들리는 상태에서 더블부터 쌓으면, 나중에 메인을 손볼 때 전부 다시 찍어야 하거든요. 애드립은 메인과 아예 다른 트랙에 따로 받아둬야 믹스에서 EQ와 공간을 독립적으로 만질 수 있습니다. 이렇게 정리된 스템으로 넘어오면 그다음 [믹싱·마스터링 요금](/pricing) 단계도 훨씬 깔끔하게 마감됩니다.
