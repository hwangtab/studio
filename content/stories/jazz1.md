...
summary: >-
  재즈 보컬 녹음 가이드 정보를 보컬 훈련 순서, 녹음 실수, 피드백 기준으로 정리합니다. 연신내 Studio NOL 레슨·녹음에서 바로 점검할 포인트를 담았습니다.
faq:
...
재즈 보컬 녹음은 팝·발라드와 근본적으로 다른 철학을 요구합니다. 재즈에서 정확한 음정보다 중요한 것은 **타이밍의 뉘앙스**와 **표현의 진정성**입니다. 1950-60년대 Blue Note Records와 Verve Records가 정립한 재즈 보컬 녹음 미학은 바로 이 원칙 위에 세워졌습니다. Ella Fitzgerald가 스튜디오에서 라이브 밴드와 함께 녹음하던 방식, Billie Holiday가 단 한 음표의 블루 노트로 듣는 이의 심장을 쥐어짜던 기법 — 그 모든 것이 "정확한 음정 교정"을 통해서는 절대 나올 수 없는 표현입니다.
...
재즈 보컬은 팝보다 약간 멀리 세팅합니다. 클로즈 마이킹은 팝의 친밀감에 유리하지만 재즈 특유의 공기감을 죽입니다. 20~30cm 거리에서 자연스러운 룸 어쿠스틱이 소량 섞이도록 하면 좋습니다. 녹음 공간 자체의 음향이 좋을수록 이 거리에서 좋은 결과가 나옵니다.
...
## 재즈 보컬을 시작하려는 분께 제가 늘 하는 말

재즈 보컬은 제가 스튜디오에서 만나는 장르 중 준비 편차가 가장 큰 쪽입니다. 어떤 분은 스탠더드를 수십 곡 몸에 넣고 오고, 어떤 분은 좋아하는 재즈 팝 한두 곡만 들고 옵니다. 실력의 문제라기보다 재즈라는 언어에 얼마나 익숙한지의 차이인데, 이게 녹음 결과를 크게 가릅니다.

제가 가장 먼저 권하는 건 멜로디가 아니라 코드를 외우는 습관입니다. 본문에서도 짚었듯 재즈에서 즉흥은 코드 진행이라는 지도 위를 걷는 일이라, 코드가 몸에 들어와 있으면 처음 만난 반주자와도 같은 곡을 매번 다르게 부를 수 있습니다. 반대로 멜로디만 외워 오면 한 가지 버전밖에 나오지 않고, 그건 스튜디오에서 여러 테이크를 남길 이유를 없애 버립니다.

두 번째는 레퍼토리입니다. 재즈 보컬은 결국 가진 스탠더드의 양이 곧 표현의 폭이 됩니다. 좋아하는 열 곡부터 자기 키를 정해 몸에 새겨 두면, 녹음날 어떤 곡을 붙잡아도 흔들리지 않습니다. 준비가 어느 정도 됐다 싶을 때 한 곡을 실제로 녹음해 보길 권하는데, 자기 목소리를 냉정하게 마주하는 순간만큼 빠른 성장은 없더군요. 세션을 어떻게 잡는지는 [녹음 안내](/pricing)에서 확인할 수 있습니다.
