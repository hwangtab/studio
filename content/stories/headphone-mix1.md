...
## Studio NOL이 헤드폰 믹싱 사용자에게 자주 권하는 3가지

스튜디오 놀(연신내, 서울 은평구)에서 헤드폰 믹싱 상담 때 자주 드리는 조언입니다.

**1. 번역 체크 — 스피커·차·이어폰 3가지**

헤드폰 믹스 완료 후 스마트폰 스피커·차·블루투스 이어폰 3가지 환경 확인.

**2. 낮은 볼륨 — 70dB 미만 명료도**

70dB 미만 낮은 볼륨에서도 보컬 명료·킥 펀치 살아있어야 좋은 믹스.

**3. -14 LUFS — 스트리밍 표준**

최종 마스터링 -14 LUFS. iZotope Insight·Youlean으로 확인.
