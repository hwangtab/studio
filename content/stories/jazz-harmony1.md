...
summary: >-
  재즈 화성학 기초 완전 가이드입니다. 재즈의 핵심 코드 진행(ii-V-I), 텐션 음정, 보이싱 기법, 모달 재즈, 알터드 스케일을 정리합니다. 재즈 보컬·작곡·편곡에 필수적인 이론입니다. 스튜디오 놀 엔지니어의 실무 경험을 바탕으로 홈레코딩 환경에서 바로 적용할 수 있도록 정리했습니다.
faq:
