...
summary: >-
  컴프레서의 작동 원리와 어택·릴리즈·스레숄드·레이쇼 파라미터 설명. 보컬·드럼·베이스에서 컴프레서를 자연스럽게 사용하는 실전 방법을 안내합니다.
...
faq:
  ...
  - q: "어택(Attack)과 릴리즈(Release) 설정은 어떻게 하나요?"
    a: "어택은 컴프레서가 소리를 잡기 시작하는 속도, 릴리즈는 놓아주는 속도입니다. 빠른 어택은 타격감을 죽이고, 느린 어택은 타격감을 살립니다. 보컬은 보통 중간 어택에 중간~느린 릴리즈로 시작하는 것이 좋습니다."
...
## Studio NOL 보컬 컴프레서 설정 3가지 표준

스튜디오 놀 보컬 믹싱 세션에서 컴프레서 설정에 일관되게 적용하는 표준입니다.

**1. Ratio — 3:1~5:1 보컬 표준**

장르·다이내믹 폭에 따라 다르지만 보컬 표준은 3:1~5:1입니다. 발라드는 4:1, 일관된 팝 보컬은 3:1, 거친 록 보컬은 5:1 이상. Ratio 단독보다 GR -3~5dB 지점을 찾는 것이 더 중요합니다.

**2. Attack — 10~30ms 자음 통과**

Attack 10ms 미만은 자음 트랜지언트가 짓눌려 발음이 흐려집니다. 보컬 표준 10~30ms로 자음은 통과시키고 모음 본체만 컴프에 잡히게 합니다.

**3. 2단 체인 — 피크 + 음색**

1차 컴프(빠른 어택, GR -3~5dB)로 피크 제어 → 2차 컴프(느린 어택, GR -2~4dB)로 음색·에너지 정리하는 2단 체인이 K-POP·팝 보컬 표준입니다.
