...
스튜디오 놀에서 Studio One으로 보컬 녹음·믹싱하는 클라이언트에게 자주 권하는 설정입니다.
...
## Studio NOL이 Studio One 사용자에게 자주 권하는 3가지

스튜디오 놀(연신내, 서울 은평구)에서 Studio One 상담 때 자주 드리는 조언입니다.
...
**3. Professional vs Artist**

VST·서드파티 위해 Professional 필요.
