...
faq:
  ...
  - q: 드럼 폴리리듬·크로스리듬 연습 시 가장 중요한 포인트는 무엇인가요?
    a: >-
      드럼 폴리리듬·크로스리듬 연습에서 가장 중요한 것은 일정한 타이밍과 스틱 컨트롤입니다. 메트로놈과 함께 느린 BPM부터 시작해
      정확도를 높이세요.
...
## Studio NOL이 폴리리듬 연습실 사용자에게 자주 권하는 3가지

스튜디오 놀(연신내, 서울 은평구) 음악연습실에서 드럼 폴리리듬 연습 상담에서 반복적으로 드리는 조언입니다.

**1. 3 대 2 우선 — 가장 기본 폴리리듬**

3 over 2 폴리리듬을 마스터한 후 3 over 4, 4 over 5로 확장합니다. 기본 패턴을 건너뛰면 복잡한 폴리리듬이 박자에 묻힙니다.

**2. 손뼉 분리 — 한 손 3박, 다른 손 2박**

스틱 잡기 전 손뼉으로 한 손 3박, 다른 손 2박을 동시에 합니다. 신체화 후 드럼으로 옮깁니다.
