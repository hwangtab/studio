...
## Studio NOL이 피아노 즉흥 연주 연습자에게 자주 권하는 3가지

스튜디오 놀(연신내, 서울 은평구) 음악연습실에서 피아노 즉흥·임프로비제이션 상담에서 반복적으로 드리는 조언입니다.

**1. 스케일 + 코드 톤 — 안전한 음 먼저**

즉흥 초기에는 스케일 음 + 코드 톤만 사용해도 충분합니다. 텐션·아우트 음은 기초 안정 후 추가.

**2. 짧은 모티프 — 발전·반복 패턴**

긴 라인보다 짧은 4~8음 모티프를 만들고 리듬·음정 변형으로 발전시키는 패턴이 가장 음악적입니다.

**3. 매 세션 녹음 — 본인 즉흥 객관화**

즉흥 중에는 좋게 들려도 녹음하면 단조롭게 들리는 경우가 많습니다. 매 세션 녹음 → 청취 루틴 필수.
