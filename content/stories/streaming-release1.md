...
faq:
  ...
  - q: "스트리밍 음원 파일 규격은?"
    a: "일반적으로 WAV 24bit/44.1kHz 또는 16bit/44.1kHz를 권장합니다. MP3는 320kbps가 최소 기준이지만 마스터링 원본은 반드시 WAV로 보관하세요. Spotify, Apple Music은 유통사가 자체 변환해 배포합니다."
  - q: "커버아트 최소 규격은?"
    a: "3000x3000px 이상, RGB 모드, JPEG 또는 PNG, 72dpi 이상이 일반적인 기준입니다. 유통사에 따라 다를 수 있으나 3000x3000px이 업계 표준입니다."
