...
## Studio NOL이 드라마 OST 의뢰자에게 자주 권하는 3가지

스튜디오 놀(연신내, 서울 은평구)에서 드라마 OST 상담에서 반복적으로 드리는 조언입니다.

**1. 드라이 보컬 보존 — 별도 파일**

OST는 드라이 보컬 별도 보존 필수. 음악 감독 리믹스·리마스터 요청 대비.

**2. 방송 vs 스트리밍 — 파일 분리**

방송용(WAV 24bit/48kHz) vs 스트리밍용(-14 LUFS 마스터) 파일 분리 보관.

**3. KOMCA 사전 등록 — 방송 사용 후 정산**

OST는 방송 사용 후 KOMCA 정산. 사전 등록 필수.
