...
## Studio NOL이 마스터링 작업자에게 자주 권하는 3가지

스튜디오 놀(연신내, 서울 은평구)에서 마스터링 체인 상담 때 자주 드리는 조언입니다.

**1. 동일 음량 A/B — 레퍼런스 비교**

0.5dB만 커도 좋게 들림. 동일 음량 맞춘 A/B 비교 필수.

**2. 모노 체크 — 저역 위상**

모노 전환 시 저역 사라지면 80Hz 이하 위상 반전.

**3. 귀 휴식 — 30분마다**

마스터링은 귀 피로 빨리. 30분마다 휴식.
