...
faq:
  - q: "목소리에 가장 중요한 생활 습관은 무엇인가요?"
    a: "수분 섭취가 가장 중요합니다. 하루 1.5~2L 이상의 물을 마시면 성대 점막이 촉촉하게 유지되어 마찰이 줄고 성대 피로가 감소합니다. 특히 녹음 당일에는 미지근한 물을 자주 마시는 것이 좋습니다."
  - q: "보컬리스트가 피해야 할 음식은 무엇인가요?"
    a: "유제품(우유, 치즈 등)은 점액 분비를 증가시켜 목이 잠길 수 있습니다. 술은 성대 탈수와 점막 자극, 카페인은 탈수 효과가 있습니다. 녹음 전날과 당일에는 이 세 가지를 피하는 것이 기본입니다."
  - q: "충분히 쉬어도 목소리가 쉰 상태가 지속된다면 어떻게 해야 하나요?"
    a: "3~5일 이상 목소리가 쉰 상태가 지속된다면 이비인후과 진료를 받아야 합니다. 성대 결절, 폴립, 성대 부종 등 의학적 문제일 수 있으므로 전문가 진단이 필요합니다."
  - q: "겨울철 건조한 환경에서 목소리를 어떻게 관리하나요?"
    a: "실내 가습기를 사용하고(습도 50~60%), 마스크 착용으로 호흡 시 공기를 가습합니다. 외출 시 마스크 착용이 성대 보호에 효과적입니다. 코로 호흡하는 습관도 성대 건조 방지에 도움이 됩니다."
---
![목소리 관리 생활 습관 — 스튜디오 놀](/images/portfolio3.webp)
