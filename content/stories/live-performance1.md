...
author: "스튜디오 놀"
category: "음반 제작 가이드"
tags: ["라이브 공연 준비", "무대 퍼포먼스", "셋리스트 구성", "사운드 체크", "라이브 보컬", "공연 준비", "무대 입문"]
thumbnail: "/images/room4.webp"
summary: "라이브 공연 준비 완전 가이드입니다. 셋리스트 구성, 사운드 체크 방법, 인이어 모니터링, 무대 퍼포먼스 팁, 공연 직전 루틴, 갑작스러운 상황 대처법을 정리합니다."
faq:
  - q: "처음 라이브 공연을 준비할 때 가장 먼저 해야 할 일은?"
    a: "셋리스트(Set List) 확정이 첫 번째입니다. 공연 시간·청중·장소에 맞는 곡 순서를 정하고, 전환 포인트(MC 멘트·악기 교체)를 계획하세요. 그 다음 반복 리허설을 통해 전체 공연 흐름을 몸에 익혀야 합니다."
  - q: "사운드 체크는 어떻게 진행하나요?"
    a: "공연 시작 1~2시간 전에 진행합니다. 보컬 마이크 → 악기 → 전체 밸런스 순서로 체크합니다. 무대 모니터(인이어 또는 스피커)를 통해 자신의 목소리가 잘 들리는지 확인하고, 사운드 엔지니어에게 원하는 모니터 믹스를 구체적으로 요청하세요."
  - q: "공연 중 목소리가 떨리거나 잊어버리면 어떻게 하나요?"
    a: "반복 리허설로 가사를 완전히 외우는 것이 최선입니다. 공연 중 실수가 발생하면 당황하지 말고 계속 진행하세요. 청중은 아티스트가 생각하는 것보다 실수를 크게 인식하지 않습니다. 여유로운 표정과 자신감 있는 태도가 가장 중요합니다."
  - q: "공연 직전 보컬 워밍업은 어떻게 하나요?"
    a: "공연 30~60분 전부터 시작합니다. 립 트릴(입술 진동)로 시작해 스케일 허밍, 가볍게 가사 읽기, 곡의 첫 소절 가볍게 부르기 순서로 진행합니다. 찬 물 섭취, 소리 지르기, 위산이 많은 음식은 공연 직전 피하세요."
---
