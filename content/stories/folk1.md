...
author: "스튜디오 놀"
category: "강좌"
tags: ["포크 녹음", "통기타 녹음", "어쿠스틱 녹음", "싱어송라이터 녹음", "자작곡 녹음", "보컬 기타 녹음", "서울 보컬 녹음실"]
thumbnail: "/images/album2.webp"
summary: "포크·통기타를 연주하며 노래하는 싱어송라이터를 위한 레코딩 가이드. 어쿠스틱 기타와 보컬을 동시에 녹음하는 방법, 마이킹 전략, 편곡 없이 단출한 사운드를 완성하는 방법을 안내합니다."
faq:
  - q: "기타와 보컬을 동시에 녹음해도 되나요?"
    a: "가능하지만, 기타 소리가 보컬 마이크에 들어가고 보컬이 기타 마이크에 들어가는 음향 간섭(누화, Bleed)이 생깁니다. 라이브 느낌을 원하면 동시 녹음을, 완성도 높은 후편집을 원하면 기타 먼저 녹음 후 보컬을 오버더빙하는 방식이 유리합니다."
  - q: "전문 스튜디오에서 포크 녹음을 하면 홈 녹음과 얼마나 차이가 나나요?"
    a: "포크·어쿠스틱 음악에서 음질 차이는 특히 두드러집니다. 기타의 배음(하모닉스)과 공간감, 보컬의 숨결까지 전문 마이크가 포착합니다. 홈 녹음에서는 룸 울림과 배경 소음이 섞여 어쿠스틱 악기 고유의 맑은 소리가 잘 담기지 않습니다."
  - q: "통기타 녹음에는 어떤 마이크를 사용하나요?"
    a: "통기타 녹음에는 일반적으로 스몰 다이어프램 컨덴서 마이크(소리홀 앞·12프렛 위치)와 라지 다이어프램 컨덴서(전체 공간감)를 함께 사용합니다. 또는 피에조 픽업(엔드핀 잭)을 직접 연결해 DI 신호를 혼용하기도 합니다."
  - q: "기타 코드가 완벽하지 않아도 녹음할 수 있나요?"
    a: "전문 스튜디오에서는 구간별 재녹음이 가능합니다. 기타 파트를 구간별로 나눠 찍고 편집(컴핑)해 완성본을 만들 수 있습니다. 단, 기타 연주가 안정적일수록 세션 시간이 단축됩니다."
---
