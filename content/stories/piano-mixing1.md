...
## Studio NOL이 피아노 믹싱 작업자에게 자주 권하는 3가지

스튜디오 놀(연신내, 서울 은평구)에서 피아노 믹싱 상담에서 반복적으로 드리는 조언입니다.

**1. 스테레오 폭 — 자연스럽게**

너무 넓으면 비현실적. -100~+100보다 -70~+70.

**2. 200~300Hz 컷 — 탁한 공명 제거**

피아노 저역 탁함은 200~300Hz.

**3. 보컬 충돌 — 사이드체인**

리드 보컬과 충돌 시 피아노에 가벼운 사이드체인.
