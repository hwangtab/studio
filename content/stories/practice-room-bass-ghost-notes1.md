...
## Studio NOL이 베이스 고스트 노트 연습실 사용자에게 자주 권하는 3가지

스튜디오 놀(연신내, 서울 은평구) 음악연습실에서 베이스 고스트 노트·뮤트 연습 상담에서 반복적으로 드리는 조언입니다.

**1. 왼손 펜치 뮤트 — 손가락 가볍게 얹기**

고스트 노트의 핵심은 왼손이 현을 약하게 가로질러 음정 없이 어택만 내는 것입니다. 손가락을 강하게 누르면 음정이 살아납니다.

**2. 메인 vs 고스트 음량 차이 — 메트로놈 BPM 60**

메인 음과 고스트 음의 음량 격차가 명확해야 펑크·소울 그루브가 살아납니다. BPM 60에서 메인 -8dB / 고스트 -25dB 격차를 손에 익힙니다.

**3. 녹음 자가 청취 — 본인 귀로는 가려짐**

연주 중에는 고스트 노트가 작게 들리지 않을 수 있습니다. 스마트폰 녹음 후 청취하면 실제 음량 비율을 객관적으로 확인할 수 있습니다.
