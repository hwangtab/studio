...
## Studio NOL이 온라인 협업 도구 사용자에게 자주 권하는 3가지

스튜디오 놀(연신내, 서울 은평구)에서 음악 온라인 협업 상담 때 자주 드리는 조언입니다.

**1. WAV 24bit/48kHz — 파일 표준**

협업 파일은 WAV 24bit/48kHz. MP3는 피하는 것이 좋습니다.

**2. 파일명 버전 — Artist_Song_v2_dry**

파일명에 버전 번호 포함. 수정 라운드 혼동 방지.

**3. 이중 백업 — 클라우드 + 로컬**

최종 마스터는 클라우드 + 로컬 드라이브 이중 백업.
