...
## Studio NOL이 베이스 이론 연습실 사용자에게 자주 권하는 3가지

스튜디오 놀(연신내, 서울 은평구) 음악연습실에서 베이스 이론·화성 연습 상담에서 반복적으로 드리는 조언입니다.

**1. 코드 톤 — 1·3·5·7도 우선**

베이스의 핵심 음정 선택은 코드 톤(1·3·5·7도)입니다. 코드 톤을 자유롭게 연결할 수 있어야 다른 음정으로 확장 가능합니다.

**2. 다이아토닉 7개 코드 — 한 키 전체 파악**

C 키 다이아토닉 7개 코드(I·ii·iii·IV·V·vi·vii°)를 베이스로 자유롭게 연결하면 키 안의 모든 코드 진행을 익힐 수 있습니다.

**3. 12마디 블루스 진행 — 즉흥 응용**

이론을 실용으로 연결하는 가장 빠른 길은 12마디 블루스 진행입니다. I-IV-V 진행을 12키에서 익힙니다.
