...
faq:
  ...
  - q: "EP와 싱글 중 어느 것이 먼저인가요?"
    a: "대부분의 인디 아티스트는 싱글 발매로 팬을 모으고, 이후 EP를 발매하는 전략이 효과적입니다. 첫 번째 EP 전에 2~3곡의 싱글로 팬 베이스를 구축하는 것이 일반적입니다."
  - q: "EP 제작 비용은 얼마나 드나요?"
    a: "곡 수·제작 수준에 따라 다르지만, 4곡 EP 기준으로 녹음+믹싱+마스터링 합산 비용이 소규모 스튜디오 기준 30~80만 원대, 전문 스튜디오는 100~300만 원대로 다양합니다."
