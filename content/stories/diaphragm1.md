...
---
![복식호흡·횡격막 발성 완전 가이드 — 스튜디오 놀](/images/recording7.webp)
...
씨 훈련 (S Sound)
① 복식호흡으로 숨 들이쉬기
② "쏘~"/"씨~" 소리를 10~15초 동안 균일하게 내뱉기
③ 소리가 흔들리지 않도록 복부 근육 컨트롤
④ 시간을 점진적으로 늘리기 (20초 → 30초)

캔들 훈련
① 초(캔들) 앞에 서서
② 숨을 10~15cm 거리에서 일정하게 내뱉어 불꽃이 흔들리게 유지
③ 불꽃이 꺼지지 않고 일정하게 흔들리도록 제어
```
...
복식호흡은 모든 보컬 기술의 기초입니다. 스튜디오 놀에서 1:1 보컬 디렉팅으로 올바른 호흡 습관을 확인하고 최상의 발성으로 녹음을 진행하세요.
