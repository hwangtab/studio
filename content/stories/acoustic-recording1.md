...
author: "스튜디오 놀"
category: "음반 제작 가이드"
tags: ["어쿠스틱 기타 녹음", "어쿠스틱 녹음", "통기타 녹음", "어쿠스틱 음악 제작", "스트럼 녹음", "핑거피킹 녹음", "어쿠스틱 미킹"]
thumbnail: "/images/studio4.webp"
summary: "어쿠스틱 기타와 어쿠스틱 악기 녹음을 위한 완전 가이드입니다. 마이킹 포지션, 마이크 선택, 룸 어쿠스틱, 스트럼·핑거피킹별 세팅, 믹싱 팁을 정리합니다."
faq:
  - q: "어쿠스틱 기타는 어떤 마이크로 녹음하는 것이 좋나요?"
    a: "소형 다이어프램 콘덴서 마이크(예: Shure SM81, Audio-Technica AT4041)가 어쿠스틱 기타 녹음의 표준입니다. 따뜻한 빈티지 사운드를 원한다면 대형 다이어프램 콘덴서(U87, TLM 102)도 좋습니다. 다이나믹 마이크는 라이브용이며 스튜디오 녹음에는 적합하지 않습니다."
  - q: "어쿠스틱 기타 마이킹 위치는 어디가 좋나요?"
    a: "가장 일반적인 위치는 12프렛 위 30~40cm 거리입니다. 사운드홀 정면은 너무 밝고 울림이 과해 권장하지 않습니다. 두 대의 마이크를 X/Y 또는 ORTF 방식으로 스테레오 미킹하면 더 풍부한 사운드를 얻을 수 있습니다."
  - q: "어쿠스틱 기타 녹음 시 룸 어쿠스틱은 얼마나 중요한가요?"
    a: "매우 중요합니다. 울림이 너무 많은 공간(욕실, 큰 방)은 불필요한 잔향이 섞입니다. 방음 처리된 스튜디오 또는 소파·커튼이 많은 건식 공간에서 녹음하는 것이 가장 좋습니다. 집에서는 옷장 안이나 카펫이 깔린 방이 좋습니다."
  - q: "어쿠스틱 기타 녹음 후 믹싱에서 어떻게 처리하나요?"
    a: "하이패스 필터(80~120Hz)로 불필요한 저음을 제거하고, 2~5kHz 범위에서 선명도를 살립니다. 컴프레서는 부드럽게(Ratio 2:1~3:1) 사용해 다이나믹스를 자연스럽게 정리합니다. 소량의 플레이트 리버브로 공간감을 더하면 완성도가 높아집니다."
---
