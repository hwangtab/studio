...
summary: >-
  음악인 세금 신고 정보를 비용, 일정, 준비물 기준으로 비교합니다. Studio NOL 상담 전에 예산과 선택 기준, 의뢰 전 확인할 내용을 빠르게 정리하세요.
faq:
...
특히 음악을 만들려고 쓴 돈은 상당 부분이 필요경비로 인정되는 항목입니다. [녹음·믹싱 비용](/pricing)은 물론이고 장비나 소프트웨어 구매까지, 수익을 만들기 위한 지출이라면 챙겨둘 가치가 있습니다. 저희처럼 세금계산서나 현금영수증을 발행하는 곳에서 작업했다면 요청만 하면 증빙을 받을 수 있으니, 결제할 때 "증빙 되나요?"를 습관처럼 물어보시길 권합니다.
