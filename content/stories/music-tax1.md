...
tags: ["음악인 세금", "음원 수익 세금", "저작권료 세금", "종합소득세 음악", "프리랜서 음악인 세금", "공연 수익 신고", "음악 세금 신고"]
thumbnail: "/images/hardware8.webp"
summary: "음악인 세금 신고 완전 가이드입니다. 음원 스트리밍 수익, 저작권료, 공연 수입, 세션비 등의 종합소득세 신고 방법, 필요경비 처리, 사업자 등록 여부 판단을 정리합니다."
faq:
  - q: "음원 스트리밍 수익도 세금을 내야 하나요?"
    a: "네, 음원 수익은 사업소득 또는 기타소득으로 분류되어 종합소득세 신고 대상입니다. 연간 수익이 100만 원을 초과하면 5월 종합소득세 신고를 해야 합니다."
  - q: "저작권료(KOMCA 분배금)는 어떤 소득인가요?"
    a: "KOMCA 분배금은 기타소득(저작권 사용료)으로 분류됩니다. 건당 지급액이 125,000원을 초과하면 원천징수(22%)가 됩니다. 원천징수가 된 경우에도 연간 수익이 크다면 5월에 종합소득세 신고가 유리할 수 있습니다."
  - q: "음악인도 필요경비를 인정받을 수 있나요?"
    a: "가능합니다. 녹음 비용, 스튜디오 대여료, 악기·장비 구매, 음악 소프트웨어, 홈 스튜디오 운영 비용, 이동 교통비 등이 필요경비로 인정됩니다. 영수증·세금계산서를 반드시 보관하세요."
  - q: "음악 활동으로 사업자 등록을 해야 하나요?"
    a: "연간 수익이 상당하거나 지속적으로 음악 활동을 할 계획이라면 사업자 등록이 유리합니다. 사업자 등록 시 세금계산서 발행이 가능하고, 필요경비 인정 범위가 넓어집니다. 부가세 면세 여부는 음악 활동 유형에 따라 다릅니다."
---
