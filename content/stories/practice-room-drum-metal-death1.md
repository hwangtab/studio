...
faq:
  - q: 데스메탈 드럼·블라스트비트·더블 베이스·익스트림 테크닉을 처음 연습할 때 어디서부터 시작해야 하나요?
    a: >-
      ...
      드럼 순서로 진행하면 좋습니다. 기초 단계를 익힌 뒤 다음 단계로 넘어가세요.
  - q: 데스메탈 드럼·블라스트비트·더블 베이스·익스트림 테크닉 연습할 때 무엇을 신경 쓰면 좋나요?
    a: >-
      데스메탈 드럼·블라스트비트·더블 베이스·익스트림 테크닉 연습에서는 일정한 타이밍과 스틱 컨트롤이 중요합니다. 메트로놈과 함께
...
summary: >-
  데스메탈 드럼·블라스트비트·더블 베이스 드럼·익스트림 스피드. 데스메탈 드럼을 은평구 24시간 음악연습실에서 마스터.
---
...
## 데스메탈 드럼은 속도만큼 체력과 귀를 지키는 게 실력입니다

데스메탈 드럼은 사실상 운동 경기예요. 극단적으로 빠른 블래스트비트와 더블 베이스를 몇 분씩 몰아쳐야 하니, 순간 속도만큼이나 그 속도를 유지하는 지구력이 실력을 가릅니다. 그래서 속도만 좇다 몸을 망치는 경우가 정말 많아요. 접근은 다른 주법과 같습니다. 절대 빠른 템포부터 시작하지 말고, BPM 80쯤에서 두 발의 교대가 완벽하게 균일해질 때까지 발 독립성부터 자동화한 뒤 조금씩 올리세요. 힘이 아니라 발목·손목의 이완과 반동으로 쳐야 오래 버팁니다.

체력 관리가 곧 훈련이에요. 무리하게 한 번에 오래 치기보다, 짧게 집중하고 충분히 쉬는 세션 구성이 부상을 막고 실력을 더 빨리 올립니다. 근육이 놀라지 않게 워밍업도 필수고요.

그리고 청력 보호는 선택이 아니라 필수입니다. 데스메탈은 드럼 중에서도 가장 큰 소리를 내는 영역이라 귀가 가장 빨리 상해요. -15dB 음악인용 이어플러그를 반드시 착용하세요. 귀는 한번 상하면 돌아오지 않습니다. 블래스트의 기본 발 컨트롤은 메탈 블래스트 비트에서 이어집니다.

데스메탈은 신체 부담이 큽니다. 25분 + 5분 휴식 사이클을 유지합니다.

---

[드럼 더블 킥·더블 배스 드럼 훈련 — 완전 가이드](/stories/practice-room-drum-double-kick1) | [카혼 드럼·플라멩코·어쿠스틱 세션·바스·스네어 카혼 테크닉 — 완전 가이드](/stories/practice-room-drum-cajon1)
