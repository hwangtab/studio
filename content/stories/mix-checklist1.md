...
author: "스튜디오 놀"
category: "음반 제작 가이드"
tags: ["믹싱 체크리스트", "믹스 납품 전 확인", "믹싱 최종 점검", "믹스 완성 기준", "음원 납품 체크리스트", "믹스다운 확인", "마스터링 전 체크"]
thumbnail: "/images/room8.webp"
summary: "믹싱 최종 체크리스트 완전 가이드입니다. 레벨·다이나믹·EQ·공간감·모노 호환성·LUFS·True Peak·파일 포맷·메타데이터까지 납품 전 반드시 확인해야 할 모든 항목을 정리합니다."
faq:
  - q: "믹스 납품 전 가장 먼저 확인해야 할 것은 무엇인가요?"
    a: "레벨과 클리핑 여부입니다. 마스터 아웃풋의 True Peak가 -1dBTP를 넘지 않아야 하며, 어떤 트랙에도 클리핑이 없는지 확인하세요. 다음으로 모노로 변환했을 때 사운드가 크게 달라지지 않는지 체크합니다."
  - q: "믹스가 완성됐는지 어떻게 알 수 있나요?"
    a: "레퍼런스 트랙과 A/B 비교했을 때 전체 음압·음색·공간감이 유사하다면 완성에 가까운 상태입니다. 또한 여러 기기(스피커·헤드폰·이어폰·차량 오디오)에서 들었을 때 일관성 있게 들리면 됩니다."
  - q: "LUFS는 얼마로 맞춰야 하나요?"
    a: "스트리밍 납품용은 -14 LUFS (Integrated), 마스터링 전 믹스는 -18~-20 LUFS로 헤드룸을 충분히 남겨두세요. 마스터링 엔지니어가 다이나믹 여유를 확보할 수 있도록 너무 높은 음압은 피합니다."
  - q: "파일 포맷은 어떻게 납품해야 하나요?"
    a: "마스터링 전 믹스는 24bit / 44.1kHz 또는 48kHz WAV로 납품합니다. MP3나 M4A는 납품용으로 부적합합니다. 스테레오 인터리브드 WAV 파일 1개 또는 스템 세트로 납품합니다."
---
