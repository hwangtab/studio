...
faq:
  ...
  - q: "연습 후 바로 녹음도 가능한가요?"
    a: "네, 음악연습실 입주 회원은 연습과 녹음 세션을 연계할 수 있습니다. 같은 건물 스튜디오에서 보컬·악기 녹음(전담 엔지니어 진행 시간당 10만원), 믹싱·마스터링까지 원스톱으로 진행 가능합니다."
---
...
3. **녹음 병행**: 스마트폰으로 자가 녹음만 해두어도 복습과 개선 포인트 파악에 유용합니다. 정식 녹음(전담 엔지니어 진행 시간당 10만원)으로 바로 연결할 수도 있습니다.
...
- 음악연습실 입주 → 보컬·악기 세션 개별 녹음(전담 엔지니어 진행 시간당 10만원) → 믹싱·마스터링
