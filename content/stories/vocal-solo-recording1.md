...
faq:
  - q: "1인 보컬 녹음만 받는 패키지가 있나요?"
    a: "네. 스튜디오 놀의 1인 보컬 녹음은 엔지니어 동반 시간당 10만원입니다. 마이크 세팅·디렉팅·기본 보정까지 포함되며, 1곡 기준 보통 2~3시간(20~30만원)이면 완성됩니다. 셀프 녹음·시간 대여는 운영하지 않으며 모든 세션에 엔지니어가 함께합니다."
...
| 옵션 | 시간 | 가격 | 포함 내용 |
|---|---|---|---|
| 1인 보컬 녹음 (엔지니어 동반) | 시간당 | 10만원 | 마이크 비교 선택, 디렉팅, 컴핑, 기본 보정 |
...
**1인 보컬 녹음 (엔지니어 동반 시간당 10만원).** 스튜디오 놀의 모든 녹음은 엔지니어가 함께 들어갑니다. 마이크 비교 선택, 게인 스테이징, 디렉팅, 세션 내 컴핑과 기본 보정까지 진행해요. 1곡 기준 보통 2~3시간이면 발매 직전 단계의 보컬을 받을 수 있어요. 셀프 녹음·시간 대여는 운영하지 않습니다.

**1곡 풀 패키지 (3~4시간 + 믹싱 / 70~90만원).** 한 곡을 완성도 있게 끝내고 싶으신 분, 발매 일정이 가까워서 한 번에 마무리하고 싶으신 분에게 적합해요. 녹음 세션(엔지니어 동반)과 1곡 믹싱 작업이 포함되어 있어요. 보컬 튠(피치 보정)과 노이즈 제거도 포함되어 있어서, 추가 비용 없이 발매 직전 마스터링 단계까지 진행할 수 있어요.
