...
faq:
  - q: "1인 보컬 녹음만 받는 패키지가 있나요?"
    a: "네. 스튜디오 놀은 보컬 1프로(1곡) 패키지 25만원을 운영합니다. 3시간 기준이며 전담 엔지니어 진행으로 마이크 세팅·디렉팅·기본 보정이 포함됩니다. 3시간 초과 시 시간당 8만원이 추가됩니다. 셀프 녹음·시간 대여는 운영하지 않으며 모든 세션에 엔지니어가 함께합니다."
...
| 옵션 | 시간 | 가격 | 포함 내용 |
|---|---|---|---|
| 보컬 녹음 1프로 (1곡 패키지) | 3시간 기준 | 25만원 | 마이크 비교 선택, 디렉팅, 컴핑, 기본 보정 / 초과 시 8만원/시간 |
...
**보컬 녹음 1프로 (25만원, 3시간 기준).** 스튜디오 놀의 모든 녹음은 엔지니어가 함께 들어갑니다. 마이크 비교 선택, 게인 스테이징, 디렉팅, 세션 내 컴핑과 기본 보정까지 진행해요. 3시간 초과 시 시간당 8만원이 추가됩니다. 셀프 녹음·시간 대여는 운영하지 않습니다.
