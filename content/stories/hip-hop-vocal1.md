---
title: 힙합 보컬·랩 녹음 — 플로우·딜리버리·오토튠·더블 트래킹 기법
date: 2026-04-06
author: 스튜디오 놀
category: 보컬 가이드
tags:
...
summary: >-
  마이크 가깝게 배치해 친밀하고 강렬한 사운드. 플로우·딜리버리·훅 레코딩과 힙합 믹싱 포인트.
faq:
...
## Studio NOL 힙합 보컬 녹음에서 가장 자주 손보는 3가지

스튜디오 놀에 들어오는 힙합·랩 보컬 녹음 의뢰에서 반복적으로 손이 가는 영역입니다.

**1. 메인 + 더블 + 애드립 — 멀티트랙 표준**

힙합 보컬은 메인 1트랙으로 끝나지 않습니다. 메인 + L/R 더블링 2트랙 + 애드립 1~2트랙 4~5개 보컬 레이어가 표준이며, 모든 트랙을 같은 컨디션에서 연속 녹음해야 자연스러운 두께감이 만들어집니다.

**2. 플로우 첫 마디 박자 — 0.1초 늦으면 전체 어긋남**

랩의 핵심은 첫 마디 박자 진입 정확도입니다. 가이드 라임 한두 마디를 연습 테이크로 부르며 헤드폰 모니터 볼륨을 조정하는 것이 첫 박자 정확도의 출발점입니다.

**3. 클로즈 마이킹 — 5~15cm + 팝 필터 필수**

힙합은 5~15cm 클로즈 마이킹으로 친밀하고 강렬한 사운드를 만듭니다. 마이크와 가까울수록 plosive(ㅂ·ㅍ) 위험이 커지므로 팝 필터를 5~7cm 거리에 두고, 게인을 클리핑 없는 -14~-10dBFS 피크 범위로 설정합니다.
