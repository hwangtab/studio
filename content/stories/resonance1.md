...
author: "스튜디오 놀"
category: "강좌"
tags: ["보컬 공명", "공명 훈련", "목소리 공명", "풍성한 목소리", "두성 공명", "흉성 공명", "마스크 공명"]
thumbnail: "/images/recording8.webp"
summary: "공명은 목소리에 풍성함과 울림을 더하는 핵심 요소입니다. 흉강·구강·비강·두강 공명의 위치와 특성, 각 공명을 찾고 활용하는 훈련법을 정리합니다."
faq:
  - q: "보컬 공명이란 무엇인가요?"
    a: "공명(Resonance)은 성대에서 만들어진 기본 진동이 몸의 공간(흉강, 구강, 비강, 두강)을 통해 증폭되고 색채가 더해지는 현상입니다. 공명에 따라 목소리의 풍성함, 밝기, 따뜻함, 파워가 달라집니다."
  - q: "마스크 공명이란 무엇인가요?"
    a: "마스크 공명(Mask Resonance)은 얼굴 앞쪽(코 주변, 광대뼈 부근)에서 느껴지는 공명입니다. 밝고 투과력 있는 소리를 만들며, 'ㅁ'이나 'ㄴ' 발음으로 코 주변에 진동이 느껴지면 마스크 공명이 활성화된 것입니다."
  - q: "공명을 어떻게 훈련하나요?"
    a: "허밍(흥~)으로 공명 위치를 찾는 것이 시작입니다. 허밍 중 입술이나 코에 손가락을 대면 진동이 느껴집니다. 이 진동 감각을 유지하면서 모음 발성으로 확장하는 것이 기본 훈련 방법입니다."
