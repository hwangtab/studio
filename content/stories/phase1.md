---
title: 오디오 위상이란? — 모노 호환성·위상 반전 문제 식별과 교정 완전 가이드
date: 2026-04-07
author: 스튜디오 놀
category: 믹싱·마스터링
tags:
...
summary: >-
  오디오 위상이란 두 신호가 시간축에서 맞지 않아 소리가 상쇄되거나 증폭되는 현상입니다. 마이크 배치·더블 트래킹·MS 마이킹에서 발생하는 위상 문제 원인, 모노 호환성 확인 방법, 교정 도구와 기법을 정리합니다.
faq:
  - q: 오디오 위상 문제란 무엇인가요?
    a: >-
