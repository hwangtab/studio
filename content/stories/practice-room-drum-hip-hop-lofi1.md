...
faq:
  - q: 힙합·로파이 드럼·붐뱁·드럼머신 그루브을 처음 연습할 때 어디서부터 시작해야 하나요?
    a: >-
      힙합·로파이 드럼·붐뱁·드럼머신 그루브 연습은 힙합 드럼이란?, 붐뱁 (Boom Bap), J Dilla 스타일 순서로 진행하는 것을
      추천합니다. 기초 단계를 충분히 소화한 후 다음 단계로 넘어가세요.
  - q: 힙합·로파이 드럼·붐뱁·드럼머신 그루브 연습 시 가장 중요한 포인트는 무엇인가요?
    a: >-
      힙합·로파이 드럼·붐뱁·드럼머신 그루브 연습에서 가장 중요한 것은 일정한 타이밍과 스틱 컨트롤입니다. 메트로놈과 함께 느린 BPM부터
      시작해 정확도를 높이세요.
...
## Studio NOL이 힙합·로파이 드럼 연습자에게 자주 권하는 3가지

스튜디오 놀(연신내, 서울 은평구) 음악연습실에서 힙합·로파이 드럼 상담에서 반복적으로 드리는 조언입니다.

**1. 박자 늦추기 — 정박 뒤로 살짝**

힙합·로파이는 정박이 아닌 미세하게 뒤로 늦춘 박자(레이드 백). 메트로놈에 맞추되 살짝 뒤로.

**2. 스네어 메인 — 강한 백비트**

힙합·로파이 시그니처는 강한 스네어 2·4박.

**3. J Dilla 그루브 — 카피로 학습**
