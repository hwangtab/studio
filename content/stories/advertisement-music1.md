...
faq:
  ...
  - q: "CM송과 BGM의 차이는 무엇인가요?"
    a: "CM송(Commercial Message Song)은 브랜드명·슬로건이 가사에 포함된 노래 형식입니다. BGM은 가사 없이 분위기를 만드는 배경음악입니다. CM송은 기억에 남기 쉽고, BGM은 브랜드 이미지를 서브리미널하게 전달합니다."
  - q: "기존 음악을 광고에 사용하려면 어떻게 하나요?"
    a: "저작권자(작사·작곡가 또는 퍼블리셔)와 음원 소유자(음반사)에게 싱크 라이센스와 마스터 라이센스를 각각 허가받아야 합니다. 미허가 사용 시 저작권 침해가 됩니다."
...
광고음악은 짧은 시간 안에 브랜드의 핵심 감성을 전달해야 합니다. 멜로디·편곡·레코딩의 완성도가 광고 효과에 직결됩니다.
