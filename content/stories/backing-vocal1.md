...
author: "스튜디오 놀"
category: "녹음 가이드"
tags: ["백보컬 녹음", "코러스 녹음", "하모니 레이어링", "백킹 보컬", "보컬 스택", "보컬 레이어", "코러스 믹싱"]
thumbnail: "/images/hardware3.webp"
summary: "백보컬(코러스) 녹음 완전 가이드. 하모니 구성, 레이어 쌓는 방법, 피치 블렌딩, 믹스에서 배치 전략까지 코러스 녹음을 처음 시도하는 보컬리스트를 위한 실전 가이드."
faq:
  - q: "백보컬과 코러스는 어떻게 다른가요?"
    a: "코러스(Chorus)는 곡의 후렴 구간을 뜻하기도 하고, 보컬 이펙트(코러스 이펙트)를 뜻하기도 합니다. 백보컬(Backing Vocal)은 메인 보컬을 지원하는 보조 성부를 말합니다. 실무에서는 '코러스 녹음'과 '백보컬 녹음'을 같은 의미로 사용하는 경우가 많습니다."
  - q: "하모니는 몇 개 레이어가 적당한가요?"
    a: "팝 발라드의 경우 3도·5도 위아래로 각 1~2개씩 총 3~5개 레이어가 일반적입니다. 너무 많으면 주파수가 겹쳐 흐릿해질 수 있으므로 메인 보컬보다 레벨을 -6~-12dB 낮게 배치합니다."
  - q: "백보컬 녹음 시 메인 보컬과 다른 마이크를 써야 하나요?"
    a: "같은 마이크를 사용하는 것이 음색 통일성에 유리합니다. 다만 백보컬은 메인보다 마이크와 약간 더 먼 거리(30~40cm)에서 녹음해 자연스러운 거리감을 만들기도 합니다."
  - q: "혼자서 모든 파트를 녹음할 수 있나요?"
    a: "가능합니다. 메인 보컬을 먼저 녹음하고 같은 가이드 트랙을 들으며 3도·5도 하모니를 차례로 레이어링합니다. 피치 수정 툴(Auto-Tune, Melodyne)로 블렌딩을 다듬으면 전문적인 코러스 사운드를 만들 수 있습니다."
---
