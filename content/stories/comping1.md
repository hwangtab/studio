...
faq:
  ...
  - q: "몇 번 녹음해야 좋은 컴핑이 가능한가요?"
    a: "일반적으로 같은 파트를 3~8번 녹음하면 충분한 선택지가 생깁니다. 너무 적으면 좋은 테이크가 없고, 너무 많으면 감정 신선도가 떨어집니다. 전문 스튜디오에서는 파트별 3~5회 반복이 일반적입니다."
  - q: "좋은 보컬 테이크를 고르는 기준은 무엇인가요?"
    a: "음정(Pitch) 정확도, 박자(Timing) 일치, 감정 표현, 발음·발성 명확도, 브레스 자연스러움이 핵심 판단 기준입니다. 음정과 박자만 맞고 감정이 없는 테이크보다 감정이 풍부한 테이크를 우선하는 것이 원칙입니다."
  - q: "컴핑 후 피치 교정이 필요한가요?"
