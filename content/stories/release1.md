...
author: "스튜디오 놀"
category: "강좌"
tags: ["음원 발매", "음원 유통", "멜론 발매", "스포티파이 발매", "디지털 싱글", "음악 유통사"]
thumbnail: "/images/album2.webp"
summary: "디지털 싱글을 멜론·스포티파이·애플뮤직에 발매하는 전 과정. 음원 유통사 선택, 마스터링 규격, 발매 신청 방법, 발매 후 스트리밍 수익까지 실전 정보를 정리했습니다."
faq:
  - q: "음원 발매를 하려면 어떤 준비가 필요한가요?"
    a: "마스터링이 완료된 WAV 파일(보통 24bit/48kHz 또는 44.1kHz)과 커버 아트(3000x3000px 이상 JPEG/PNG)가 기본입니다. 음원 유통사를 통해 제출하면 멜론·스포티파이 등 주요 플랫폼에 자동 배포됩니다."
  - q: "음원 유통사는 어디를 선택해야 하나요?"
    a: "국내 중심이라면 카카오뮤직(멜론·지니), 해외까지 배포하려면 DistroKid·TuneCore·CD Baby를 권장합니다. 각각 연간 구독료 또는 곡별 요금이 다르므로 발매 계획에 맞게 선택하세요."
  - q: "음원 발매 후 스트리밍 수익은 얼마나 되나요?"
    a: "멜론은 스트리밍 1회당 약 5~6원, 스포티파이는 약 0.003~0.005 USD입니다. 수익은 음원 사용료 징수 후 약 2~3개월 뒤에 정산됩니다. 초기에는 마케팅(플레이리스트 피칭, SNS 홍보)이 스트리밍 수를 좌우합니다."
  - q: "마스터링 없이 음원을 발매해도 되나요?"
    a: "기술적으로는 가능하지만, 스트리밍 플랫폼의 자동 음량 정규화(-14 LUFS)로 음원이 작게 들릴 수 있습니다. 발매 전 마스터링으로 음압을 최적화하는 것을 강력히 권장합니다."
---
