...
summary: >-
  기획사·레이블에 제출하는 데모 트랙의 기준과 제작 방법을 안내합니다. 심사위원이 실제로 보는 것, 데모 곡 선정 기준, 녹음 품질 수준, 발송 방법까지 실전 정보를 정리했습니다. 홈레코딩 환경에서도 바로 적용할 수 있는 실전 팁을 단계별로 정리합니다.
faq:
