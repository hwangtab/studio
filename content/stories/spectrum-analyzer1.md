...
summary: >-
  스펙트럼 분석기 완전 가이드입니다. FFT 원리, 믹싱·마스터링에서의 활용법, 주파수 밸런스 체크, 마스킹 발견, SPAN·iZotope Insight 등 추천 플러그인을 정리합니다. 스튜디오 놀 엔지니어의 실무 경험을 바탕으로 홈레코딩 환경에서 바로 적용할 수 있도록 정리했습니다.
faq:
  - q: 스펙트럼 분석기란 무엇인가요?
    a: >-
