...
faq:
  - q: 기타 컨트리·치킨피킹 기법을 처음 연습할 때 어디서부터 시작해야 하나요?
    a: >-
      기타 컨트리·치킨피킹 기법 연습은 치킨피킹 (Chicken Picking), 컨트리 리드 기타 기법, 텔레캐스터 세팅 순서로 진행하면 좋습니다. 기초 단계를 충분히 소화한 후 다음 단계로 넘어가세요.
  - q: 기타 컨트리·치킨피킹 기법 연습 시 핵심 포인트는 무엇인가요?
    a: >-
...
스튜디오 놀(연신내, 서울 은평구) 음악연습실에서 컨트리 기타·치킨 피킹 상담 때 자주 드리는 조언입니다.
