...
Pro Tools 기본 설정 방법을 단계별로 정리했습니다.
...
트랙 생성 및 녹음의 핵심 포인트를 단계별로 설명합니다.
...
EQ III / Pro-Q3 설정 방법을 단계별로 정리했습니다.
...
Dynamics III 컴프레서 설정 방법을 단계별로 정리했습니다.
...
다음 내용에서 파일 내보내기 (Bounce)을 자세히 다룹니다.
