...
summary: >-
  보컬 녹음 전 MR(반주) 파일을 구하는 방법. 유료 MR 사이트, 유튜브 MR 활용, 직접 제작 의뢰, 키 조정 방법까지 녹음 준비를 위한 MR 완전 가이드. 홈레코딩 환경에서도 바로 적용할 수 있는 실전 팁을 단계별로 정리합니다.
faq:
  ...
  - q: 키(Key)가 맞지 않는 MR을 조정할 수 있나요?
    a: >-
      ...
      반음 단위로 올리거나 내릴 수 있습니다. 단, MR을 직접 구매할 때 '원하는 키 MR'을 요청하면 최상의 품질을 얻을 수 있습니다.
  - q: MR 없이 녹음할 수 있나요?
    a: >-
...
MR 파일 포맷은 WAV 44.1kHz/16bit 이상이 녹음 세션 기준이며, MP3 MR을 사용할 경우 최소 320kbps를 권장합니다. 파일명에 곡명·키·BPM을 포함하면(예: 사랑의배터리_Bb_120BPM.wav) 세션에서 엔지니어와 소통이 빠르고 실수를 줄일 수 있습니다.
