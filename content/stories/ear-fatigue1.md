...
## Studio NOL이 청각 피로 관리자에게 자주 권하는 3가지

스튜디오 놀(연신내, 서울 은평구)에서 청각 피로·믹싱 환경 상담에서 반복적으로 드리는 조언입니다.

**1. 30~60분 휴식 — 청각 회복**

장시간 믹싱은 청각 피로. 30~60분마다 5분 휴식 필수.

**2. 레퍼런스 A/B — 절대 기준 회복**

본인 믹스와 레퍼런스 트랙 A/B 비교로 절대 기준 회복.

**3. LUFS 정규화 — 볼륨 차이 보정**

비교 전 LUFS 정규화. 볼륨 차이로 인한 착각 회피.
