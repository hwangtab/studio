...
summary: >-
  셀프 보컬 녹음 준비 기준을 녹음 전 준비물, 세션 진행, 결과물 확인 포인트에 맞춰 정리합니다. 연신내 Studio NOL의 장비와 엔지니어링 관점도 함께 확인하세요.
faq:
...
## Studio NOL 셀프 녹음 파일로 의뢰 시 가장 자주 받는 3가지 지적

스튜디오 놀에서 셀프 녹음 보컬 파일로 온라인 믹싱·튠 의뢰를 받을 때 자주 받는 지적입니다.

**1. 공간 — 이불 텐트로 흡음 보강**

가정용 방에서 그대로 녹음하면 룸 반사음이 마이크에 잡혀 후처리에서 제거할 수 없습니다. 마이크 주변에 이불·매트리스를 둘러 임시 흡음 부스를 만들면 잔향이 5~10dB 줄어들어 후처리 부담이 크게 줄어듭니다.

**2. 입력 레벨 — -18~-12dBFS 표준**

너무 작게 녹음한 파일은 게인 업 시 노이즈가 함께 증폭되고, 너무 크게 녹음한 파일은 클리핑 위험이 있습니다. 입력 레벨이 -18~-12dBFS 범위에 있도록 사전 점검합니다.

**3. 파일 — WAV 24bit/48kHz + MR 함께 전달**

MP3가 아닌 WAV 24bit/48kHz로 저장하고, MR 파일도 BPM·키 정보와 함께 전달합니다. 보컬 파일만 보내면 정확한 키·박자 정렬이 어려워 작업 시간이 길어집니다.
