...
## Studio NOL이 콰탈 보이싱 연습실 사용자에게 자주 권하는 3가지

스튜디오 놀(연신내, 서울 은평구) 음악연습실에서 피아노 콰탈 보이싱(4도 적층) 연습 상담에서 반복적으로 드리는 조언입니다.

**1. 4도 적층 — McCoy Tyner·Herbie Hancock 시그니처**

콰탈 보이싱은 4도 간격으로 음을 적층한 보이싱입니다. McCoy Tyner·Herbie Hancock의 시그니처 사운드입니다.

**2. 모달 재즈 적용 — 한 코드에 머무는 곡**

콰탈 보이싱은 모달 재즈(So What, Impressions 등 한 코드에 오래 머무는 곡)에 가장 잘 맞습니다.

**3. 양손 분리 — 왼손 4도, 오른손 멜로디**

왼손 콰탈 보이싱이 자동화되면 오른손 멜로디가 자유로워집니다. 왼손 단독 BPM 80에서 자동화합니다.
