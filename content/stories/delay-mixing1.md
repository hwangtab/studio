...
## Studio NOL이 딜레이 믹싱 사용자에게 자주 권하는 3가지

스튜디오 놀(연신내, 서울 은평구)에서 딜레이 믹싱 상담 때 자주 드리는 조언입니다.

**1. BPM 동기화 — 1/4·1/8 음표**

딜레이 타임을 BPM에 동기화. 1/4·1/8 음표가 표준.

**2. 에코 EQ — 고역·저역 정리**

딜레이 에코는 EQ로 고역·저역 정리. 메인 보컬 가리지 않게.

**3. Aux 버스 분리 — 보컬 채널 X**

딜레이는 Aux 버스 분리. 보컬 채널 직접 인서트 X.
