...
faq:
  ...
  - q: "트랩 비트의 기본 BPM은 얼마인가요?"
    a: "트랩 비트의 표준 BPM은 130~145BPM입니다. 단, 실제 체감 템포는 절반(65~72.5BPM)으로 느껴지도록 3연음 하이햇을 사용합니다. 최근 플로우 트랩은 80~120BPM의 더 느린 버전도 인기입니다."
  - q: "808 베이스를 올바르게 사용하는 방법은?"
    a: "808 베이스는 킥 드럼의 저음을 확장하는 서브 베이스입니다. 킥과 808이 겹칠 때 사이드체인 컴프레서로 킥이 808보다 먼저 들리도록 설정합니다. 808 피치를 멜로디에 맞게 설정하면 베이스 라인이 됩니다."
