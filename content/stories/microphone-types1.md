...
author: "스튜디오 놀"
category: "음반 제작 가이드"
tags: ["마이크 종류", "다이나믹 마이크", "콘덴서 마이크", "리본 마이크", "마이크 비교", "폴라 패턴", "보컬 마이크 추천"]
thumbnail: "/images/portfolio5.webp"
summary: "마이크 종류 완전 가이드입니다. 다이나믹·콘덴서·리본 마이크의 작동 원리와 차이, 카디오이드·옴니·피겨8 폴라 패턴, 용도별 마이크 선택법을 정리합니다."
faq:
  - q: "다이나믹 마이크와 콘덴서 마이크의 차이는 무엇인가요?"
    a: "다이나믹 마이크는 코일 진동으로 소리를 잡아 내구성이 강하고 팬텀 파워가 필요 없습니다. 콘덴서 마이크는 축전기 원리로 동작해 고역 해상도가 높고 감도가 뛰어납니다. 스튜디오 보컬 녹음에는 콘덴서 마이크가 표준입니다."
  - q: "카디오이드 마이크가 무엇인가요?"
    a: "카디오이드(Cardioid)는 마이크 정면 방향의 소리를 가장 잘 잡고 후면 소리를 차단하는 폴라 패턴입니다. 보컬 녹음과 악기 마이킹의 기본 패턴으로, 룸 소음을 최소화하는 데 유리합니다."
  - q: "리본 마이크는 언제 사용하나요?"
    a: "리본 마이크는 따뜻하고 빈티지한 음색이 특징입니다. 기타 앰프, 드럼 오버헤드, 브라스 악기에 많이 사용합니다. 충격에 약하고 팬텀 파워를 인가하면 손상될 수 있어 취급에 주의가 필요합니다."
  - q: "보컬 녹음에 가장 좋은 마이크는 무엇인가요?"
    a: "스튜디오 보컬 녹음 표준은 Neumann U87 AI(라지 다이어프램 콘덴서)입니다. 카디오이드 패턴 설정으로 룸 소음을 최소화하고, 팝필터를 함께 사용해 파열음을 제거합니다. 스튜디오 놀에서도 U87 AI를 기본 사용합니다."
---
