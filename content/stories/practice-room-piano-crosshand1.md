...
## 크로스핸드의 정확성은 눈으로 미리 조준하는 데서 나옵니다

크로스핸드, 즉 한 손이 다른 손 위를 넘어가 건반을 짚는 연주는 보기엔 멋지지만 목표 건반을 자꾸 놓쳐 애먹는 기법이에요. 비결은 눈이에요. 손이 넘어가기 전에 시선이 먼저 목표 건반에 가 있어야 정확히 착지합니다. 지금 치는 건반이 아니라 다음에 넘어갈 자리를 미리 보는 거죠. 이 '눈이 손을 이끄는' 감각이 크로스핸드의 전부라 해도 과언이 아니에요.

연습은 양손을 따로 익힌 뒤 합치는 게 순서입니다. 처음부터 두 손을 교차시키면 서로 부딪혀 엉키니, 각 손의 동선을 단독으로 자동화한 다음 조심스럽게 겹치세요.

그리고 내 동선은 내가 못 봅니다. 거울이나 영상으로 손이 넘어가는 모습을 찍어 보면, 어디서 손이 헤매고 어색해지는지가 객관적으로 드러나요. 이 점검이 크로스핸드를 빠르게 다듬어 줍니다. 멀리 떨어진 음을 정확히 짚는 도약 훈련은 [피아노 도약 연습](/stories/practice-room-piano-leaps1)에서 이어집니다.
