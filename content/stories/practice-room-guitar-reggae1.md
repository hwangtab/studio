...
faq:
  ...
  - q: 레게 기타·스카·록스테디·오프비트 리듬 연습할 때 무엇을 신경 쓰면 좋나요?
    a: >-
      레게 기타·스카·록스테디·오프비트 리듬 연습에서는 정확한 손 포지션과 리듬감이 중요합니다. 메트로놈을 활용해 느린 템포부터
...
summary: >-
  레게 기타·스카·록스테디·오프비트 스크래치·Peter Tosh·Bob Marley 스타일. 레게 기타를 은평구 24시간 음악연습실에서 마스터.
---
...
## 레게 기타는 강박을 비우고 약박만 치는 음악입니다

레게 기타의 그 특유의 통통 튀는 느낌은 남들이 다 치는 강박을 오히려 비우는 데서 나와요. 레게의 골격은 약박, 즉 박과 박 사이의 '&' 자리에만 코드를 짧게 끊어 치는 겁니다. 강박은 베이스와 드럼이 채우고, 기타는 그 사이의 뒷박을 콕콕 찌르는 거죠. 처음엔 강박을 안 치는 게 어색하지만, 이 오프비트 감각이 몸에 배야 비로소 레게가 됩니다.

소리는 짧아야 해요. 코드를 친 즉시 왼손 힘을 풀거나 손바닥으로 현을 덮어 뚝 끊는, 스타카토 어택이 핵심입니다. 음이 길게 늘어지면 그 특유의 탄력이 사라져요. 치자마자 죽이는 감각을 익히세요.

톤은 맑고 날카로워야 합니다. 레게 기타는 왜곡 없는 클린 톤에 트레블을 강조해, 톤 노브를 8~10으로 올린 쨍한 소리가 표준이에요. 이 밝은 소리가 짧은 어택과 만나 레게 특유의 '척, 척' 하는 컴핑을 완성합니다. 코드를 끊는 뮤트 기법은 [기타 뮤트 연습](/stories/practice-room-guitar-mute1)에서 이어집니다.
