...
## Studio NOL이 레게 기타 연습실 사용자에게 자주 권하는 3가지

스튜디오 놀(연신내, 서울 은평구) 음악연습실에서 레게·스카·록스테디·오프비트 리듬 연습 상담에서 반복적으로 드리는 조언입니다.

**1. 오프비트 강조 — 약박 단독 연주**

레게의 골격은 약박(&) 단독 코드 컴핑입니다. 강박은 베이스가 채웁니다.

**2. 짧은 어택 — 스타카토 강조**

레게 기타는 짧고 끊는 어택이 핵심입니다. 코드를 친 후 즉시 손바닥으로 뮤트합니다.

**3. 클린 톤 — 트레블 강조**

레게 기타는 클린 톤에 트레블이 강조된 사운드입니다. 톤 노브를 8~10으로 올립니다.
