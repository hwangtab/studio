...
## 피치 보정을 하며 지키는 선 — 자연스러움이 먼저

Melodyne은 강력해서 오히려 과하게 쓰기 쉬운 도구예요. 세션에서 보컬을 다듬을 때 제가 지키는 원칙을 알려드릴게요. 핵심은 "고쳤는지 티가 안 나게"입니다.

**100%로 붙이지 않습니다.** Pitch Center를 100%로 밀면 음정은 완벽해도 사람 목소리 특유의 미세한 흔들림이 사라져 로봇처럼 들려요. 90~95% 정도로 잡아 미세 변동을 남겨두는 게, 정확하면서도 살아있는 소리를 만드는 지점입니다.

**반음 이상 틀렸으면 고치지 말고 다시 부릅니다.** 보정은 50센트(반음의 절반) 이내에서만 자연스러워요. 그 이상을 억지로 끌어올리면 포먼트가 깨지고 음색이 뭉개집니다. 크게 틀린 구간은 보정보다 재녹음이 항상 더 좋은 결과를 냅니다. 그래서 저는 녹음 단계에서 키를 제대로 잡는 걸 훨씬 중요하게 봐요.

**포먼트는 최소한으로 건드립니다.** 음정을 옮기면 음색(포먼트)도 따라 변하는데, 이걸 과하게 보정하면 목소리가 낯설어져요. Formant 조정은 ±0.5반음 이내로 억제하는 게 안전합니다. 결국 좋은 보정은 '많이 고치는 것'이 아니라 '덜 티 나게 고치는 것'입니다.
