...
faq:
  ...
  - q: "성우 데모 녹음 비용은 얼마인가요?"
    a: "스튜디오 놀의 녹음은 엔지니어 동반 시간당 10만원입니다. 데모 1편(90초~3분) 녹음은 보통 2시간(20만원)이면 충분합니다. 편집·노이즈 제거·라우드니스 정상화까지 포함됩니다. 카카오톡으로 무료 견적 가능합니다."
...
**시간당 10만원 (엔지니어 동반 녹음 기본).** 1시간 단위로 부스 + 엔지니어 + 기본 편집 포함. 본인이 이미 완성된 대본·연출 계획을 가지고 오시면 1시간 만에 광고 데모 1편 정도는 녹음 가능해요. 단, 워밍업 + 본녹음 + 편집까지 제대로 하려면 최소 2시간 권장이에요.
