...
## Studio NOL이 워밍업 연습자에게 자주 권하는 3가지

스튜디오 놀(연신내, 서울 은평구) 음악연습실에서 워밍업 루틴 상담에서 반복적으로 드리는 조언입니다.

**1. 시간 고정 — 매 세션 10~15분**

워밍업은 매 세션 시작 10~15분 고정 시간을 배정합니다.

**2. 단계적 강도 — 약 → 강**

워밍업은 약한 동작 → 강한 동작 순으로 단계적으로 강도를 올립니다.

**3. 부상 방지 우선 — 통증 시 즉시 중단**

워밍업 중 통증이 있으면 즉시 중단합니다.
