...
summary: >-
  보컬 녹음 전 MR·편곡·작사 외주를 맡기는 방법. 의뢰 플랫폼 비교, 전달해야 할 정보, 계약서 작성 기준, 저작권 처리 방법까지 음악 외주…
faq:
...
## Studio NOL이 음악 작업 의뢰자에게 자주 권하는 3가지

스튜디오 놀(연신내, 서울 은평구)에서 음악 작업 의뢰 상담에서 반복적으로 드리는 조언입니다.

**1. 저작권 양도 vs 라이선스 — 목적 따라 선택**

발매·방송용은 저작권 양도. 개인 SNS는 비독점 라이선스로 충분.

**2. 계약서 명시 — 사용 범위·기간**

구두 약속 X. 계약서에 사용 범위·기간 명시.

**3. KOMCA 신탁 여부 — 사전 확인**

KOMCA 신탁 여부는 계약 전 반드시 확인.
