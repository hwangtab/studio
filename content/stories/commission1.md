...
작곡가가 이미 KOMCA에 신탁을 걸어 둔 곡이라면, 나중에 사용 방식에 제약이 생길 수 있습니다. 계약서에 서명하기 전에 이 부분을 반드시 물어보셔야 합니다. 이런 조건까지 정리해서 아예 저희 쪽에서 제작을 진행하실 거면, 작업 범위별 기준은 [요금 안내](/pricing)에서 먼저 확인하실 수 있습니다.
