...
슈게이즈 톤은 리버브 + 코러스/플랜저 + 디스토션 다중 결합. 이펙터 체인 설계 시간 충분히.

**2. Glide Guitar — 비브라토 바 적극 활용**

My Bloody Valentine 시그니처는 비브라토 바를 사용한 글라이드 기타. 트레몰로 암 적극 사용.

**3. 멜로디·노이즈 동시 — 노이즈 속에서 멜로디 들려야**

슈게이즈는 노이즈가 많지만 그 속에서 멜로디가 들려야 합니다. 노이즈와 멜로디 균형.
