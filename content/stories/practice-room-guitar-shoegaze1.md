...
faq:
  - q: >-
    ...
    a: >-
      ...
      Bloody Valentine 스타일, Slowdive 스타일 순서로 진행하면 좋습니다. 기초 단계를 익힌 뒤 다음 단계로
      넘어가세요.
  - q: >-
      슈게이징 기타·Wall of Sound·My Bloody Valentine·Slowdive 스타일 연습할 때 무엇을 신경 쓰면
      좋나요?
    a: >-
...
summary: >-
  슈게이징 기타·Wall of Sound·My Bloody Valentine·Slowdive·Cocteau Twins 스타일.
---
...
## 슈게이즈는 노이즈의 벽 속에 멜로디를 숨기는 음악입니다

슈게이즈 기타의 그 몽롱하고 벽처럼 밀려오는 사운드는 이펙터의 겹겹 조합에서 나와요. 리버브로 공간을 무한히 넓히고, 코러스나 플랜저 같은 모듈레이션으로 소리를 일렁이게 하고, 거기에 디스토션까지 얹어 두툼한 노이즈의 벽을 세우는 거죠. 이 여러 이펙터를 어떤 순서로 어떻게 섞느냐가 슈게이즈 톤의 절반이라, 연주 전 이펙터 체인 설계에 시간을 충분히 들여야 합니다.

My Bloody Valentine의 시그니처인 글라이드 기타도 익혀 보세요. 비브라토 바(트레몰로 암)를 치는 내내 미묘하게 흔들어, 음정 전체가 일렁이며 녹아내리는 듯한 그 몽환적인 효과를 내는 겁니다. 코드를 잡고 암을 살살 흔드는 감각이에요.

가장 중요한 원칙은, 노이즈가 아무리 두꺼워도 그 속에서 멜로디가 들려야 한다는 겁니다. 노이즈에 파묻혀 멜로디가 사라지면 그냥 소음이 돼요. 노이즈와 멜로디의 균형을 잡는 게 슈게이즈의 미학입니다. 톤과 질감을 다루는 인디 사운드는 [인디·얼터너티브 기타 연습](/stories/practice-room-guitar-indie-alternative1)에서 이어집니다.
