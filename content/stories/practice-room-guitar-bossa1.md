...
faq:
  - q: 보사노바 기타·삼바 리듬·João Gilberto 스타일을 처음 연습할 때 어디서부터 시작해야 하나요?
    a: >-
      보사노바 기타·삼바 리듬·João Gilberto 스타일 연습은 보사노바란?, João Gilberto 기타 리듬, Tom Jobim
      화성 순서로 진행하면 좋습니다. 기초 단계를 익힌 뒤 다음 단계로 넘어가세요.
  - q: 보사노바 기타·삼바 리듬·João Gilberto 스타일 연습할 때 무엇을 신경 쓰면 좋나요?
    a: >-
      보사노바 기타·삼바 리듬·João Gilberto 스타일 연습에서는 정확한 손 포지션과 리듬감이 중요합니다. 메트로놈을
      활용해 느린 템포부터 연습하고, 깨끗한 음 하나하나에 집중하세요.
  - q: 음악연습실에서 보사노바 기타·삼바 리듬·João Gilberto 스타일 연습하면 어떤 장점이 있나요?
    a: >-
...
## 보사노바 기타는 한 손으로 두 사람 몫을 합니다

보사노바 기타의 매력은 혼자서 베이스와 리듬을 동시에 연주해, 마치 두 사람이 함께 반주하는 것처럼 들린다는 거예요. 그 바탕이 엄지 베이스입니다. 엄지가 1박과 3박에 저음을 규칙적으로 짚어 곡 전체를 떠받치는데, 이게 흔들리면 위에 얹는 모든 게 무너져요. 그래서 엄지 베이스만 따로 떼어 BPM 90 정도에서 생각 없이 굴러갈 만큼 자동화한 뒤, 그 위에 손가락 컴핑을 얹는 순서로 익힙니다.

보사노바 특유의 느긋한 흔들림은 컴핑의 강세에서 나와요. 정박이 아니라 약박, 즉 2박과 4박 쪽에 액센트를 실어야 그 나른한 보사노바 감성이 살아납니다. 메트로놈을 2·4박에 맞춰 놓고 강세 위치를 또렷이 하는 훈련이 필요해요.

음색은 손톱이 결정합니다. 보사노바 컴핑은 손톱으로 현을 살짝 긁어내는 부드러운 어택이 핵심이라, 오른손 손톱을 1~2mm로 유지하고 파일로 매끄럽게 다듬어 두세요. 보사노바가 즐겨 쓰는 재즈 코드를 손에 익히는 법은 [기타 재즈 코드·재즈 보이싱](/stories/practice-room-guitar-jazz-voicing1)에서 이어집니다.
