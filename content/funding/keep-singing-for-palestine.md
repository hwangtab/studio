...
summary: 9월 19일 거리집회 〈Keep Singing for Peace〉를 마쳤습니다. 이미 치른 진행비를 채우는 펀딩입니다. 후원해 주시면 앨범 〈이름을 모르는 먼 곳의 그대에게〉 13곡을 보내 드립니다.
...
rewards:
  ...
  - id: wav-hires-plus
    title: 가장 든든한 펀딩 — 세 가지 모두
    description: 세 가지 음질을 모두 보내 드립니다.
    amount: 100000
    requiresShipping: false
    estimatedDelivery: 2026-09
    image: /images/funding/keep-singing-for-palestine/album.webp
...
거리 집회 〈Keep Singing for Peace〉가 무사히 끝났습니다.

그날 하루는 세 자리로 이어졌습니다. 오후 1시 종로에서 파병 반대 집회에 참가해 연대 공연을 했고, 3시에는 서울시청에서 기후정의행진에 함께했습니다. 그리고 저녁 6시부터 경복궁 돌담 앞 서십자각터에서 세 시간 동안 음악과 함께하는 집회를 열었습니다.

무대에 선 사람들과 스태프, 지정발언과 자유발언으로 함께한 분들, 거리를 지나다 걸음을 멈추고 응원을 보낸 분들이 그 세 시간을 같이 만들었습니다.

조직위원회는 그날을 이렇게 적었습니다.

> 세계는 전쟁과 기후재앙으로 불타고 있고, 자본과 군사주의 카르텔과 국가주의는 민중의 삶을 끝없이 파편화시킵니다. 그럼에도 우리는 서로의 손을 마주잡고, 함께 노래하고, 춤추며 뛰어 노는 시간 속에서 우리 모두가 타인의 아픔에 공감하고, 서로의 존재를 환대할 수 있는 연대의 능력을 지닌 존재라는 것을 다시 한 번 경험할 수 있었습니다.

그날 참가자들이 함께 외친 구호입니다.

> 미국·이스라엘은 서아시아 침략전쟁과 집단학살 중단하라!
>
> 어떠한 형태의 군사적 개입도 거부한다. 꼼수 파병 반대한다!
>
> 흔들림 없는 연대투쟁, 팔레스타인 해방 쟁취하자!

## 집회는 끝났는데 펀딩은 왜 계속되나

**진행비를 이미 썼기 때문입니다.** 거리에 선 뮤지션들의 출연료와 식비, 음향·장비 비용이 그날 치러졌고, 이 펀딩은 그 돈을 채웁니다. 10월 19일까지 열어 둡니다.

들어올 돈을 스스로 지운 결정이 앞에 있었습니다. 조직위원회는 본래 9월 19일 저녁 서울 반쥴에서 평화 콘서트를 열 예정이었고 표도 팔고 있었는데, 일주일 전 540여 개 단체가 종로에 모여 호르무즈 파병 거부를 요구하는 것을 보고 판단을 바꿨습니다. 음악을 통한 연대를 넘어 직접 광장으로 나가야 할 때라고요. 대관을 취소하고 예매를 마감했으며, 표를 산 분들께는 전액을 돌려드렸습니다.

집회에 관한 문의는 강정피스앤뮤직캠프 조직위원회(010-2379-0760, 이상)로 하시면 됩니다. 펀딩과 리워드 문의는 스튜디오 놀이 받습니다.

## 그날 노래한 것이 끝난 일이 아닌 이유

파병을 막는 일은 아직 끝나지 않았습니다. 대통령은 9월 18일 기자회견에서 "전쟁에 관여하거나 개입하는 파병은 없다"고 했지만, 호르무즈 인근 청해부대의 역할을 강화하는 방안은 검토 중이라고 밝혔습니다. 전투병력인지 비전투병력인지도 정해지지 않았습니다. 그날 광장에서 "꼼수 파병 반대한다"는 구호가 나온 자리가 거기입니다.
...
원하시면 결제 화면에서 응원 메시지를 남기고, 이름과 함께 후원자 명단에 공개할 수 있습니다. 어느 리워드를 고르셨는지와는 무관합니다. 공개 여부는 후원 확인 페이지에서 언제든 다시 바꾸실 수 있습니다.

## 후원 금액은 이렇게 쓰입니다

거리에 함께한 뮤지션들의 출연료와 식비, 그리고 음향·장비 비용입니다. 9월 19일에 이미 치른 돈이고, 모이는 금액이 그 자리를 채웁니다.

목표를 넘긴 금액은 이어지는 연대 활동에 보탭니다. 항목별 금액을 못 박아 두지는 않았습니다.

한 가지만 분명히 해 두겠습니다. 이 펀딩은 기부가 아니라 리워드가 있는 선주문 형태의 통신판매입니다. 기부금영수증은 발급되지 않습니다. 목표 금액에 못 미쳐도 모인 만큼으로 정산하고, 리워드는 그대로 보내 드립니다.

## 내려받기 안내

결제가 확정되면 내려받기 주소를 메일로 보내 드립니다. 후원 확인 페이지에서도 언제든 다시 보실 수 있습니다.

내려받는 형태의 리워드라 내려받기가 시작된 뒤에는 청약철회가 제한됩니다. 내려받기 전이고 모금이 진행 중이며 아직 발송 준비가 시작되지 않았다면, 후원 확인 페이지에서 취소하고 전액 환불받으실 수 있습니다.
