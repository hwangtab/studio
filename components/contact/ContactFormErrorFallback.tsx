  ...
  <div className="mb-6 rounded-md border border-amber-300 bg-amber-50 p-4 dark:border-amber-500/30 dark:bg-amber-500/10">
    ...
    <div className="flex flex-col gap-2 sm:flex-row">
      <a
        ...
        className="inline-flex min-h-[44px] flex-1 items-center justify-center gap-2 rounded-md bg-kakao px-4 py-2 text-sm font-bold text-kakao-ink transition-colors hover:bg-kakao-dark touch-manipulation focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-kakao-ink dark:focus-visible:ring-kakao focus-visible:ring-offset-2 focus-visible:ring-offset-white dark:focus-visible:ring-offset-gray-900"
      >
