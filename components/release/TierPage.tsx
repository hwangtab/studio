    ...
    <div className="overflow-visible">
      ...
      <Section variant="default">
        ...
        <div className="max-w-2xl mx-auto space-y-3">
          ...
          <p className="text-sm text-gray-500 dark:text-gray-400 text-center mt-4 pt-1">
      ...
      <Section variant="alternate">
        ...
        <div className="max-w-3xl mx-auto grid grid-cols-1 sm:grid-cols-2 gap-6">
          ...
          <div className="bg-gray-50 dark:bg-gray-900/50 rounded-2xl p-6 border border-gray-100 dark:border-gray-700">
            <h3 className="font-semibold text-gray-500 dark:text-gray-400 mb-4 flex items-center gap-2 text-sm">
