...
const primaryButtonBase = 'inline-flex items-center justify-center w-full sm:w-auto text-center whitespace-normal leading-snug min-h-[48px] font-bold text-base sm:text-lg py-4 px-10 rounded-full transition-transform duration-300 shadow-lg hover:shadow-xl hover:-translate-y-1 touch-manipulation focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-2';
...
const formPrimaryClassName = `${primaryButtonBase} bg-white text-primary-dark hover:bg-gray-100 focus-visible:ring-primary/70 focus-visible:ring-offset-white`;
