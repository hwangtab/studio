    ...
    <div className="my-8 rounded-xl glass-card overflow-hidden">
      ...
      <div className="px-6 pb-5 flex flex-wrap items-center gap-x-4 gap-y-2">
        ...
        <NextLink
          ...
          className="rounded text-sm font-semibold text-primary dark:text-primary-lighter hover:underline underline-offset-4 min-h-[44px] inline-flex items-center focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary/70 dark:focus-visible:ring-primary-lighter/70 focus-visible:ring-offset-2 focus-visible:ring-offset-white dark:focus-visible:ring-offset-gray-900"
        >
          온라인 믹싱 의뢰 안내
        </NextLink>
      </div>
