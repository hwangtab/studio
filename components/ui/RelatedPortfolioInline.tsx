    ...
    >
      <div className="flex items-center justify-between gap-4 mb-6 flex-wrap">
        ...
        <Link
          ...
          prefetch={false}
          className="inline-flex items-center gap-1 typo-card-cta text-primary dark:text-primary-lighter hover:underline min-h-[44px] touch-manipulation rounded-md focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary/70 dark:focus-visible:ring-primary-lighter/70 focus-visible:ring-offset-2 focus-visible:ring-offset-white dark:focus-visible:ring-offset-gray-900"
        >
