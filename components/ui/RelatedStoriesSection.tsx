  ...
  return (
    <Section variant="default">
      ...
      <div className="mt-10 text-center">
        <Link
          href={allHref}
          className="inline-flex items-center gap-2 typo-card-cta text-primary dark:text-primary-lighter hover:underline min-h-[44px] touch-manipulation rounded-md focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary/70 dark:focus-visible:ring-primary-lighter/70 focus-visible:ring-offset-2 focus-visible:ring-offset-white dark:focus-visible:ring-offset-gray-900"
        >
