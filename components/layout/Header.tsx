...
export const Header = React.forwardRef<HTMLElement, HeaderProps>(({ locale, isScrolled, hasHero, isDarkMode, toggleDarkMode }, ref) => {
  ...
  return (
    <header
      ref={ref}
      className={`fixed w-full z-50 transition-all duration-300 py-4 shadow-lg backdrop-blur-xl ${isScrolled
        ? 'bg-white/80 dark:bg-gray-900/80 shadow-gray-200/50 dark:shadow-gray-950/50'
        : hasHero
