    ...
    <div>
      {showTitle && (
        <div className="flex items-center mb-6">
          {TitleIcon && React.createElement(TitleIcon, { className: "text-xl text-primary dark:text-primary-lighter mr-3" })}
          ...
          {categories.map((category) => {
            ...
            return (
              <m.button
                ...
                className={`${sizeClasses[buttonSize]} rounded-full transition-colors transition-shadow duration-300 min-w-fit whitespace-nowrap flex-shrink-0 min-h-[44px] sm:min-h-[36px] touch-manipulation focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary/70 dark:focus-visible:ring-primary-lighter/70 focus-visible:ring-offset-2 focus-visible:ring-offset-white dark:focus-visible:ring-offset-gray-900 ${isActive
