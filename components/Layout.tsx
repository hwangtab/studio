...
const Layout = ({ children, hasHero, locale = defaultLocale }: LayoutProps) => {
  ...
  return (
    ...
    >
      ...
      <a
        href="#main-content"
        className="sr-only focus:not-sr-only focus:fixed focus:top-4 focus:left-4 focus:z-[60] focus:px-4 focus:py-2 focus:rounded-md focus:bg-canvas focus:text-ink focus:shadow-lg focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-link-focus/40"
      >
        {skipLabel}
      </a>
