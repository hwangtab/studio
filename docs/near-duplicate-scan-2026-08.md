...
> 전체 페어 데이터(지역·noindex 포함 31건): [near-duplicate-scan-2026-08.csv](near-duplicate-scan-2026-08.csv)
...
- 비교 페어: 594,595건 → 크기 필터 통과 521,005건 → 스케치 통과 247건 → **J ≥ 0.45 등재 31건**
- GSC 매칭: 대상 1091편 중 1075편이 CSV에 존재
- 소요 시간: **1.2s** (전처리 0.8s + 페어 스캔 0.4s)
...
*생성: `scripts/scan-near-duplicates.mjs` (2026-08-29, 분석 전용 — 콘텐츠 비수정)*
