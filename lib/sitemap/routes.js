...
const pageRouteMap = {
  ...
  '/music-promotion': 'music-promotion.tsx',
  '/crowdfunding-design': 'crowdfunding-design.tsx',
...
// song-structure1은 여기 없다: regionRedirectMap.json에 이미 키가 있어(middleware가
// 선점) Object.keys(...)로 아래 REDIRECTED_SLUGS에 포함된다 — 중복 등재였다(제거,
// 2026-09-09, next.config.mjs 죽은 리다이렉트 규칙 제거와 한 쌍).
