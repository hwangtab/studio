...
export const PRICE_FACTS: string[] = [
  ...
  `**Crowdfunding Design (standalone)**: ${krw(FUNDING_DESIGN_PRICE)} KRW upfront + ${FUNDING_SUCCESS_FEE_PERCENT}% success fee if the campaign succeeds — available without commissioning a release project`,
