...
describe('승인된 프로젝트 — 구획별·필드별 잠금이 화면에 배선됐다', () => {
  it('기본정보: 제목은 활성, 주소(slug)는 비활성이고 잠금 사유가 보인다', () => {
    render(<CreatorProjectEditor project={APPROVED_PROJECT} earliestStartDate="2026-09-25" />);
  ...
  it('draft 프로젝트라면 같은 체크박스가 활성이다 — 대조군', () => {
    render(<CreatorProjectEditor project={DRAFT_PROJECT} earliestStartDate="2026-09-25" />);
