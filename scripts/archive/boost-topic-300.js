...
const proseEvent = [
  ...
  `스튜디오 놀은 연신내역 4번 출구에서 걸어서 5분 거리에 위치해 있어 서울 전 지역과 수도권에서 접근하기 편리합니다. 처음 방문하는 아티스트를 위해 예약 확인 메시지에 상세한 찾아오는 길을 안내해드리고 있습니다. 세션 당일 짐이 많거나 악기를 가져올 경우 미리 안내해주시면 최대한 불편함 없이 준비해드리겠습니다. 방문 전 궁금한 점이 있다면 카카오톡 채널로 언제든지 문의해주세요.`,
