    ...
    <div className="overflow-visible">
      ...
      <div className="container mx-auto px-4 py-12">
        ...
        >
          ...
          <Link to="/booking" className="inline-flex items-center justify-center bg-gradient-to-r from-primary to-secondary text-white font-bold py-3 px-8 rounded-full text-lg hover:from-primary-dark hover:to-secondary-dark transition duration-300">
