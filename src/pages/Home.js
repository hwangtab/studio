...
import { FaMicrophone, FaCompactDisc, FaGlobeAmericas, FaCalendarCheck } from 'react-icons/fa';
...
const AnimatedCard = ({ title, description, link, icon: Icon }) => (
  ...
  >
    ...
    <div className="flex justify-center">
      <Link to={link} className="bg-gradient-to-r from-primary to-secondary text-white font-bold py-2 px-4 rounded-full hover:from-primary-dark hover:to-secondary-dark transition duration-300">
        자세히 보기
      </Link>
    </div>
  </motion.div>
  ...
  return (
    <div className="overflow-visible">
      ...
      <div className="container mx-auto px-4 py-12">
        <motion.h2 
          className="word-break-keep-all text-3xl md:text-4xl pt-2 font-title mb-8 text-center text-transparent bg-clip-text bg-gradient-to-r from-primary-dark via-secondary to-accent"
        ...
        <motion.h2 
          className="word-break-keep-all text-3xl md:text-4xl pt-6 font-title mb-8 text-center text-transparent bg-clip-text bg-gradient-to-r from-primary-dark via-secondary to-accent"
          initial={{ opacity: 0, y: -20 }}
          animate={{ opacity: 1, y: 0 }}
        ...
        >
          ...
          <motion.div
            ...
            whileTap={{ scale: 0.95 }}
          >
            <Link to="/booking" className="inline-flex items-center justify-center bg-gradient-to-r from-primary to-secondary text-white font-bold py-3 px-8 rounded-full text-lg shadow-lg hover:shadow-xl transition-shadow duration-300">
