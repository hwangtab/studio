...
const Services = () => {
  const services = [
    { 
      ...
      icon: FaCompactDisc,
      link: "https://tumblbug.com/goldenhour"
    },
    { 
  ...
  return (
    <div className="container mx-auto px-4 py-16">
      <motion.h1 
        className="text-5xl pt-2 font-title mb-12 text-center text-transparent bg-clip-text bg-gradient-to-r from-primary-dark via-secondary to-accent"
        initial={{ opacity: 0, y: -50 }}
        animate={{ opacity: 1, y: 0 }}
