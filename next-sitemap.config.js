...
const pageImageMap = {
  '/release-project': { url: '/images/og-recording15.jpg', title: 'Studio NOL Release Project - Indie Music Release by Producer Hwang Gyeongha', caption: 'Full-service indie music release: planning, recording, sessions, mixing, distribution, and media PR by 15-year producer Hwang Gyeongha.' },
  '/release-project/single': { url: '/images/og-recording15.jpg', title: 'Studio NOL Single Release - Indie Single by Producer Hwang Gyeongha', caption: 'Indie single release project: planning, vocal recording, sessions, mixing, distribution, and PR by 15-year producer Hwang Gyeongha.' },
  '/release-project/ep': { url: '/images/og-recording15.jpg', title: 'Studio NOL EP Release - Indie EP by Producer Hwang Gyeongha', caption: 'Indie EP release project: 3–5 tracks with planning, recording, sessions, mixing, distribution, and PR by 15-year producer Hwang Gyeongha.' },
  '/release-project/album': { url: '/images/og-recording15.jpg', title: 'Studio NOL Full Album Release - Indie Album by Producer Hwang Gyeongha', caption: 'Full album release project: planning, vocal recording, sessions, mixing, distribution, and media PR by 15-year producer Hwang Gyeongha.' },
  '/about': { url: '/images/og-recording15.jpg', title: 'Studio NOL - 10-Year Music Production Experience', caption: 'Recording studio in Yeonsinnae, Eunpyeong-gu, Seoul with professional engineers.' },
  // 상업 LP 2종 + 운영자 프로필. ogImage는 각 페이지의 SEO ogImage prop과 동기
  // (recording.tsx:137 · mixing-mastering.tsx:171 · author.tsx:45).
  '/recording': { url: '/images/og-recording1.jpg', title: 'Studio NOL Recording Studio - Vocal Recording ₩250K/song', caption: 'Vocal and instrument recording in Yeonsinnae, Seoul: treated live room, STC 60+ booth, Neumann U87Ai, dedicated engineer.' },
  '/mixing-mastering': { url: '/images/og-hardware1.jpg', title: 'Studio NOL Mixing & Mastering - From ₩200K/song', caption: 'Professional mixing and mastering by 15-year producer Hwang Gyeongha. Track-count tiers, two revisions included, remote submission accepted.' },
  '/author': { url: '/images/og-recording15.jpg', title: 'Hwang Gyeongha - Producer & Audio Engineer, Studio NOL', caption: 'Producer and audio engineer with 15 years of experience; recipient of the Selection Committee Special Award at the 14th Korean Music Awards (2017).' },
  '/contact': { url: '/images/og-hardware5.jpg', title: 'Studio NOL Contact - Book Recording Session', caption: 'Reach Studio NOL for recording, mixing, voiceover, and wedding song production.' },
  '/index': { url: '/images/og-studio2.jpg', title: 'Studio NOL - Seoul Music Production Studio', caption: 'Yeonsinnae Studio NOL: recording, mixing, mastering, voiceover, wedding song.' },
  '/lesson': { url: '/images/og-lesson1.jpg', title: 'Studio NOL Music Lessons - Vocal & Production', caption: 'One-on-one vocal, mixing, and music production lessons at Studio NOL.' },
  '/portfolio': { url: '/images/og-recording1.jpg', title: 'Studio NOL Portfolio - Recording & Mixing Works', caption: 'Albums, singles, and commercial works produced at Studio NOL.' },
  '/practice-room': { url: '/images/og-room8.jpg', title: 'Studio NOL Premium Practice Room - Soundproof Residency', caption: 'Soundproof premium practice room with monthly residency in Eunpyeong-gu, Seoul.' },
  '/pricing': { url: '/images/og-hardware2.jpg', title: 'Studio NOL Pricing - Transparent Recording Fees', caption: 'Studio NOL pricing: practice room ₩360K/mo, recording ₩100K/hr, wedding song ₩350K, voiceover ₩100K/hr.' },
  '/stories': { url: '/images/og-studio1.jpg', title: 'Studio NOL Stories - Mixing & Recording Guides', caption: 'Production guides, engineering tutorials, and studio stories by Studio NOL.' },
  '/studio-info': { url: '/images/og-hardware1.jpg', title: 'Studio NOL Equipment - Analog Gear & Neumann Mics', caption: 'Studio NOL gear list: Neumann microphones, analog outboard, pro DAW setup.' },
  '/wedding-song': { url: '/images/og-recording3.jpg', title: 'Studio NOL Wedding Song Package - ₩150K+', caption: 'Wedding vocal package at Studio NOL: pro recording, mix, and editing.' },
  '/voice-acting': { url: '/images/og-hardware3.jpg', title: 'Studio NOL Voiceover Recording - ₩100K/hr', caption: 'Professional voiceover recording at Studio NOL, Yeonsinnae.' },
  '/cover-video': { url: '/images/og-recording1.jpg', title: 'Studio NOL Cover Video Package - ₩350K', caption: 'Cover video filming + recording + mixing all-in-one at Studio NOL, Yeonsinnae.' },
