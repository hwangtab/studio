    ...
    sections: [
      ...
      },
      {
        ...
        body:
          ...
          '화면에서만 보입니다. 정산 계좌와 세금 처리 구분을 담을 자리를 데이터베이스에 두고 ' +
          '있으나 정산 기능이 아직 열리지 않아, 지금은 어떤 화면에서도 이 정보를 받지 않습니다 — ' +
          '받기 시작하면 이 처리방침을 먼저 고칩니다. 보유 기간은 계정이 남아 있는 동안이며, ' +
