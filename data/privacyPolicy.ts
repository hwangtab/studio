  ...
  ko: {
    ...
    sections: [
      ...
      },
      {
        ...
        body: '개인정보를 제3자에게 제공하지 않습니다. 다만 문의·상담과 예약·결제 처리에 필요한 범위에서 아래와 같이 개인정보 처리를 위탁하고 있으며, 수탁자가 바뀌면 이 처리방침으로 알립니다. 펀딩(리워드 선주문) 처리의 위탁 현황은 아래 9항이, 언론 홍보 업무의 매체 연락처는 아래 10~12항이, 개설자 계정 정보는 아래 13~14항이, 요청 제한 기록은 아래 15항이 따로 정합니다.',
      ...
      // 개설자 절이 거기 섞이면 서포터 약관이 개설자 항을 가리키게 된다.
      {
        ...
        items: [
          ...
          '정산을 기록한 경우 자동 생성 — 그 프로젝트의 모금액, 환불액, 공급가액, 플랫폼 수수료, 결제 수수료와 그 합계, 세전 개설자 몫, 원천징수액, 실지급액, 확정 후원 건수, 지급 상태·지급 시각, 운영자가 적는 정산 메모(정산 안내 메일에 그대로 실립니다)',
        ],
      },
      {
