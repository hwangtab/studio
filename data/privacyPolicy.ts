    ...
    sections: [
      ...
      // 이 문서가 실제보다 많이 들고 있다고 고지하는 셈이 된다.
      {
        ...
        items: [
          ...
          '자동 파기 ⑫ 계약서에 적힌 개인정보 — 연습실 계약은 계약이 끝난 날부터 3년이 지나면 계약 상대방의 이름·생년월일·연락처·주소와 계약 본문, 서명 이미지와 서명자의 IP·단말 정보, 그리고 보관하던 계약서 PDF를 지우거나 표시로 덮습니다. 관리자가 자유롭게 적는 계약 제목과 해지 사유도 이름이 들어갈 수 있어 함께 덮습니다. 기산점은 실제로 종료 처리한 날이고, 종료 처리를 하지 않은 계약은 계약서에 적힌 종료일입니다. 계약이 있었다는 사실과 기간·금액·호실, 계약을 언제 몇 번 열어 봤는지는 남습니다',
