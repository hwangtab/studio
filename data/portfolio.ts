...
export const getCategories = (locale: Locale): PortfolioCategory[] => {
    return [
        {
            "id": "all",
            "name": t(locale, { ko: "전체", en: "All", zh: "全部", es: "Todo" }),
            "description": t(locale, { ko: "모든 프로젝트", en: "All Projects", zh: "所有项目", es: "Todos los proyectos" }),
            "color": "#6d28d9"
        },
        {
            "id": "album",
            "name": t(locale, { ko: "앨범", en: "Album", zh: "专辑", es: "Álbum" }),
            "description": t(locale, { ko: "정규 앨범 프로젝트", en: "Full Album Projects", zh: "正规专辑项目", es: "Proyectos de Álbum Completo" }),
            "color": "#db2777"
        },
        {
            "id": "single",
            "name": t(locale, { ko: "싱글", en: "Single", zh: "单曲", es: "Sencillo" }),
            "description": t(locale, { ko: "싱글 곡 프로젝트", en: "Single Song Projects", zh: "单曲项目", es: "Proyectos de Sencillo" }),
            "color": "#059669"
        },
        {
            "id": "compilation",
            "name": t(locale, { ko: "컴필레이션", en: "Compilation", zh: "合辑", es: "Compilación" }),
            "description": t(locale, { ko: "아티스트 간 협업 및 컴필레이션 프로젝트", en: "Collaboration & Compilation Projects", zh: "艺术家合作及合辑项目", es: "Proyectos de Colaboración y Compilación" }),
            "color": "#7c3aed"
        },
        {
            "id": "commercial",
            "name": t(locale, { ko: "상업음악", en: "Commercial", zh: "商业音乐", es: "Comercial" }),
            "description": t(locale, { ko: "CM송 및 상업적 목적의 음악", en: "CM Songs & Commercial Music", zh: "广告歌曲及商业目的音乐", es: "Música Comercial y Jingles" }),
            "color": "#ea580c"
        }
    ];
};
...
export const getPortfolioItems = (locale: Locale): PortfolioItem[] => {
    ...
    const getService = (serviceDict: { ko: string; en: string; zh?: string; es?: string }) => t(locale, serviceDict);

    // Common service names
    const services = {
        planning: { ko: "기획", en: "Planning", zh: "策划", es: "Planificación" },
        recording: { ko: "레코딩", en: "Recording", zh: "录音", es: "Grabación" },
        mixing: { ko: "믹싱", en: "Mixing", zh: "混音", es: "Mezcla" },
        mastering: { ko: "마스터링", en: "Mastering", zh: "母带", es: "Masterización" },
        promotion: { ko: "홍보", en: "Promotion", zh: "宣传", es: "Promoción" },
        design: { ko: "아트워크", en: "Artwork/Design", zh: "设计", es: "Arte/Diseño" },
        web: { ko: "웹사이트 제작", en: "Web Development", zh: "网站制作", es: "Desarrollo Web" },
        arrangement: { ko: "편곡", en: "Arrangement", zh: "编曲", es: "Arreglos" },
        composition: { ko: "작곡", en: "Composition", zh: "作曲", es: "Composición" },
    };
    ...
    return [
        ...
        },
        {
            ...
            "description": t(locale, { ko: "기획, 믹싱, 마스터링, 아트워크, 홍보", en: "Planning, Mixing, Mastering, Artwork, Promotion" }),
        ...
        },
        {
            ...
            "description": t(locale, { ko: "기획, 믹싱, 마스터링, 홍보, 웹사이트 제작", en: "Planning, Mixing, Mastering, Promotion, Web Dev" }),
        ...
        },
        {
            ...
            "description": t(locale, { ko: "기획, 레코딩, 믹싱, 마스터링, 홍보, 웹사이트 제작", en: "Planning, Recording, Mixing, Mastering, Promotion, Web Dev" }),
        ...
        },
        {
            ...
            "description": t(locale, { ko: "기획, 레코딩, 믹싱, 홍보", en: "Planning, Recording, Mixing, Promotion" }),
        ...
        },
        {
            ...
            "title": "허정혁 <바람 한 점>",
            "description": t(locale, { ko: "레코딩, 믹싱, 홍보", en: "Recording, Mixing, Promotion" }),
        ...
        },
        {
            ...
            "description": t(locale, { ko: "기획, 레코딩, 믹싱, 홍보, 웹사이트 제작", en: "Planning, Recording, Mixing, Promotion, Web Dev" }),
        ...
        },
        {
            ...
            "title": "이서영 <우리>",
            "description": t(locale, { ko: "기획, 레코딩, 홍보", en: "Planning, Recording, Promotion" }),
        ...
        },
        {
            ...
            "title": "김인 <별을 보러 간 사람>",
            "description": t(locale, { ko: "기획, 편곡, 레코딩, 믹싱, 홍보", en: "Planning, Arrangement, Recording, Mixing, Promotion" }),
        ...
        },
        {
            ...
            "title": "황경하 <눈녹듯>",
            "description": t(locale, { ko: "기획, 작곡, 편곡, 레코딩, 믹싱, 마스터링, 홍보", en: "Planning, Composition, Arrangement, Recording, Mixing, Mastering, Promotion" }),
        ...
        },
        {
            "id": "hee-woo-ijeum",
            "title": "희우 <잊음>",
            "description": t(locale, { ko: "편곡, 레코딩, 믹싱, 마스터링, 홍보", en: "Arrangement, Recording, Mixing, Mastering, Promotion" }),
        ...
        },
        {
            ...
            "title": "희우 <그대는>",
            "description": t(locale, { ko: "레코딩, 편곡, 믹싱, 마스터링, 홍보", en: "Recording, Arrangement, Mixing, Mastering, Promotion" }),
        ...
        },
        {
            "id": "namjae-haran",
            "title": "남자애 <하란>",
            "description": t(locale, { ko: "레코딩, 믹싱, 마스터링, 홍보", en: "Recording, Mixing, Mastering, Promotion" }),
        ...
        },
        {
            "id": "semin-yeorin-ip",
            "title": "세민 <여린 잎>",
            "description": t(locale, { ko: "기획, 믹싱, 마스터링, 홍보", en: "Planning, Mixing, Mastering, Promotion" }),
        ...
        },
        {
            "id": "young-in-red-dot",
            "title": "영인 <빨간 점>",
            "description": t(locale, { ko: "믹싱, 마스터링", en: "Mixing, Mastering" }),
        ...
        },
        {
            ...
            "description": t(locale, { ko: "기획, 레코딩, 믹싱, 마스터링, 홍보", en: "Planning, Recording, Mixing, Mastering, Promotion" }),
    ...
    return [
        {
            ...
            "duration": "3:44",
            "featured": true,
            "description": t(locale, { ko: "스튜디오 놀에서 레코딩, 믹싱한 트랙", en: "Recorded and Mixed at Studio NOL" })
        },
        {
            "id": "track-2",
            "title": "물결 (Wave)",
