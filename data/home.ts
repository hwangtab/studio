...
const homeData = {
    ...
    seo: {
      ...
      description: "연신내역 도보 5분, 전문 엔지니어 상주 녹음실. 축가·성우·오디오북·음원 녹음, 믹싱·마스터링, 24시간 음악연습실까지 원스톱. 시간당 10만원부터, 무료 견적 상담 후 당일 예약 가능합니다.",
    ...
    homeServices: [
      ...
      {
        title: '음악연습실',
        description: '24시간 완벽 방음 음악연습실. 보컬·피아노·건반 완비, 월 30만원대 입주 프로그램으로 나만의 창작 공간을 경험하세요.',
        link: '/practice-room',
        icon: 'Music',
      },
    ],
