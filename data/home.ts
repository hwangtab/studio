...
const homeData = {
    ...
    heroContent: {
      ...
      // seo.title·description에도 있다. \u00A0는 좁은 화면에서 상호가 "스튜디오 / 놀이"로 갈리지 않게. 펀딩 실적·"제작비 상담" CTA는 넣지 않는다:
      // /release-project의 전환 실험(2026-11-20 판정)이 펀딩 상담 건수를 1차 지표로 보고,
      // 그 페이지 히어로에 이미 "발매 자금 상담"이 있어 입구가 둘이 되면 판정이 섞인다.
