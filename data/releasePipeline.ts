...
export const releasePipelineCopy = {
  hero: {
    subtitle:
      '제작비를 만드는 펀딩부터 녹음·믹싱, 매체 홍보, 협력 유통사 연결까지. 발매의 모든 단계를 한 팀이 끝까지 함께합니다.',
    cta: '발매 자금 상담 (무료 30분)',
  },
  paths: {
    title: '제작비, 이렇게 만듭니다',
  ...
  faq: [
    {
      ...
      answer:
        '상담 → 티저 한 곡 제작과 펀딩 페이지 준비 → 스튜디오 놀 펀딩 진행 → 정산 뒤 나머지 곡 제작 → 매체 홍보 → 협력 유통사를 통한 발매 순서입니다. 티저 곡은 음반에 그대로 들어갑니다. 기간은 음반 규모와 펀딩 기간에 따라 상담에서 정합니다.',
    },
    {
