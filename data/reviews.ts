  ...
  return [
    ...
    },
    {
      ...
      content: t(locale, {
        ...
        th: "เขามีความสามารถยอดเยี่ยมในการทำให้ไอเดียที่เป็นนามธรรมกลายเป็นเสียงจริง การสื่อสารระหว่างมิกซ์ดีมาก และตอนที่ได้ยินซาวด์ที่เคยมีแค่ในหัวก็ขนลุกเลย เขาจัดสมดุลระหว่างความดื้อของศิลปินกับความเป็นสาธารณะได้ดีมาก",
        uz: "Mavhum g‘oyalarni tovushga aniq aylantirish qobiliyati juda kuchli. Miks jarayonida ham muloqot a’lo bo‘ldi, xayolimdagina tasavvur qilgan tovushni eshitganimda hayajonlanib ketdim. San’atkor g‘ururi bilan ommaboplik orasidagi muvozanatni juda yaxshi ushlaydi."
      })
    },
    {
