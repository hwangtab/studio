    ...
    quickAnswers: [
      {
        ...
        a: '유통 자체는 DistroKid 연 3만원대 정액제로 해결됩니다. 녹음·믹싱·마스터링은 별도로, 보컬 녹음 1곡 250,000원 + 싱글 마스터링 100,000원선이 기준입니다(VAT 별도). 기획·세션 연결·홍보까지 함께하는 발매 프로젝트는 싱글 규모 약 50만원부터 규모별 견적으로 진행합니다. 세션 연주비는 여기에 포함되지 않고 연주자 실비만 따로 받습니다.',
      },
      {
