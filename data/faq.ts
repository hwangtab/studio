...
const faqData = {
  ko: [
    ...
    },
    {
      ...
      answer: '네, 전문가가 아니어도 누구나 환영합니다. 모든 녹음 세션에 전담 엔지니어가 동반해 마이크 세팅부터 보컬 디렉팅, 완성 파일 전달까지 전 과정을 지원하므로 처음 녹음하시는 분도 편안하게 고품질 결과물을 얻으실 수 있습니다. (녹음실은 엔지니어 없이 공간만 빌려 드리는 셀프 녹음을 운영하지 않습니다. 연습실은 시간제로 이용할 수 있습니다.)',
    },
    {
