...
const faqData = {
  ko: [
    ...
    },
    {
      ...
      answer: '보컬 녹음 1프로(1곡 패키지)는 250,000원이며 3시간 기준 전담 엔지니어 진행입니다. 시간당 레코딩은 100,000원(성우·악기 추가·보정 등), 6시간 패키지(Day Lock)는 500,000원으로 장시간 앨범 작업에 적합합니다.',
    },
    {
    ...
    },
    {
      ...
      answer: "카카오톡 채널 \'스튜디오 놀\', 전화(0507-1384-3144), 또는 홈페이지 문의 폼을 통해 예약하실 수 있습니다. 당일 예약도 가능하며, 주말·공휴일에도 운영합니다.",
    },
    {
  ...
  en: [
    ...
    },
    {
      ...
      answer: 'You can book via KakaoTalk (channel: Studio NOL), phone (0507-1384-3144), or our website contact form. Same-day bookings are possible, and we are available on weekends and holidays.',
    },
    {
  ...
  zh: [
    ...
    {
      question: '如何预约录音室？',
      answer: '可通过 KakaoTalk 频道"Studio NOL"、电话 0507-1384-3144 或网站联系表单预约。支持当天预约，周末及节假日均可使用。',
    },
    {
  ...
  es: [
    ...
    },
    {
      ...
      answer: 'Puedes reservar a través de KakaoTalk (canal: Studio NOL), por teléfono (0507-1384-3144) o el formulario de contacto en nuestra web. Las reservas el mismo día son posibles y estamos disponibles los fines de semana y festivos.',
    },
    {
  ...
  vi: [
    ...
    },
    {
      ...
      answer: 'Bạn có thể đặt qua KakaoTalk (kênh: Studio NOL), điện thoại (0507-1384-3144) hoặc form liên hệ trên website. Đặt trong ngày được, và chúng tôi mở cửa cả cuối tuần và ngày lễ.',
    },
    {
  ...
  th: [
    ...
    },
    {
      ...
      answer: 'จองได้ผ่าน KakaoTalk (ช่อง: Studio NOL), โทรศัพท์ (0507-1384-3144) หรือฟอร์มติดต่อบนเว็บไซต์ รับจองในวันเดียวกัน และเปิดให้บริการทั้งวันหยุดสุดสัปดาห์และวันหยุดนักขัตฤกษ์',
    },
    {
  ...
  uz: [
    ...
    },
    {
      ...
      answer: "KakaoTalk (kanal: Studio NOL), telefon (0507-1384-3144) yoki veb-saytdagi murojaat formasi orqali band qilishingiz mumkin. Bir kunlik band ham mumkin, dam olish va bayram kunlarida ham ishlaydi.",
    },
    {
