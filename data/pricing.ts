  ...
  const specialPackages = [
    {
      ...
      features: tArray(locale, {
        ko: ['기획 · 방향 디렉팅', '보컬 녹음 1프로 (3시간, 전담 엔지니어)', '믹싱 10트랙 이하 (수정 2회)', '싱글 마스터링 (수정 1회)', '디지털 유통 등록 (멜론·스포티파이·애플뮤직·유튜브뮤직)', `발매 홍보 — 국내 음악 매체 + 해외 매체·라디오·플레이리스트 피칭 (단독 구매 시 ${releasePressListKo})`, `제작 단가 합계 ${singleLineItemTotalKo} 대비 약 9% 할인`],
        ...
        zh: ['策划 · 方向指导', '人声录音1首（3小时，专属工程师）', '混音 ≤10轨（含2次修改）', '单曲母带（含1次修改）', '数字发行登记（Melon·Spotify·Apple Music·YouTube Music）', `发行宣传 — 面向韩国音乐媒体及海外媒体·电台·歌单策展人推介（单独购买 ${releasePressListIntl}）`, `比制作单项合计 ${singleLineItemTotalIntl} 便宜约9%`],
        ...
        uz: ["Konsepsiya rejasi va yo'nalish", 'Vokal yozuv 1 qo\'shiq (3 soat, maxsus muhandis)', 'Miks ≤10 trek (2 tahrir)', 'Single mastering (1 tahrir)', 'Raqamli tarqatish (Melon, Spotify, Apple Music, YouTube Music)', `Reliz targ"iboti — Koreya musiqa nashrlari hamda xalqaro OAV, radio va playlist kuratorlariga yuborish (alohida ${releasePressListIntl})`, `Ishlab chiqarish yig'indisi ${singleLineItemTotalIntl} dan ~9% chegirma`]
      }),
    },
    {
      ...
      features: tArray(locale, {
        ko: ['앨범 기획 · 트랙리스트 큐레이션', '보컬 녹음 1프로 × 4곡 (곡당 3시간, 전담 엔지니어)', '믹싱 10트랙 이하 × 4곡 (곡당 수정 2회)', 'EP 마스터링 × 4곡 (앨범 톤·라우드니스 통일)', '디지털 유통 등록 (멜론·스포티파이·애플뮤직·유튜브뮤직)', `발매 홍보 — 국내 음악 매체 + 해외 매체·라디오·플레이리스트 피칭 (단독 구매 시 ${releasePressListKo})`, `제작 단가 합계 ${epLineItemTotalKo} 대비 약 15% 할인`, '11트랙 이상 편성은 믹싱 차액 별도'],
        ...
        zh: ['专辑策划 · 曲目编排', '人声录音1首 × 4（各 3 小时，专属工程师）', '混音 ≤10轨 × 4（各含2次修改）', 'EP 母带 × 4（全专辑音色·响度统一）', '数字发行登记（Melon·Spotify·Apple Music·YouTube Music）', `发行宣传 — 面向韩国音乐媒体及海外媒体·电台·歌单策展人推介（单独购买 ${releasePressListIntl}）`, `比制作单项合计 ${epLineItemTotalIntl} 便宜约 15%`, '11轨以上编制按混音差额另计'],
        ...
        uz: ['Albom rejasi va treklist kuratsiyasi', "Vokal yozuv 1 qo\'shiq × 4 (har biri 3 soat, maxsus muhandis)", 'Miks ≤10 trek × 4 (har biriga 2 tahrir)', 'EP mastering × 4 (albom bo\'yicha ton va balandlik)', 'Raqamli tarqatish (Melon, Spotify, Apple Music, YouTube Music)', `Reliz targ"iboti — Koreya musiqa nashrlari hamda xalqaro OAV, radio va playlist kuratorlariga yuborish (alohida ${releasePressListIntl})`, `Ishlab chiqarish yig'indisi ${epLineItemTotalIntl} dan ~15% chegirma`, '11+ trek aranjirovka miks farqi bo\'yicha hisoblanadi']
      }),
    },
    {
      ...
      features: tArray(locale, {
        ko: ['A&R 컨설팅 · 트랙리스트 시퀀스 설계', '보컬 녹음 1프로 × 8곡 (곡당 3시간, 전담 엔지니어)', '믹싱 10트랙 이하 × 8곡 (곡당 수정 2회)', '정규 마스터링 × 8곡 (앨범 톤·라우드니스 통일)', '디지털 유통 등록 (멜론·스포티파이·애플뮤직·유튜브뮤직)', `발매 홍보 — 국내 음악 매체 + 해외 매체·라디오·플레이리스트 피칭 (단독 구매 시 ${releasePressListKo})`, `제작 단가 합계 ${albumLineItemTotalKo} 대비 약 20% 할인`, '11트랙 이상 편성은 믹싱 차액 별도'],
        ...
        zh: ['A&R 咨询 · 曲序设计', '人声录音1首 × 8（各 3 小时，专属工程师）', '混音 ≤10轨 × 8（各含2次修改）', '专辑母带 × 8（全专辑音色·响度统一）', '数字发行登记（Melon·Spotify·Apple Music·YouTube Music）', `发行宣传 — 面向韩国音乐媒体及海外媒体·电台·歌单策展人推介（单独购买 ${releasePressListIntl}）`, `比制作单项合计 ${albumLineItemTotalIntl} 便宜约 20%`, '11轨以上编制按混音差额另计'],
        ...
        uz: ['A&R konsalting va treklist ketma-ketligi', "Vokal yozuv 1 qo\'shiq × 8 (har biri 3 soat, maxsus muhandis)", 'Miks ≤10 trek × 8 (har biriga 2 tahrir)', "Albom mastering × 8 (albom bo\'yicha ton va balandlik)", 'Raqamli tarqatish (Melon, Spotify, Apple Music, YouTube Music)', `Reliz targ"iboti — Koreya musiqa nashrlari hamda xalqaro OAV, radio va playlist kuratorlariga yuborish (alohida ${releasePressListIntl})`, `Ishlab chiqarish yig'indisi ${albumLineItemTotalIntl} dan ~20% chegirma`, '11+ trek aranjirovka miks farqi bo\'yicha hisoblanadi']
      }),
    },
    {
      id: 'package-wedding',
