  ...
  const specialPackages = [
    {
      ...
      features: tArray(locale, {
        ko: ['기획 · 방향 디렉팅', '보컬 녹음 1프로 (3시간, 전담 엔지니어)', '믹싱 10트랙 이하 (수정 2회)', '싱글 마스터링 (수정 1회)', '디지털 유통 등록 (멜론·스포티파이·애플뮤직·유튜브뮤직)', `발매 홍보 — 국내 기자·평론가 + 해외 매체·라디오·플레이리스트 피칭 (단독 구매 시 ${releasePressListKo})`, `제작 단가 합계 ${singleLineItemTotalKo} 대비 약 9% 할인`],
        en: ['Concept planning & direction', 'Vocal Recording 1 Song (3h, dedicated engineer)', 'Mixing ≤10 Tracks (2 revisions)', 'Single Mastering (1 revision)', 'Digital distribution (Melon, Spotify, Apple Music, YouTube Music)', `Release promotion — pitched to Korean journalists/critics and international media, radio & playlist curators (${releasePressListIntl} on its own)`, `~9% off the ${singleLineItemTotalIntl} production line-item total`],
        zh: ['策划 · 方向指导', '人声录音1首（3小时，专属工程师）', '混音 ≤10轨（含2次修改）', '单曲母带（含1次修改）', '数字发行登记（Melon·Spotify·Apple Music·YouTube Music）', `发行宣传 — 面向韩国记者·乐评人及海外媒体·电台·歌单策展人推介（单独购买 ${releasePressListIntl}）`, `比制作单项合计 ${singleLineItemTotalIntl} 便宜约9%`],
        es: ['Planificación de concepto y dirección', 'Grabación vocal 1 canción (3h, ingeniero dedicado)', 'Mezcla ≤10 pistas (2 revisiones)', 'Masterización de sencillo (1 revisión)', 'Distribución digital (Melon, Spotify, Apple Music, YouTube Music)', `Promoción de lanzamiento — envío a periodistas y críticos coreanos, medios internacionales, radios y curadores de playlists (${releasePressListIntl} por separado)`, `~9% de descuento sobre la suma de producción (${singleLineItemTotalIntl})`],
        vi: ['Lên kế hoạch & định hướng', 'Thu âm vocal 1 bài (3h, kỹ sư chuyên trách)', 'Mixing ≤10 track (2 lần chỉnh sửa)', 'Mastering single (1 lần chỉnh sửa)', 'Đăng ký phát hành số (Melon, Spotify, Apple Music, YouTube Music)', `Quảng bá phát hành — gửi tới nhà báo, nhà phê bình Hàn Quốc và truyền thông quốc tế, đài phát thanh, người tuyển chọn playlist (mua riêng ${releasePressListIntl})`, `Giảm ~9% so với tổng chi phí sản xuất ${singleLineItemTotalIntl}`],
        th: ['วางแผนคอนเซปต์และกำกับทิศทาง', 'อัดเสียงร้อง 1 เพลง (3 ชม. วิศวกรประจำ)', 'มิกซ์ ≤10 แทร็ก (แก้ไข 2 ครั้ง)', 'มาสเตอร์ซิงเกิล (แก้ไข 1 ครั้ง)', 'ลงทะเบียนจัดจำหน่ายดิจิทัล (Melon, Spotify, Apple Music, YouTube Music)', `โปรโมตการปล่อยผลงาน — ส่งถึงนักข่าวและนักวิจารณ์เกาหลี สื่อต่างประเทศ วิทยุ และผู้จัดเพลย์ลิสต์ (ซื้อแยก ${releasePressListIntl})`, `ลด ~9% จากผลรวมค่าผลิต ${singleLineItemTotalIntl}`],
        uz: ["Konsepsiya rejasi va yo'nalish", 'Vokal yozuv 1 qo\'shiq (3 soat, maxsus muhandis)', 'Miks ≤10 trek (2 tahrir)', 'Single mastering (1 tahrir)', 'Raqamli tarqatish (Melon, Spotify, Apple Music, YouTube Music)', `Reliz targ"iboti — Koreya jurnalistlari va tanqidchilari hamda xalqaro OAV, radio va playlist kuratorlariga yuborish (alohida ${releasePressListIntl})`, `Ishlab chiqarish yig'indisi ${singleLineItemTotalIntl} dan ~9% chegirma`]
      }),
    },
    {
      ...
      features: tArray(locale, {
        ko: ['앨범 기획 · 트랙리스트 큐레이션', '보컬 녹음 1프로 × 4곡 (곡당 3시간, 전담 엔지니어)', '믹싱 10트랙 이하 × 4곡 (곡당 수정 2회)', 'EP 마스터링 × 4곡 (앨범 톤·라우드니스 통일)', '디지털 유통 등록 (멜론·스포티파이·애플뮤직·유튜브뮤직)', `발매 홍보 — 국내 기자·평론가 + 해외 매체·라디오·플레이리스트 피칭 (단독 구매 시 ${releasePressListKo})`, `제작 단가 합계 ${epLineItemTotalKo} 대비 약 15% 할인`, '11트랙 이상 편성은 믹싱 차액 별도'],
        en: ['Album planning & tracklist curation', 'Vocal Recording 1 Song × 4 (3h each, dedicated engineer)', 'Mixing ≤10 Tracks × 4 (2 revisions each)', 'EP Mastering × 4 (album-wide tone & loudness)', 'Digital distribution (Melon, Spotify, Apple Music, YouTube Music)', `Release promotion — pitched to Korean journalists/critics and international media, radio & playlist curators (${releasePressListIntl} on its own)`, `~15% off the ${epLineItemTotalIntl} production line-item total`, '11+ track arrangements billed at the mixing difference'],
        zh: ['专辑策划 · 曲目编排', '人声录音1首 × 4（各 3 小时，专属工程师）', '混音 ≤10轨 × 4（各含2次修改）', 'EP 母带 × 4（全专辑音色·响度统一）', '数字发行登记（Melon·Spotify·Apple Music·YouTube Music）', `发行宣传 — 面向韩国记者·乐评人及海外媒体·电台·歌单策展人推介（单独购买 ${releasePressListIntl}）`, `比制作单项合计 ${epLineItemTotalIntl} 便宜约 15%`, '11轨以上编制按混音差额另计'],
        es: ['Planificación del álbum y curaduría del tracklist', 'Grabación vocal 1 canción × 4 (3h cada una, ingeniero dedicado)', 'Mezcla ≤10 pistas × 4 (2 revisiones cada una)', 'Masterización EP × 4 (tono y loudness unificados)', 'Distribución digital (Melon, Spotify, Apple Music, YouTube Music)', `Promoción de lanzamiento — envío a periodistas y críticos coreanos, medios internacionales, radios y curadores de playlists (${releasePressListIntl} por separado)`, `~15% de descuento sobre la suma de producción ${epLineItemTotalIntl}`, 'Arreglos de 11+ pistas se facturan por la diferencia de mezcla'],
        vi: ['Lên kế hoạch album & sắp xếp tracklist', 'Thu âm vocal 1 bài × 4 (3h mỗi bài, kỹ sư chuyên trách)', 'Mixing ≤10 track × 4 (2 lần chỉnh sửa mỗi bài)', 'Mastering EP × 4 (đồng nhất tone & loudness)', 'Đăng ký phát hành số (Melon, Spotify, Apple Music, YouTube Music)', `Quảng bá phát hành — gửi tới nhà báo, nhà phê bình Hàn Quốc và truyền thông quốc tế, đài phát thanh, người tuyển chọn playlist (mua riêng ${releasePressListIntl})`, `Giảm ~15% so với tổng chi phí sản xuất ${epLineItemTotalIntl}`, 'Phối khí 11+ track tính thêm phần chênh mixing'],
        th: ['วางแผนอัลบั้มและคัดเลือกลำดับเพลง', 'อัดเสียงร้อง 1 เพลง × 4 (เพลงละ 3 ชม. วิศวกรประจำ)', 'มิกซ์ ≤10 แทร็ก × 4 (แก้ไขเพลงละ 2 ครั้ง)', 'มาสเตอริ่ง EP × 4 (โทนและความดังทั้งอัลบั้ม)', 'ลงทะเบียนจัดจำหน่ายดิจิทัล (Melon, Spotify, Apple Music, YouTube Music)', `โปรโมตการปล่อยผลงาน — ส่งถึงนักข่าวและนักวิจารณ์เกาหลี สื่อต่างประเทศ วิทยุ และผู้จัดเพลย์ลิสต์ (ซื้อแยก ${releasePressListIntl})`, `ลด ~15% จากผลรวมค่าผลิต ${epLineItemTotalIntl}`, 'การเรียบเรียง 11+ แทร็ก คิดส่วนต่างค่ามิกซ์'],
        uz: ['Albom rejasi va treklist kuratsiyasi', "Vokal yozuv 1 qo\'shiq × 4 (har biri 3 soat, maxsus muhandis)", 'Miks ≤10 trek × 4 (har biriga 2 tahrir)', 'EP mastering × 4 (albom bo\'yicha ton va balandlik)', 'Raqamli tarqatish (Melon, Spotify, Apple Music, YouTube Music)', `Reliz targ"iboti — Koreya jurnalistlari va tanqidchilari hamda xalqaro OAV, radio va playlist kuratorlariga yuborish (alohida ${releasePressListIntl})`, `Ishlab chiqarish yig'indisi ${epLineItemTotalIntl} dan ~15% chegirma`, '11+ trek aranjirovka miks farqi bo\'yicha hisoblanadi']
      }),
    },
    {
      ...
      features: tArray(locale, {
        ko: ['A&R 컨설팅 · 트랙리스트 시퀀스 설계', '보컬 녹음 1프로 × 8곡 (곡당 3시간, 전담 엔지니어)', '믹싱 10트랙 이하 × 8곡 (곡당 수정 2회)', '정규 마스터링 × 8곡 (앨범 톤·라우드니스 통일)', '디지털 유통 등록 (멜론·스포티파이·애플뮤직·유튜브뮤직)', `발매 홍보 — 국내 기자·평론가 + 해외 매체·라디오·플레이리스트 피칭 (단독 구매 시 ${releasePressListKo})`, `제작 단가 합계 ${albumLineItemTotalKo} 대비 약 20% 할인`, '11트랙 이상 편성은 믹싱 차액 별도'],
        en: ['A&R consulting & tracklist sequencing', 'Vocal Recording 1 Song × 8 (3h each, dedicated engineer)', 'Mixing ≤10 Tracks × 8 (2 revisions each)', 'Album Mastering × 8 (album-wide tone & loudness)', 'Digital distribution (Melon, Spotify, Apple Music, YouTube Music)', `Release promotion — pitched to Korean journalists/critics and international media, radio & playlist curators (${releasePressListIntl} on its own)`, `~20% off the ${albumLineItemTotalIntl} production line-item total`, '11+ track arrangements billed at the mixing difference'],
        zh: ['A&R 咨询 · 曲序设计', '人声录音1首 × 8（各 3 小时，专属工程师）', '混音 ≤10轨 × 8（各含2次修改）', '专辑母带 × 8（全专辑音色·响度统一）', '数字发行登记（Melon·Spotify·Apple Music·YouTube Music）', `发行宣传 — 面向韩国记者·乐评人及海外媒体·电台·歌单策展人推介（单独购买 ${releasePressListIntl}）`, `比制作单项合计 ${albumLineItemTotalIntl} 便宜约 20%`, '11轨以上编制按混音差额另计'],
        es: ['Consultoría A&R y secuenciación del tracklist', 'Grabación vocal 1 canción × 8 (3h cada una, ingeniero dedicado)', 'Mezcla ≤10 pistas × 8 (2 revisiones cada una)', 'Masterización de álbum × 8 (tono y loudness unificados)', 'Distribución digital (Melon, Spotify, Apple Music, YouTube Music)', `Promoción de lanzamiento — envío a periodistas y críticos coreanos, medios internacionales, radios y curadores de playlists (${releasePressListIntl} por separado)`, `~20% de descuento sobre la suma de producción ${albumLineItemTotalIntl}`, 'Arreglos de 11+ pistas se facturan por la diferencia de mezcla'],
        vi: ['Tư vấn A&R & thiết kế thứ tự tracklist', 'Thu âm vocal 1 bài × 8 (3h mỗi bài, kỹ sư chuyên trách)', 'Mixing ≤10 track × 8 (2 lần chỉnh sửa mỗi bài)', 'Mastering album × 8 (đồng nhất tone & loudness)', 'Đăng ký phát hành số (Melon, Spotify, Apple Music, YouTube Music)', `Quảng bá phát hành — gửi tới nhà báo, nhà phê bình Hàn Quốc và truyền thông quốc tế, đài phát thanh, người tuyển chọn playlist (mua riêng ${releasePressListIntl})`, `Giảm ~20% so với tổng chi phí sản xuất ${albumLineItemTotalIntl}`, 'Phối khí 11+ track tính thêm phần chênh mixing'],
        th: ['ที่ปรึกษา A&R และออกแบบลำดับเพลง', 'อัดเสียงร้อง 1 เพลง × 8 (เพลงละ 3 ชม. วิศวกรประจำ)', 'มิกซ์ ≤10 แทร็ก × 8 (แก้ไขเพลงละ 2 ครั้ง)', 'มาสเตอริ่งอัลบั้ม × 8 (โทนและความดังทั้งอัลบั้ม)', 'ลงทะเบียนจัดจำหน่ายดิจิทัล (Melon, Spotify, Apple Music, YouTube Music)', `โปรโมตการปล่อยผลงาน — ส่งถึงนักข่าวและนักวิจารณ์เกาหลี สื่อต่างประเทศ วิทยุ และผู้จัดเพลย์ลิสต์ (ซื้อแยก ${releasePressListIntl})`, `ลด ~20% จากผลรวมค่าผลิต ${albumLineItemTotalIntl}`, 'การเรียบเรียง 11+ แทร็ก คิดส่วนต่างค่ามิกซ์'],
        uz: ['A&R konsalting va treklist ketma-ketligi', "Vokal yozuv 1 qo\'shiq × 8 (har biri 3 soat, maxsus muhandis)", 'Miks ≤10 trek × 8 (har biriga 2 tahrir)', "Albom mastering × 8 (albom bo\'yicha ton va balandlik)", 'Raqamli tarqatish (Melon, Spotify, Apple Music, YouTube Music)', `Reliz targ"iboti — Koreya jurnalistlari va tanqidchilari hamda xalqaro OAV, radio va playlist kuratorlariga yuborish (alohida ${releasePressListIntl})`, `Ishlab chiqarish yig'indisi ${albumLineItemTotalIntl} dan ~20% chegirma`, '11+ trek aranjirovka miks farqi bo\'yicha hisoblanadi']
      }),
    },
    {
      id: 'package-wedding',
