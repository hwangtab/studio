                ...
                <div className="container mx-auto px-4">
                    ...
                    <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
                        ...
                        >
                            ...
                            <p className="text-2xl font-bold text-primary dark:text-primary-light mb-4">400,000원 <span className="text-sm text-gray-500 font-normal">(선불)</span></p>
                            <p className="text-sm text-gray-600 dark:text-gray-300">텀블벅 등 크라우드 펀딩 페이지 기획, 스토리텔링, 리워드 설계</p>
                            <p className="text-xs text-gray-400 mt-2">* 성공 수수료 10% 별도 (후불)</p>
                        </motion.div>
