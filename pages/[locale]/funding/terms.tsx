...
export const FUNDING_TERMS_SECTIONS: FundingTermsSection[] = [
  ...
  { heading: '제5조 (후원 신청과 결제)', body: ['후원은 리워드·수량·후원자 정보·배송지(배송 리워드에 한함)를 입력하고 결제를 완료한 때 성립합니다.', '결제는 신청 후 15분 안에 완료되어야 하며, 기한이 지나면 신청이 자동 해제됩니다.'] },
