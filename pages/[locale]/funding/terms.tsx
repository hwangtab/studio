...
export const FUNDING_TERMS_SECTIONS: FundingTermsSection[] = [
  ...
  { heading: '제8조 (청약철회의 권리 및 기간)', body: ['후원자는 프로젝트 마감 전이고 리워드 발송 준비가 시작되기 전이면 언제든 후원을 취소하고 전액 환불받을 수 있습니다. 온라인 결제는 후원 확인 페이지에서 바로 취소되며, 스튜디오가 계좌로 받아 등록한 후원은 문의로 접수하면 계좌로 환불해 드립니다.', '리워드를 받은 날부터 7일 이내에 청약철회할 수 있습니다. 리워드가 표시·광고 내용과 다르거나 계약 내용과 다르게 이행된 경우 리워드를 받은 날부터 3개월 이내, 그 사실을 안 날부터 30일 이내에 청약철회할 수 있습니다.'] },
