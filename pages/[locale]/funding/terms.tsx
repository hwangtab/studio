...
export const FUNDING_TERMS_SECTIONS: FundingTermsSection[] = [
  ...
  { heading: '제13조 (개인정보의 처리)', body: [`스튜디오는 후원 확정·리워드 발송·고객 응대 목적으로 후원자의 이름·연락처·이메일·배송지를 수집하며, ${PRIVACY_RETENTION_TEXT} 보관한 뒤 파기합니다. ${PRIVACY_LEGAL_RETENTION_TEXT}`, '후원자 명단 공개에 동의한 후원자의 이름은 프로젝트 페이지에 표시되며, 동의는 후원 확인 페이지 또는 문의로 철회할 수 있습니다.', '수집 항목·이용 목적·보유 기간·처리위탁 현황은 개인정보 처리방침 제6항(펀딩(리워드 선주문) 수집 항목)부터 제9항(펀딩 개인정보의 처리위탁)까지에 함께 고지합니다.'] },
