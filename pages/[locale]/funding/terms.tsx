...
export const FUNDING_TERMS_SECTIONS: FundingTermsSection[] = [
  ...
  { heading: '제7조 (리워드의 제공)', body: ['리워드의 예상 전달 시기는 제작 계획에 따른 예정이며, 지연이 예상되면 스튜디오는 서포터에게 이메일로 고지합니다.', '배송 리워드는 서포터가 입력한 배송지로 발송하며, 배송지 오류로 인한 반송·재발송 비용은 서포터가 부담합니다.', '개설자가 있는 프로젝트는 리워드의 제작과 발송을 개설자가 수행할 수 있습니다. 이 경우에도 서포터에 대한 계약상 책임(리워드 미이행에 따른 환불 등)은 판매자인 스튜디오가 집니다. 환불·청약철회의 접수 창구는 개설자 유무와 관계없이 이 약관에 정한 대로 스튜디오입니다.'] },
