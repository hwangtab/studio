...
export const FUNDING_CREATOR_TERMS_SECTIONS: CreatorTermsSection[] = [
  ...
  },
  {
    ...
    body: [
      '후원자의 개인정보는 스튜디오가 보유하며, 개설자에게 제공하지 않습니다. 리워드의 발송은 개설자가 아니라 스튜디오가 처리합니다.',
      '앞으로 리워드 이행을 위해 후원자의 개인정보를 개설자에게 제공해야 하는 경우가 생기면, 개인정보 처리방침을 개정하고 별도로 고지한 뒤에만 제공합니다. 그 경우에도 개설자는 제공받은 정보를 리워드 제작·배송 목적으로만 사용하며 그 밖의 목적으로 이용하거나 제3자에게 제공할 수 없고, 목적을 다한 정보는 지체 없이 파기해야 합니다.',
    ],
  },
];
