...
export const FUNDING_CREATOR_TERMS_SECTIONS: CreatorTermsSection[] = [
  ...
  },
  {
    ...
    body: [
      ...
      '제공하는 항목은 다음뿐입니다: 받는 분 이름, 연락처, 우편번호, 주소, 상세주소, 배송 메모, 그리고 그 후원의 리워드 이름·수량·발송 상태·택배사·운송장번호. 서포터의 이메일 주소, 결제 금액, 결제수단, 주문번호, 응원 메시지는 제공하지 않습니다.',
      ...
      '배송 리워드의 발송 주체는 개설자입니다. 개설자는 개설자 화면에서 후원 건마다 발송 상태(미발송·준비중·발송완료·수령완료)와 택배사·운송장번호를 직접 기록해야 하며, 서포터와 스튜디오는 그 기록으로 배송 진행 상황을 확인합니다. 발송 상태를 마지막으로 바꾼 주체가 누구인지는 시스템에 기록으로 남습니다.',
