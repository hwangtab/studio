...
export const FUNDING_CREATOR_TERMS_SECTIONS: CreatorTermsSection[] = [
  ...
  },
  {
    ...
    body: [
      ...
      '개설자 계정 정보(소개·연락처·링크)는 프로젝트가 아니라 개설자 계정에 속한 정보이므로, 프로젝트 승인 여부와 무관하게 언제든 고칠 수 있습니다. 다만 이름은 예외입니다 — 승인된 프로젝트가 하나라도 있으면 그 개설자의 이름은 더 이상 바꿀 수 없습니다. 프로젝트 상세 화면에 판매자 표시와 함께 그대로 노출되는 값이라, 승인 뒤 바뀌지 않는 것들과 같은 이유로 잠급니다.',
    ],
  },
  {
