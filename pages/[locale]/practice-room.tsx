...
const PRACTICE_ROOM_RELATED_GUIDES = [
  { slug: 'practice-room-guide1', label: '연습실 고르는 법' },
  { slug: 'practice-room-price1', label: '연습실 가격' },
  { slug: 'practice-room-rental1', label: '연습실 대여 방법' },
  { slug: 'practice-room-monthly1', label: '월세 입주 가이드' },
  { slug: 'practice-room-soundproof1', label: '방음 연습실 선택' },
  { slug: 'practice-room-private1', label: '개인 연습실' },
  { slug: 'practice-room-booking1', label: '예약 방법' },
  { slug: 'practice-room-first1', label: '처음 이용 가이드' },
  { slug: 'practice-room-equipment1', label: '연습실 장비' },
  { slug: 'practice-room-contract1', label: '월세 계약 체크' },
  { slug: 'practice-room-unmanned1', label: '무인 연습실' },
  { slug: 'practice-room-nodeposit1', label: '보증금 없는 연습실' },
  { slug: 'practice-room-storage1', label: '악기 보관 가능한 연습실' },
  { slug: 'practice-room-etiquette1', label: '연습실 에티켓' },
  { slug: 'practice-room-yeonsinnae1', label: '연신내 허브 가이드' },
  { slug: 'practice-room-seoul1', label: '서울 지역 비교' },
  { slug: 'practice-room-bulgwang1', label: '불광 지역 가이드' },
  { slug: 'practice-room-hongdae1', label: '홍대 vs 연신내' },
  { slug: 'practice-room-gangnam1', label: '강남·서초 가이드' },
  { slug: 'practice-room-sinchon1', label: '신촌·이대 가이드' },
  { slug: 'practice-room-bucheon1', label: '부천·인천·김포 가이드' },
  { slug: 'practice-room-goyang1', label: '고양·일산 가이드' },
  { slug: 'practice-room-vocal1', label: '보컬 연습실' },
  { slug: 'practice-room-guitar1', label: '기타 연습실' },
  { slug: 'practice-room-piano1', label: '피아노 연습실' },
  { slug: 'practice-room-drum1', label: '드럼 연습실' },
  { slug: 'practice-room-bass1', label: '베이스 연습실' },
  { slug: 'practice-room-keyboard1', label: '건반·키보드 연습실' },
  { slug: 'practice-room-hobby1', label: '취미 음악인 가이드' },
  { slug: 'practice-room-night1', label: '야간 연습실' },
  { slug: 'practice-room-weekend1', label: '주말 연습 전략' },
  { slug: 'practice-room-lesson1', label: '레슨 병행법' },
  { slug: 'practice-room-audition1', label: '오디션 준비' },
  { slug: 'practice-room-entrance1', label: '입시 연습실 가이드' },
  { slug: 'practice-room-recording1', label: '셀프 녹음 연습실' },
  { slug: 'practice-room-midi1', label: '미디·프로덕션 연습실' },
  { slug: 'practice-room-cover1', label: '커버 연습실' },
  { slug: 'practice-room-startup1', label: '연습실 창업 가이드' },
  { slug: 'practice-room-transfer1', label: '양도·인수 가이드' },
] as const;
        ...
        <Section variant="default" className="py-10">
          <div className="max-w-5xl mx-auto">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
              {PRACTICE_ROOM_RELATED_GUIDES.map(({ slug, label }) => (
                <Link
                  key={slug}
