...
export default async function handler(req: NextRequest) {
  try {
    ...
    // 사이트 본문은 next/font/local의 Pretendard Variable로 통일됐지만, @vercel/og는 edge runtime에서
    // 동적으로 폰트를 fetch해 ImageResponse에 주입해야 한다. next/font 빌드 산출물(_next/static/media)은
    // edge runtime에서 접근 불가하므로 OG 전용으로 public/fonts/ 자체 호스팅 woff2 파일을 유지.
