...
const PracticeRoom: NextPage = () => {
  return (
    <>
      <SEO
        title="유튜브 촬영 스튜디오 · 방음/레코딩 연습실 대관 | 스튜디오 놀"
        description="유튜브/인터뷰/방송 촬영을 위한 완벽한 방음 스튜디오. 보컬 및 악기 녹음이 가능한 프리미엄 연습실. 24시간 언제든 나만의 콘텐츠를 제작하세요."
        keywords="유튜브 촬영 스튜디오, 방송 촬영 대관, 레코딩 연습실, 방음 부스 대여, 개인 작업실, 영상 촬영 스튜디오, 연신내 연습실, 스튜디오 놀"
